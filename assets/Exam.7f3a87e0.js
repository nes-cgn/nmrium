import{r as e,j as t,c as o,e as n,f as s}from"./vendor.974372f3.js";import{f as i,N as l,S as r,M as a,c}from"./NMRium.3b938adb.js";import"./index.c60e15d4.js";let d=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function u(e){const t=await fetch(e);!function(e){if(!e.ok)throw new Error(`HTTP ${e.status} - ${e.statusText}`)}(t);return await t.json()}const f=o`
  display: flex;
...
//# sourceMappingURL=Exam.7f3a87e0.js.map
