import{r,j as l,a as t,c as s,g as P,h as R}from"./vendor.cb69b7e6.js";import{f as m,N as j,S as F,M as N,c as T}from"./NMRium.d5513ea6.js";import"./index.55df369b.js";let g=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function D(o){const e=await fetch(o);return E(e),await e.json()}function E(o){if(!o.ok)throw new Error(`HTTP ${o.status} - ${o.statusText}`);return o}const I=s`
  display: flex;
...
//# sourceMappingURL=Exam.19f4a308.js.map
