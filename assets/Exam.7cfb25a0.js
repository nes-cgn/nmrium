import{r as i,j as e,c as s,e as j,f as A}from"./vendor.5177a34e.js";import{f as h,N as P,S as R,M as N,c as F}from"./NMRium.856fc79a.js";import"./index.d53527e8.js";let m=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function T(o){const t=await fetch(o);return D(t),await t.json()}function D(o){if(!o.ok)throw new Error(`HTTP ${o.status} - ${o.statusText}`);return o}const E=s`
  display: flex;
...
//# sourceMappingURL=Exam.7cfb25a0.js.map
