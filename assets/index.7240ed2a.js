...
`;function df(e){const t=c.exports.useMemo(()=>ef(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:N(nf,e.menuIsClosed?sf:of),children:[w("div",{css:lf,children:[d("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:d("a",{css:N(af,cf),children:"NMRium"})}),d("button",{type:"button",css:rf,onClick:e.onMenuToggle,children:d(Ud,{})})]}),d("div",{css:uf,style:{display:n},children:d(Kd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Lt(o.item.props.file)}`)},mode:"inline",children:t})})]})}var pf=Zd(c.exports.memo(df));const hf="modulepreload",yr={},ff="./",lt=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${ff}${o}`,o in yr)return;yr[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const r=document.createElement("link");if(r.rel=s?"stylesheet":hf,s||(r.as="script",r.crossOrigin=""),r.href=o,document.head.appendChild(r),s)return new Promise((l,a)=>{r.addEventListener("load",l),r.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ii={Exam:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./Exam.18d5a47c.js"),["assets/Exam.18d5a47c.js","assets/vendor.6bb543ed.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./Exercise.55d00e49.js"),["assets/Exercise.55d00e49.js","assets/vendor.6bb543ed.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./SingleView.58d3adf9.js"),["assets/SingleView.58d3adf9.js","assets/vendor.6bb543ed.js"]))),Test:c.exports.memo(c.exports.lazy(()=>lt(()=>Promise.resolve().then(function(){return zT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./View.eb3026d3.js"),["assets/View.eb3026d3.js","assets/vendor.6bb543ed.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./TwoInstances.223eab5b.js"),["assets/TwoInstances.223eab5b.js","assets/vendor.6bb543ed.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./Teaching.bd509c64.js"),["assets/Teaching.bd509c64.js","assets/vendor.6bb543ed.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>lt(()=>import("./Prediction.ef61cc94.js"),["assets/Prediction.ef61cc94.js","assets/View.eb3026d3.js","assets/vendor.6bb543ed.js"])))},mf=N`
  position: relative;
  float: right;
  height: 100%;
...
`;function wv(){return d("div",{css:Sv})}function Ev(a){var u=a,{children:e,wrapperRef:t=null,offset:n="5px",position:o=te.BOTTOM_CENTER,timeout:s=3e3,type:i,transition:r=et.FADE}=u,l=G(u,["children","wrapperRef","offset","position","timeout","type","transition"]);const p=c.exports.useRef(null),h=c.exports.useRef([]),[m,g]=c.exports.useState([]);c.exports.useEffect(()=>{p.current=document.createElement("div");const A=p.current,R=h.current;return t&&t.appendChild(A),()=>{A&&t&&(R.forEach(clearTimeout),t.removeChild(A))}},[t]);const x=c.exports.useCallback(A=>{g(R=>{const I=R.length,O=R.filter(L=>L.id!==A.id);return I>O.length&&A.options.onClose&&A.options.onClose(),O})},[]),y=c.exports.useCallback((A="",R={})=>{const I=Math.random().toString(36).substr(2,9),O=b({position:R.position||o,timeout:s,type:i,backgroundColor:"black",color:"white"},R),L={id:I,message:A,options:O};if(L.close=()=>x(L),L.options.timeout){const H=setTimeout(()=>{x(L),h.current.splice(h.current.indexOf(H),1)},L.options.timeout);h.current.push(H)}return g(H=>H.concat(L)),L.options.onOpen&&L.options.onOpen(),L},[o,x,s,i]),k=c.exports.useCallback((A="",R={})=>(R.type=Mn.SUCCESS,R=b({backgroundColor:"#28ba62",color:"white"},R),y(A,R)),[y]),v=c.exports.useCallback((A="",R={})=>(R.type=Mn.ERROR,R=b({backgroundColor:"#cf3c4f",color:"white"},R),y(A,R)),[y]),C=c.exports.useCallback((A="",R={})=>(R.type=Mn.INFO,R.color="#28ba62",y(A,R)),[y]),E=c.exports.useCallback((A="Process in progress",R={})=>(R.type=Mn.PROGRESS_INDICATOR,R.timeout=0,R.backgroundColor="#232323",new Promise(I=>{const O=y(A,R);setTimeout(()=>{I(()=>x(O))},500)})),[x,y]),T=c.exports.useCallback(A=>{x(A)},[x]),M=kv(m,A=>A.options.position),D=c.exports.useMemo(()=>t?t.getBoundingClientRect():{top:0,left:0,width:window.innerWidth,height:window.innerHeight},[t]),P=c.exports.useMemo(()=>({show:y,success:k,error:v,info:C,showLoading:E}),[y,k,v,C,E]);return _(bv,{value:P,children:[e,p.current&&qo.exports.createPortal(f(c.exports.Fragment,{children:Object.keys(te).map(A=>{const R=te[A];return f(Ol,S(b({appear:!0,options:{position:R,zIndex:999999},component:rd,containerStyle:D},l),{children:M[R]?M[R].map(I=>f(id,{type:r,children:_("div",{style:{margin:n,padding:"25px",borderRadius:"10px",pointerEvents:"all",backgroundColor:I.options.backgroundColor,color:I.options.color,minHeight:"60px",position:"relative"},children:[f("button",{style:{position:"absolute",right:"5px",top:"5px",border:"none",backgroundColor:"transparent",color:"white"},type:"button",onClick:()=>T(I),children:f(oi,{})}),f("span",{children:I.message}),I.options.type===Mn.PROGRESS_INDICATOR&&f(wv,{})]},I.id)},I.id)):null}),R)})}),p.current)]})}var Av=c.exports.memo(Ev);const ld=c.exports.createContext({}),Tv=ld.Provider;function he(){return c.exports.useContext(ld)}const Dv=N`
  display: block;
  border-radius: 5px;
  overflow: hidden;
  width: 300px;
...
`;function Pv({style:e={},buttons:t=[],onClose:n,message:o}){const s=c.exports.useCallback((i,{handler:r=()=>null})=>{r(i),n()},[n]);return w("div",{style:e,css:Dv,children:[d("p",{className:"message",children:o}),d("div",{className:"buttons-container",children:t.map(i=>d("button",{type:"button",onClick:r=>s(r,i),style:i.style&&i.style,children:i.text},i.text))})]})}const Rv=({modal:e,onClose:t,onLayout:n})=>{const o=c.exports.useRef(),[s,{width:i,height:r}]=Tp(()=>f("div",{style:{height:"100%",display:"block",overflow:"auto"},children:c.exports.cloneElement(e.component,S(b({},e.options),{onClose:t,style:{cursor:"default"}}))}));return c.exports.useEffect(()=>{isFinite(r)&&isFinite(i)&&!o.current&&(o.current={width:i,height:r},n({modal:e,layout:{width:i,height:r}}))},[i,r,o,n,e]),s},Iv={[et.FADE]:{entering:{opacity:0},entered:{opacity:1}},[et.SCALE]:{entering:{transform:"scale(0)"},entered:{transform:"scale(1)"},exiting:{transform:"scale(0)"},exited:{transform:"scale(0)"}}};function Mv({children:e,style:t=void 0,offset:n="0px",position:o=te.MIDDLE,transition:s=et.SCALE,wrapperRef:i=null}){const r=c.exports.useRef(),l=c.exports.useRef(),[a,u]=c.exports.useState();c.exports.useEffect(()=>{r.current=document.createElement("div");const C=r.current;return i&&i.appendChild(C),()=>{C&&i&&i.removeChild(C)}},[i]);const p=c.exports.useCallback(function(){u(null)},[u]),h=c.exports.useMemo(()=>i?i.getBoundingClientRect():{top:0,left:0,width:window.innerWidth,height:window.innerHeight},[i]),m=c.exports.useCallback((C,E={})=>{const T={component:C,options:b({isBackgroundBlur:!0,enableResizing:!1},E)};return T.close=p,u(T),T.options.onOpen&&T.options.onOpen(),T},[p]),g=c.exports.useCallback((C,E={enableResizing:!1})=>{const T={component:d(Pv,b({},C)),options:b({isBackgroundBlur:!0},E)};return T.close=p,u(T),T.options.onOpen&&T.options.onOpen(),T},[p]);c.exports.useEffect(()=>{function C(E){["Escape","Esc"].includes(E.key)&&p()}return document.addEventListener("keydown",C,!1),()=>document.removeEventListener("keydown",C,!1)},[p]);const x=N`
    position: absolute;
    left: 0;
    top: 0;
    bottom: 0;
...
`;function J1({margin:e,width:t,height:n,activeSpectrum:o,spectrum:s,activeTab:i}){var g,x,y,k;let r=c.exports.useContext(pt);const{startX:l,endX:a,step:u}=c.exports.useContext(At),{scaleX:p}=ge(),h=Xe(i),m=c.exports.useCallback(v=>{if(s){const C=Cn(s),E=Ze(C.x,p().invert(v));return C.y[E]}return 1},[s,p]);return!r||r.y<e.top||r.x<e.left||r.x>t-e.right||r.y>n-e.bottom?d("div",{css:Ur}):w("div",{css:Ur,children:[d(Ip,{}),w("div",{children:[d("span",{className:"label",children:" \u{1D6C5}: "}),d("span",{className:"value",children:h(p().invert(r.x))}),d("span",{className:"unit",children:"ppm"}),o&&((g=s==null?void 0:s.info)==null?void 0:g.originFrequency)&&w(je,{children:[w("span",{className:"value",children:["\xA0(",h(p().invert(r.x)*((x=s==null?void 0:s.info)==null?void 0:x.originFrequency),"hz")]}),d("span",{className:"unit",children:"Hz"}),d("span",{className:"value",children:") "})]})]}),u==="brushing"&&w("div",{children:[d("span",{className:"label",children:" \u0394ppm: "}),d("span",{className:"value",children:(p().invert(l)-p().invert(a)).toPrecision(6)})]}),o&&w(c.exports.Fragment,{children:[((y=s==null?void 0:s.info)==null?void 0:y.originFrequency)&&u==="brushing"&&w("div",{children:[d("span",{className:"label",children:" \u0394Hz: "}),d("span",{className:"value",children:((p().invert(l)-p().invert(a))*((k=s==null?void 0:s.info)==null?void 0:k.originFrequency)).toPrecision(5)})]}),u==="brushing"&&w("div",{children:[d("span",{className:"label",children:" ratio :"}),w("span",{className:"value",children:[(m(l)/(m(a)||Number.MIN_VALUE)*100).toFixed(2),"%"]})]})]}),o&&w(c.exports.Fragment,{children:[d("div",{className:"separator"}),d(Mp,{}),w("div",{children:[d("span",{className:"label",children:"Intensity: "}),d("span",{className:"value yvalue",children:h(m(r.x))})]})]})]})}const Q1=c.exports.memo(J1);function eC(){const{margin:e,width:t,height:n,activeSpectrum:o,activeTab:s}=$(),i=Ce(null);return d(Q1,{margin:e,width:t,height:n,activeSpectrum:o,spectrum:i,activeTab:s})}const Ao={container:{position:"absolute",left:"10px",top:"10px"},value:{width:"67px",display:"inline-block",margin:"0 5px",fontSize:"12px"},colorIndicator:{width:"10px",height:"1px",borderBottom:"2px solid",display:"inline-block",marginBottom:"3px"},name:{fontSize:"12px"}};function tC({datum:e}){const{scaleX:t}=Gi(),n=c.exports.useContext(pt);if(!t||!n)return null;const o=Ze(e.x,t().invert(n.x));return f("span",{style:Ao.value,children:e.y[o]})}function nC(){const{data:e,activeTab:t,xDomains:n}=$(),[o,s]=c.exports.useState(!1);c.exports.useEffect(()=>{function r(l){s(l)}return de.on("showYSpectraTrackers",r),()=>{de.off("showYSpectraTrackers",r)}},[]);const i=c.exports.useMemo(()=>o&&e.map(r=>r.display.isVisible&&n[r.id]&&r.info.nucleus===t&&_("div",{style:{display:"block"},children:[f("span",{style:S(b({},Ao.colorIndicator),{borderColor:r.display.color})}),f(tC,{datum:Cn(r)}),f("span",{style:Ao.value,children:r.display.name})]},r.id),[]),[t,e,o,n]);return o?f("div",{style:Ao.container,children:i}):null}const q={radius:10,borderColor:"#1f1f1f",strokeWidth:1,fillOpacity:0,SVGPadding:1};function oC(){const{height:e,width:t,margin:n,activeSpectrum:o,data:s,mode:i,toolOptions:{selectedTool:r},verticalAlign:l}=$(),{scaleX:a,scaleY:u}=ge();let p=c.exports.useContext(pt);const h=c.exports.useContext(At),[m,g]=c.exports.useState();return c.exports.useEffect(()=>{const x=o?ms(l,{index:(o==null?void 0:o.index)||1,align:"center"}):0,k=((v,C)=>{if(o&&p&&r===F.peakPicking.id){const E=[a().invert(C.x-v),a().invert(C.x+v)].sort((R,I)=>R-I),T=s.find(R=>R.id===o.id);if(!T)throw new Error("Unreachable");const M=Cn(T),D=M.x.findIndex(R=>R>=E[1])-1,P=M.x.findIndex(R=>R>=E[0]),A=M.y.slice(P,D);if(A&&A.length>0){const R=Ml(A),I=A.findIndex(L=>L===R),O=M.x[P+I];return{x:a()(O),y:u(o.id)(R)-x,xIndex:P+I}}}return null})(10,p);g(k)},[o,s,i,p,a,u,r,l]),r!==F.peakPicking.id||!m||!o||h.step==="brushing"||!p||p.y<n.top||p.left<n.left||p.x>t-n.right||p.y>e-n.bottom?null:f("div",{style:{cursor:"crosshair",transform:`translate(${m.x}px, ${m.y}px)`,transformOrigin:"top left",position:"absolute",top:-(q.radius+q.SVGPadding),left:-(q.radius+q.SVGPadding),pointerEvents:"none",overflow:"visible"},children:_("svg",{width:q.radius*2+q.SVGPadding*2,height:q.radius*2+q.SVGPadding*2,children:[f("circle",{cx:q.radius+q.SVGPadding,cy:q.radius+q.SVGPadding,r:q.radius,stroke:q.borderColor,strokeWidth:q.strokeWidth,fillOpacity:q.fillOpacity}),f("line",{x1:q.radius+q.SVGPadding,y1:q.SVGPadding,x2:q.radius+q.SVGPadding,y2:q.radius*2+q.SVGPadding,stroke:q.borderColor,strokeWidth:q.strokeWidth}),f("line",{x1:q.SVGPadding,y1:q.radius+q.SVGPadding,x2:q.radius*2+q.SVGPadding,y2:q.radius+q.SVGPadding,stroke:q.borderColor,strokeWidth:q.strokeWidth})]})},"peakPointer")}const sC={transformOrigin:"top left",position:"absolute",top:"0px",left:"0px",width:1,backgroundColor:"red"};function iC(){const{height:e,toolOptions:{selectedTool:t,data:{pivot:n}}}=$(),{scaleX:o}=ge();return F.phaseCorrection.id!==t?null:f("div",{style:S(b({},sC),{transform:`translate(${o()(n.value)}px, 0px)`,height:e})})}const rC={cursor:"crosshair",transformOrigin:"bottom right",position:"absolute",top:"-18px",left:"-30px",pointerEvents:"none",overflow:"visible",userSelect:"none"};function lC(){const{height:e,width:t,margin:n,data:o,activeSpectrum:s}=$(),{scaleX:i}=ge(),r=c.exports.useContext(pt),l=c.exports.useContext(At),a=c.exports.useMemo(()=>s?o.find(m=>m.id===s.id):null,[s,o]),u=Xe(a==null?void 0:a.info.nucleus),p=c.exports.useCallback(h=>{if(a){const m=i().invert(h);return u(m)}},[a,u,i]);return!s||l.step==="brushing"||!r||r.y<n.top||r.x<n.left||r.x>t-n.right||r.y>e-n.bottom?null:f("div",{style:S(b({},rC),{transform:`translate(${r.x}px, ${r.y}px)`}),children:f("span",{children:p(r.x)})},"xLabelPointer")}function aC({emptyText:e=void 0}){const{current:{display:{general:t}}}=re(),n=$(),{toolOptions:{selectedTool:o},isLoading:s,data:i,mode:r,width:l,height:a,margin:u,activeSpectrum:p,xDomain:h,xDomains:m,yDomain:g,yDomains:x,verticalAlign:y,displayerKey:k}=n,v=Y(),C=he(),E=le(),[T,M]=c.exports.useReducer(gv,nd);c.exports.useEffect(()=>{h.length>0&&g.length>0&&l&&a&&M({type:td,payload:{yDomain:g,yDomains:x,xDomain:h,xDomains:m,margin:u,height:a,width:l,verticalAlign:y,mode:r}})},[a,u,r,y,l,h,m,g,x]);const D=c.exports.useCallback(I=>{const O=()=>{if(!T.scaleX||!T.scaleY)return;const{startX:L,endX:H}=I,X=T.scaleX().invert(L),J=T.scaleX().invert(H);de.emit("brushEnd",S(b({},I),{range:[X,J].sort((z,j)=>z-j)}))};if(I.altKey)switch(o){case F.rangesPicking.id:{t!=null&&t.disableMultipletAnalysis||C.show(f(Hv,b({data:i,activeSpectrum:p,scaleX:T.scaleX},I)),{onClose:()=>{C.close()}});break}}else if(I.shiftKey)switch(o){case F.integral.id:v(b({type:gc},I));break;case F.rangesPicking.id:{const[L,H]=Wt(n,{startX:I.startX,endX:I.endX});if(!p)break;const{data:{x:X}}=n.data[p.index],{fromIndex:J,toIndex:z}=Un(X,{from:L,to:H});z-J<=Ro?v({type:Xc,payload:b({},I)}):E.error(`Advanced peak picking only available for area up to ${Ro} points`);break}case F.multipleSpectraAnalysis.id:v(b({type:su},I));break;case F.peakPicking.id:v(b({type:uc},I));break;case F.baseLineCorrection.id:v({type:Hc,zone:{from:I.startX,to:I.endX}});break;case F.exclusionZones.id:v({type:gu,payload:{from:I.startX,to:I.endX}});break;default:O();break}else switch(o){default:o!=null&&v(b({type:us},I));break}},[T,o,t==null?void 0:t.disableMultipletAnalysis,C,i,p,v,n,E]),P=c.exports.useCallback(()=>{v({type:xn,zoomType:Vn.STEP_HORIZONTAL})},[v]),A=c.exports.useCallback(I=>{v({type:cs,event:I,selectedTool:o})},[v,o]),R=c.exports.useCallback(I=>{const O=()=>{if(!T.scaleX)return;const L=T.scaleX().invert(I.x);de.emit("mouseClick",S(b({},I),{xPPM:L}))};if(I.shiftKey)switch(o){case F.peakPicking.id:v({type:cc,mouseCoordinates:I});break;case F.editRange.id:O();break}else switch(o){case F.phaseCorrection.id:v({type:Fi,position:I.x});break}},[v,T,o]);return f(xv,{value:T,children:f(ni,{children:({height:I,width:O})=>f(ed,{height:I,width:O,children:_("div",{style:{height:"100%",position:"relative"},children:[f(ju,{isLoading:s,emptyText:e}),T.scaleX&&T.scaleY&&i&&i.length>0&&f(na,{onBrush:D,onDoubleClick:P,onClick:R,onZoom:A,style:{width:"100%",height:"100%",margin:"auto",position:"relative",overflow:"hidden"},children:_(oa,{style:{width:"100%",height:"100%",position:"absolute"},children:[f(nC,{}),f(Bu,{}),f(Eo,{brushType:Pe.X}),f(lC,{}),f(oC,{}),f(iC,{}),f(eC,{}),f(q1,{width:l,height:a,margin:u,mode:r,displayerKey:k})]})})]})})})})}const go={container:{margin:"25px"},header:{backgroundColor:"#ffffff",padding:"20px",borderRadius:"10px",fontSize:"30px",textAlign:"center"},title:{textDecoration:"underline"},body:{marginTop:"10px",whiteSpace:"pre-wrap",backgroundColor:"white",padding:"20px",borderRadius:"10px",color:"red"}};function cC(e){return _("div",{style:go.container,children:[f("p",{style:go.header,children:"Something went wrong."}),_("details",{style:go.body,children:[f("p",{style:go.title,children:e.error.message}),e.error.stack]})]})}const uC={success:{base:"#2dd36f",shade:"#28ba62",tint:"#42d77d"},danger:{base:"#eb445a",shade:"#cf3c4f",tint:"#ed576b"},warning:{base:"#ffc409",shade:"#e0ac08",tint:"#ffca22"},medium:{base:"#92949c",shade:"#808289",tint:"#9d9fa6"},light:{base:"#f4f5f8",shade:"#d7d8da",tint:"#f5f6f9"}},dC={xSmall:{fontSize:"0.75rem",padding:"0.15rem 0.3rem",borderRadius:"0.15rem"},small:{fontSize:"0.8rem",padding:"0.25rem 0.5rem",borderRadius:"0.2rem"},medium:{fontSize:"1rem",padding:"0.375rem 0.75rem",borderRadius:"0.25rem"},large:{fontSize:"1.25rem",padding:"0.5rem 1rem",borderRadius:"0.3rem"}};function pC(e){const{borderColor:t,fill:n,backgroundColor:o,color:s}=e;switch(n){case"solid":return N`
...
`,mC={name:"",compressed:!1,pretty:!1,dataExportOption:vt.ROW_DATA};function gC({onClose:e,onSave:t,name:n}){const o=c.exports.useRef(),s=c.exports.useCallback(()=>{o.current.submitForm()},[]),i=c.exports.useCallback(r=>{t(r),e==null||e()},[e,t]);return w("div",{css:[mt,fC],children:[w("div",{className:"header handle",children:[d("span",{children:"Save as ... "}),d(fe,{onClick:e,className:"close-bt"})]}),d("div",{className:"inner-content",children:w(ce,{ref:o,initialValues:S(b({},mC),{name:n}),onSubmit:i,children:[w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Name"}),d(W,{name:"name",className:"name",style:{inputWrapper:{width:"100%"}}})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Compressed"}),d(xt,{name:"compressed"})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Pretty Format"}),d(xt,{name:"pretty"})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:" Include "}),w("div",{className:"data-export-group",children:[w("label",{children:[d(mr,{type:"radio",name:"dataExportOption",value:vt.ROW_DATA}),"Raw Data"]}),w("label",{children:[d(mr,{type:"radio",name:"dataExportOption",value:vt.DATA_SOURCE}),"Data Source"]})]})]})]})}),d("div",{className:"footer-container",children:d(st,{style:{flexDirection:"row-reverse",margin:0},onDone:s,doneLabel:"Save",onCancel:()=>e==null?void 0:e()})})]})}function xC(e){var s,i;let t=document.createElement("div");t.innerHTML=e,t.style.position="fixed",t.style.pointerEvents="none",t.style.opacity="0";let n=Array.prototype.slice.call(document.styleSheets).filter(r=>!r.disabled);document.body.appendChild(t),(s=window.getSelection())==null||s.removeAllRanges();let o=document.createRange();o.selectNode(t),(i=window.getSelection())==null||i.addRange(o),document.execCommand("copy");for(const r of n)r.disabled=!0;document.execCommand("copy");for(const r of n)r.disabled=!1;document.body.removeChild(t)}async function bC(e){try{return xC(e),!0}catch{return!1}}async function xs(e){try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}async function Kr(e,t="experiment",n=0,o=!1){const s=JSON.stringify(e,(i,r)=>ArrayBuffer.isView(r)?Array.from(r):r,n);if(o)try{const i=new un;i.file(`${t}.nmrium`,s);const r=await i.generateAsync({type:"blob",compression:"DEFLATE",compressionOptions:{level:9}});pn.exports.saveAs(r,`${t}.nmrium`)}catch(i){console.log(i)}else{const i=new Blob([s],{type:"text/plain"});pn.exports.saveAs(i,`${t}.nmrium`)}}function yC(e,t,n="experiment"){const o=["name","experiment"];for(const r of e[0].data.x)o.push(r);let s=`${o.join("	")}
...
${Number(C.delta).toFixed(y)}`;else continue;let T="";if(C.diaIDs&&C.diaIDs.length>0&&(C.diaIDs.forEach((M,D,P)=>{let A=", ";D===P.length-1&&(A=""),T+=`${s.byDiaID[M].label||M}${A}`}),u+=`, L=${T}`),h==="1H"){C.multiplicity&&(u+=`, S=${C.multiplicity}`);let M=C.js;if(Array.isArray(M)&&M.length){let D=", J=";for(const P of M){if(u+=`${D}${Number(P.coupling).toFixed(3)}`,P.diaIDs){let{diaIDs:A}=P;if(Array.isArray(A)||(A=[A]),!A.length)continue;u+=`(${s.byDiaID[A[0]].label||String(A[0])})`}D=", "}}k.integration?u+=`, E=${Number(k.integration).toFixed(y)}`:k.nbAtoms?u+=`, E=${k.nbAtoms.toFixed(y)}`:k.signals[0].nbAtoms!==void 0&&(u+=`, E=${k.signals[0].nbAtoms}`)}}v.length&&(u+="\\")}u+=`
`,/\n/.exec(u)&&(i+=u)}return i}function DC(e){switch(e.toLowerCase()){case"hsqc":case"cosy":return"1J";case"hmbc":return"NJ";default:return"NJ"}}const PC=Array.isArray;async function RC(e,t,n={labels:{}}){const{byDiaID:o}=n.labels;let s="";const i=`
...
Larmor=${Number(r.info.baseFrequency[0]).toFixed(2)}\\`);let y=r.zones.values||[];for(let k of y){let v=k.signals;for(let C of v){let{x:E,y:T,peaks:M}=C,D=qr(E,o,x[0]),P=qr(T,o,x[1]),A=Math.max(...M.map(R=>R.z));l+=`
${D}/${P}, I=${A.toFixed(2)}\\`}}s+=l}return s.length>0?`${s}
`:""}function qr(e,t,n){let{diaIDs:o,delta:s}=e;if(o){if(PC(o)||(o=[o]),o.length<1)return Number(s).toFixed(n);let i=o.map(r=>t[r].label).join(",");return o.length>1?`(${i})`:i}return Number(s).toFixed(n)}function IC(e){let t=[];for(const{x:n,y:o}of e)t.push(n,o);return t}function MC(e,t={groupedDiaIDs:[]}){const{groupedDiaIDs:n,molecule:o}=t;let s=_p(o,{toLabel:"H",maxLength:1}),i={},r={};for(let l of e){let{dimension:a,nucleus:u}=l.info,p=Ji(u),[h,m]=a>1?["zones",IC]:["ranges",x=>x||[]],g=l[h].values||[];for(let x of g){let y=m(x.signals);for(let k=0;k<y.length;k++){let v=y[k].diaIDs||[];for(let C of v){let E=Number(y[k].delta).toFixed(p[k%a]),T=n.find(D=>D.oclID===C),M={atom:T.atoms[0],molecule:o,connections:s,atomLabel:T.atomLabel};i[C]={atoms:T.atoms.map(D=>D+1),shift:E,label:Jr(M)};for(let D of T.atoms)M.atom=D,r[D]={shift:E,diaID:C,label:Jr(M)}}}}}return{byAssignNumber:r,byDiaID:i}}function Jr(e){const{atom:t,molecule:n,atomLabel:o,connections:s}=e;let i="";if(o!=="C"){let l=s[t].find(p=>p&&p.length>1),a=`${o}${l[0]+1}`,u=`${n.getAtomLabel(l[1])}${l[1]+1}`;i=`${a}${u}`}else i=`${o}${t+1}`;return i}const Qi={solvent:"SOLVENT",temperature:"TEMPERATURE",assignment:"ASSIGNMENT",j:"J",signals:"SIGNALS",id:"ID"};async function NC(e,t={}){const{data:n,molecules:o}=e||{data:[],molecules:[]};let s=new un;for(const i of o)await Qr(n,s,S(b({},t),{molecule:i}));return o.length||await Qr(n,s,t),s}async function Qr(e,t,n={}){let{id:o,prefix:s=`
> <NMREDATA_`,filename:i="nmredata",molecule:r}=n,l="",a;r&&(r=Xt.Molecule.fromMolfile(r.molfile),l+=r.toMolfile(),r.addImplicitHydrogens(),a=Fp(r));let u=r?MC(e,{groupedDiaIDs:a,molecule:r}):{byDiaID:void 0,byAssignNumber:void 0};l+=`${s}VERSION>
1.1\\
`,l+=el(e,"temperature",{prefix:s}),l+=el(e,"solvent",{prefix:s}),o&&(l+=`${s+Qi.id}>
id\\
`),l+=_C(u.byDiaID,{prefix:s}),l+=await TC(e,t,{prefix:s,labels:u}),l+=await RC(e,t,{prefix:s,labels:u}),l+=`
$$$$
...
`;function $C({counter:e,onDelete:t=()=>null,deleteToolTip:n="Delete",onFilter:o=()=>null,filterToolTip:s="",filterIsActive:i=!1,counterFiltered:r=0,children:l,onSettingClick:a=()=>null,showSettingButton:u=!1,canDelete:p=!0,style:h={},className:m=""}){return w("div",{css:OC,style:h,className:m,children:[w("div",{className:"left-container",children:[p&&d(Ee,{title:n,popupPlacement:"right",children:d("button",{type:"button",onClick:t,disabled:e===0,children:d(Et,{})})}),s?d(We,{popupTitle:s,popupPlacement:"right",onClick:o,defaultValue:i,children:d(Lp,{style:{pointerEvents:"none",fontSize:"12px"}})}):null,l]}),e!==void 0&&w("p",{className:"counter-label",children:["["," ",i&&i===!0&&r!==void 0?`${r}/${e}`:e," ","]"]}),u&&d(Ee,{title:"preferences",popupPlacement:"left",children:d("button",{type:"button",onClick:a,children:d(Op,{})})})]})}var it=c.exports.memo($C);function HC(){const e=c.exports.useCallback(()=>{},[]);return w("div",{css:Rt,children:[d(it,{showSettingButton:!1,canDelete:!1,children:d(Se,{popupTitle:"automatic assignment",onClick:e,children:d($p,{style:{fontSize:"18px"}})})}),d("div",{className:"inner-container"})]})}const zC=N`
...
`;function ck({onClose:e,onSave:t}){return w("div",{css:ak,children:[d(fe,{onClick:e,popupTitle:"close Preferences"}),d(tr,{onClick:t,popupTitle:"save Preferences"})]})}var Dn=c.exports.memo(ck);function uk(e,t){const{onSave:n=()=>null,value:o,type:s="text",style:i,onEditStart:r=()=>null,editStatus:l=!1}=e,[a,u]=c.exports.useState();c.exports.useEffect(()=>{u(l)},[l]),c.exports.useImperativeHandle(t,()=>({startEdit:()=>{u(!0)},closeEdit:()=>{u(!1)}}));const p=c.exports.useCallback(m=>{m.target.classList.contains("editable-column")||(u(!1),window.removeEventListener("mousedown",p))},[]),h=c.exports.useCallback((m,g=null)=>{m?(window.addEventListener("mousedown",p),r(g),u(m)):(["Enter","Tab"].includes(g.key)&&n(g),["Enter","Tab","Escape"].includes(g.key)&&(u(m),window.removeEventListener("mousedown",p)))},[p,r,n]);return _("div",{style:b({display:"table",width:"100%",height:"100%"},i),onDoubleClick:m=>h(!0,m),children:[!a&&f("span",{style:{display:"table-cell",verticalAlign:"middle"},children:o}),a&&f("div",{style:{display:"table-cell",verticalAlign:"middle"},children:f(wt,{enableAutoSelect:!0,className:"editable-column",value:o,type:s,onKeyDown:m=>h(!1,m)})})]})}var ct=c.exports.forwardRef(uk);const dk=N`
...
`;function jk({integrals:e,info:t,activeTab:n,xDomain:o,preferences:s}){var D;const[i,r]=c.exports.useState(!1),l=Y(),a=he(),[u,p]=c.exports.useState(!1),h=c.exports.useRef(),m=c.exports.useCallback(()=>{l({type:as,integralID:null})},[l]),g=c.exports.useCallback(()=>{a.showConfirmDialog({message:"All records will be deleted, Are You sure?",buttons:[{text:"Yes",handler:m},{text:"No"}]})},[a,m]),x=c.exports.useCallback(P=>{l({type:$c,value:P}),a.close()},[l,a]),y=c.exports.useMemo(()=>V(e,"options.sum",null),[e]),k=c.exports.useCallback(()=>{a.show(d(Td,{onClose:()=>a.close(),onSave:x,header:y?`Set new Integrals Sum (Current: ${Number(y).toFixed(2)})`:"Set new Integrals Sum",sumOptions:e==null?void 0:e.options}))},[x,y,e==null?void 0:e.options,a]),v=c.exports.useCallback(()=>{p(!u)},[u]),C=c.exports.useCallback(()=>{h.current.saveSetting(),p(!1)},[]),E=c.exports.useCallback(()=>{r(!i)},[i]),T=c.exports.useCallback(P=>{l({type:yu,payload:P})},[l]),M=c.exports.useMemo(()=>{function P(A,R){return R=R*1e4,A=A*1e4,R>=o[0]*1e4&&A<=o[1]*1e4||A<=o[0]*1e4&&R>=o[1]*1e4}return t.dimension===1&&(e==null?void 0:e.values)?(i?e.values.filter(R=>P(R.from,R.to)):e.values).map(R=>S(b({},R),{isConstantlyHighlighted:P(R.from,R.to)})):[]},[i,t.dimension,e,o]);return d(c.exports.Fragment,{children:w("div",{css:[Rt,Vk,u&&N`
              th {
                position: relative;
              }
            `],children:[!u&&w(it,{counter:(D=e==null?void 0:e.values)==null?void 0:D.length,onDelete:g,deleteToolTip:"Delete All Integrals",onFilter:E,filterToolTip:i?"Show all integrals":"Hide integrals out of view",filterIsActive:i,counterFiltered:M.length,showSettingButton:!0,onSettingClick:v,children:[d(Ee,{title:y?`Change Integrals Sum (${Number(y).toFixed(2)})`:"Change Integrals Sum",popupPlacement:"right",children:d("button",{className:"sum-button",type:"button",onClick:k,children:d(zl,{})})}),d(We,{className:"fix-integral-toggle-btn",popupTitle:"fix integral values",popupPlacement:"right",onClick:T,children:d(Vl,{})})]}),u&&d(Dn,{onSave:C,onClose:v}),d("div",{className:"inner-container",children:u?d(zk,{ref:h}):d(Pk,{data:M,activeTab:n,preferences:s})})]})})}const Bk=c.exports.memo(jk),Xk={integrals:{},info:{}};function Yk(){const{xDomain:e,activeTab:t}=$(),n=re(),{integrals:o,info:s}=Ce(Xk);return d(Bk,{integrals:o,info:s,preferences:n.current,xDomain:e,activeTab:t})}function Q(e){const{title:t,className:n="",children:o,style:s}=e;return _("div",{style:{display:"flex",alignItems:"center"},children:[f("span",{className:n,style:b({fontSize:"11px",fontWeight:"bold",color:"#232323",paddingRight:"10px",width:"max-content"},s==null?void 0:s.label),children:t}),f("div",{style:s==null?void 0:s.wrapper,children:o})]})}const Gk={from:-1,to:1,nbPoints:1024};function Wk({onClose:e=()=>null}){const t=c.exports.useRef(),{data:n}=$(),o=c.exports.useCallback(()=>{t.current.submitForm()},[]),s=c.exports.useCallback(i=>{yC(n,i,"fileName"),e()},[n,e]);return c.exports.useEffect(()=>{function i(r){const[l,a]=r.range;t.current.setValues(S(b({},t.current.values),{from:l,to:a}))}return de.on("brushEnd",i),()=>{de.off("brushEnd",i)}},[]),w("div",{css:mt,children:[w("div",{className:"header handle",children:[d("span",{children:"Export spectra as a Matrix"}),d(fe,{onClick:e,className:"close-bt"})]}),d("div",{className:"inner-content",children:w(ce,{ref:t,initialValues:Gk,onSubmit:s,children:[w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Range :"}),d(Q,{title:"From : ",children:d(W,{name:"from",type:"number"})}),d(Q,{title:"To : ",children:d(W,{name:"to",type:"number"})})]}),d("div",{className:"row margin-10",children:d(Q,{title:"Number of Points :",className:"custom-label",children:d(W,{name:"nbPoints",type:"number"})})})]})}),d("div",{className:"footer-container",children:d(me.Done,{onClick:o,children:"Export Now"})})]})}function Zk({onSubmit:e},t){const{xDomain:n}=$();return _(ce,{ref:t,initialValues:{from:n[0],to:n[1],numberOfPoints:1024},onSubmit:e,children:[_("div",{className:"row margin-10",children:[f("span",{className:"custom-label",children:"Range :"}),f(Q,{title:"From : ",children:f(W,{name:"from",type:"number"})}),f(Q,{title:"To : ",children:f(W,{name:"to",type:"number"})})]}),f("div",{className:"row margin-10",children:f(Q,{className:"custom-label",title:"Number of points : ",children:f(W,{name:"numberOfPoints",type:"number"})})})]})}var Uk=c.exports.forwardRef(Zk);function Kk({onSubmit:e},t){const{xDomain:n}=$();return f(ce,{ref:t,initialValues:{from:n[0],to:n[1]},onSubmit:e,children:_("div",{className:"row margin-10",children:[f("span",{className:"custom-label",children:"Range :"}),f(Q,{title:"From :",children:f(W,{name:"from",type:"number"})}),f(Q,{title:"To :",children:f(W,{name:"to",type:"number"})})]})})}var qk=c.exports.forwardRef(Kk);const Jk=[{key:0,value:0,label:"Select Filter"},{key:Io,value:Io,label:ga},{key:Bn,value:Bn,label:pa},{key:js,value:js,label:wa},{key:Hs,value:Hs,label:ca},{key:Vs,value:Vs,label:va}],Qk=N`
  .row {
    align-items: center;
  }
...
`;function eS({onClose:e=()=>null,nucleus:t=""}){const n=c.exports.useRef(),o=Y(),[s,i]=c.exports.useState(""),r=c.exports.useMemo(()=>{const h=Ot[t]?Object.entries(Ot[t]).map(m=>({key:m[0],value:m[0],label:m[0]}),[]):[];return Jk.concat(h)},[t]),l=c.exports.useCallback(h=>{h.preventDefault(),n.current&&n.current.submitForm()},[]),a=c.exports.useCallback(h=>{h&&(o({type:mu,payload:[{name:s,options:h}]}),e())},[o,s,e]);c.exports.useEffect(()=>{function h(m){const[g,x]=m.range;n.current&&n.current.setValues(S(b({},n.current.values),{from:g,to:x}))}return de.on("brushEnd",h),()=>{de.off("brushEnd",h)}},[]);const u=c.exports.useCallback(h=>{i(h)},[]),p=c.exports.useMemo(()=>{switch(s){case Io:return d(qk,{onSubmit:a,ref:n});case Bn:return d(Uk,{onSubmit:a,ref:n})}},[s,a]);return w("div",{css:[mt,Qk],children:[w("div",{className:"header handle",children:[d("span",{children:"Apply filters"}),d(fe,{onClick:e,className:"close-bt"})]}),w("div",{className:"inner-content container",children:[d("p",{className:"infoText",children:"This filter will use the exclusions zones defined in the first spectrum."}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Filter :"}),d(Ne,{data:r,style:{width:275,height:30,margin:0},onChange:u})]}),p]}),d("div",{className:"footer-container",children:d(st,{style:{flexDirection:"row-reverse",margin:0},onDone:l,doneLabel:"Save",onCancel:e,cancelLabel:"Close"})})]})}function tS(){const e=he(),t=Y(),n=c.exports.useCallback(()=>{t({type:ze}),e.show(d(eS,{}),{isBackgroundBlur:!1,position:te.TOP_CENTER,width:550,height:250})},[e,t]),o=c.exports.useCallback(()=>{t({type:ze}),e.show(d(Wk,{}),{isBackgroundBlur:!1,position:te.TOP_CENTER,width:500})},[e,t]);return w("div",{css:Rt,children:[w(it,{deleteToolTip:"Delete All Peaks",showSettingButton:!0,canDelete:!1,children:[d(Se,{popupTitle:"Add Filter",onClick:n,children:d(Bp,{style:{fontSize:"18px"}})}),d(Se,{popupTitle:"Export spectra as a Matrix",onClick:o,children:d(Xp,{})})]}),d("div",{className:"inner-container"})]})}function nS(e){const{onClose:t=()=>null,selectedMolecule:n}=e,[o,s]=c.exports.useState(null),i=Y();c.exports.useEffect(()=>{s(n?n.molfile:null)},[n]);const r=c.exports.useCallback(u=>{var h,m;const p=(m=(h=/(?<s>M {2}V30 BEGIN BOND)(?<mol>.*?)(?<e>M {2}V30 END BOND)/gs.exec(u))==null?void 0:h.groups)==null?void 0:m.mol;s(p!=null&&p.trim()?u:null)},[s]),l=c.exports.useCallback(()=>{t()},[t]),a=c.exports.useCallback(()=>{n?(i({type:Ii,molfile:o,key:n.key}),t("replace")):(i({type:Ri,molfile:o}),t("new"))},[i,n,o,t]);return w("div",{css:mt,children:[d(Yp,{initialMolfile:n==null?void 0:n.molfile,svgMenu:!0,fragment:!1,onChange:r}),d("div",{className:"footer-container",children:d(st,{style:{flexDirection:"row-reverse",margin:0},onDone:a,doneLabel:"Save",onCancel:l})})]})}const oS=N`
  .menu {
...
`,fS=[{id:"molfile",icon:d(si,{}),label:"Copy as molfile"},{id:"png",icon:d(Bl,{}),label:"Copy as PNG"},{id:"svg",icon:d(Xl,{}),label:"Export as SVG"}];function mS({currentIndex:e,molecules:t,onMoleculeIndexChange:n=()=>null,onOpenMoleculeEditor:o=()=>null,actionsOptions:s={}}){const{rootRef:i}=fs(),r=le(),l=Y(),a=he(),u=Be(),p=c.exports.useCallback(()=>{!i||bd(i,`molSVG${e}`,"molFile")},[i,e]),h=c.exports.useCallback(()=>{!i||(yd(i,`molSVG${e}`),r.success("MOL copied as PNG to clipboard"))},[i,r,e]),m=c.exports.useCallback(()=>{t[e]&&xs(t[e].molfile).then(v=>{v?r.success("MOLFile copied to clipboard"):r.error("copied not completed")})},[r,e,t]),g=c.exports.useCallback(({id:v})=>{switch(v){case"molfile":m();break;case"png":h();break;case"svg":p();break}},[m,h,p]),x=c.exports.useCallback(()=>{navigator.clipboard.readText().then(v=>{l({type:Ri,molfile:v})})},[l]),y=c.exports.useCallback(()=>{var v;(v=t[e])!=null&&v.key&&(n(0),l({type:xc,payload:{key:t[e].key,assignmentData:u}}))},[t,e,n,l,u]),k=c.exports.useCallback(()=>{a.show(d(pS,{molfile:t[e]}),{position:te.TOP_CENTER,enableResizing:!0,width:600})},[a,t,e]);return w("div",{css:hS,children:[!s.hideExport&&d(rS,{component:d(Jo,{}),toolTip:"Export As",items:fS,onClick:g}),!s.hidePast&&d(Ee,{title:"Paste molfile",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:x,children:d(Gp,{})})}),!s.hideAdd&&d(Ee,{title:"Add Molecule",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:o,"data-test-id":"panel-structures-button-add",children:d(yn,{})})}),!s.hideDelete&&d(Ee,{title:"Delete Molecule",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:y,children:d(Et,{})})}),!s.hidePredict&&t&&t.length>0&&d(Se,{popupTitle:"Predict Spectra",popupPlacement:"left",onClick:k,children:d(jl,{})}),w("p",{children:[t&&t.length>0&&`${+(e+1)} / ${t.length}`," "]})]})}function rl(e,t,n){if(t.length>0&&Object.keys(e).length>0){const o=n==="x"?0:n==="y"?1:void 0;if(o!==void 0){if(t[o]===e.atomLabel)return{oclIDs:[e.oclID],nbAtoms:e.nbAtoms};if(t[o]==="H")return{oclIDs:e.hydrogenOCLIDs,nbAtoms:e.nbAtoms*e.nbHydrogens}}else return{oclIDs:[e.oclID].concat(e.hydrogenOCLIDs),nbAtoms:e.nbAtoms+e.nbAtoms*e.nbHydrogens}}return{oclIDs:[],nbAtoms:0}}function Yo(e,t){let n=e.find(s=>s.id===t),o;if(!n){for(const s of e)if(o=s.signals.findIndex(i=>i.id===t),o>=0){n=s;break}}return{datum:n,signalIndex:o}}function gS(e,t,n){let o=[];for(let s in e.assignment.assignment){let i,r,l=!1;if((e.assignment.assignment[s].x||[]).some(a=>t.includes(a))){o=o.concat(e.assignment.assignment[s].x);const a=Yo(n,s);i=a.datum,r=a.signalIndex,l=!0}if((e.assignment.assignment[s].y||[]).some(a=>t.includes(a))){o=o.concat(e.assignment.assignment[s].y);const a=Yo(n,s);i=a.datum,r=a.signalIndex,l=!0}if(i&&(o.push(i.id),r!==void 0&&o.push(i.signals[r].id)),l)break}return o}function xS(e,t){const n=e.assignment.isOnHover?e.assignment.assignment[e.assignment.onHoverID]:null,o=e.assignment.isOnHover?e.assignment.onHoverAxis:null;return n?t===B.DM_1D?n.x||[]:t===B.DM_2D?o?o==="x"?n.x||[]:o==="y"?n.y||[]:(n.x||[]).concat(n.y||[]):(n.x||[]).concat(n.y||[]):[]:[]}function bS(e,t){let n=e?e.slice():[];const{nbAtoms:o,oclIDs:s}=t;let i=o;return s.forEach(r=>{n.includes(r)?(i*=-1,n=n.filter(l=>l!==r)):n.push(r)}),[n,i]}function yS({displayerMode:e,activeTab:t,zones:n,ranges:o}){const s=le(),i=Y(),r=An(),l=Be(),a=dt(l.assignment.activeID!==void 0?l.assignment.activeID:Ju),[u,p]=c.exports.useState([]),[h,m]=c.exports.useState(null),[g,x]=c.exports.useState([]);c.exports.useEffect(()=>{if(t){const D=t.split(",");D.length===1?x([t.replace(/[0-9]/g,"")]):D.length===2&&x(D.map(P=>P.replace(/[0-9]/g,"")))}},[t]),c.exports.useEffect(()=>{h&&(h==="show"?r.dispatch({type:"SHOW",payload:{convertedHighlights:u}}):h==="hide"&&(r.dispatch({type:"HIDE",payload:{convertedHighlights:u}}),p([])),m(null))},[h,u,r]);const y=c.exports.useMemo(()=>{if(n||o){if(e===B.DM_1D&&o&&o.values)return o.values;if(e===B.DM_2D&&n&&n.values)return n.values}return[]},[e,o,n]),k=c.exports.useMemo(()=>{const D={x:[],y:[]};for(let P in l.assignment.assignment)l.assignment.assignment[P].x&&D.x.push(...l.assignment.assignment[P].x),l.assignment.assignment[P].y&&D.y.push(...l.assignment.assignment[P].y);return D},[l.assignment]),v=c.exports.useMemo(()=>k.x.concat(k.y),[k.x,k.y]),C=c.exports.useMemo(()=>{let D=[];return r.highlight.highlighted.forEach(P=>{var R;if(l.assignment.assignment[P]){const{datum:I}=Yo(y,P),O=(R=r.highlight.sourceData)==null?void 0:R.type;I&&(O===ue.ZONE||O===ue.RANGE)&&(D=D.concat(I.signals.map(L=>Yi(l,[L.id]).length>0?L.diaIDs:[]).flat()))}}),xS(l,e).concat(D)},[l,y,e,r.highlight]),E=c.exports.useCallback((D,P)=>bS(D,P),[]),T=c.exports.useCallback((D,P)=>{var A;if(!Yt(P)&&a.isActive){const R=rl(D,g,a.activeAxis);if(R.nbAtoms>0){R.oclIDs.forEach(L=>{a.toggle(L)});const{datum:I,signalIndex:O}=Yo(y,a.id);if(I){let L=[],H=0;O===void 0?e===B.DM_1D?[L,H]=E(I.diaIDs||[],R):e===B.DM_2D&&([L,H]=E(I[a.activeAxis].diaIDs||[],R)):(A=I.signals)!=null&&A[O]&&(e===B.DM_1D?[L,H]=E(I.signals[O].diaIDs||[],R):e===B.DM_2D&&([L,H]=E(I.signals[O][a.activeAxis].diaIDs||[],R))),e===B.DM_1D?i({type:nu,payload:{nbAtoms:H,rangeData:I,diaIDs:L,signalIndex:O}}):e===B.DM_2D&&i({type:pu,payload:{nbAtoms:H,zoneData:I,diaIDs:L,axis:a.activeAxis,signalIndex:O}})}a.onClick(a.activeAxis)}else s.info("Not assigned! Different atom type or no attached hydrogens found!")}},[a,s,y,i,e,g,E]);return{handleOnAtomHover:c.exports.useCallback(D=>{const P=rl(D,g,a.activeAxis).oclIDs;if(P.length>0){const A=gS(l,P,y);p(A),m("show")}else m("hide")},[a.activeAxis,l,y,g]),handleOnClickAtom:T,currentDiaIDsToHighlight:C,assignedDiaIDsMerged:v}}const Nt={panel:N({display:"flex",overflow:"auto",flexGrow:1,width:"100%",height:"100%",flexDirection:"column"}),innerPanel:N({display:"flex",flex:"1",flexDirection:"column",overflow:"auto"}),molecule:N({display:"flex",flex:"1"}),toolbar:N({display:"flex",borderBottom:"0.55px solid rgb(240, 240, 240)",padding:"0px 10px",justifyContent:"end",height:22}),slider:N({display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",flexGrow:1,minHeight:0}),items:N({display:"flex",flexDirection:"column",flex:"1 1 0%",height:"100%",minHeight:0})};function vS({zones:e,ranges:t,molecules:n,activeTab:o,displayerMode:s,onMoleculeChange:i,actionsOptions:r,children:l}){const[a,u]=c.exports.useState(0),[p,h]=c.exports.useState([]),m=Y(),g=he(),{currentDiaIDsToHighlight:x,handleOnAtomHover:y,handleOnClickAtom:k,assignedDiaIDsMerged:v}=yS({zones:e,ranges:t,activeTab:o,displayerMode:s});c.exports.useEffect(()=>{n&&h(M=>(n.length>M.length&&u(p.length),n))},[p.length,n]),c.exports.useEffect(()=>{i==null||i(p[a]||null)},[a,p,i]);const C=c.exports.useCallback((M,D)=>{m({type:Ii,molfile:D,key:M})},[m]),E=c.exports.useCallback((M=null)=>{g.show(d(nS,{selectedMolecule:M}),{position:te.TOP_CENTER,width:700,height:500})},[g]),T=c.exports.useCallback(M=>{u(M)},[]);return w("div",{css:Nt.panel,children:[d(mS,{currentIndex:a,molecules:p,onOpenMoleculeEditor:()=>E(),onMoleculeIndexChange:T,actionsOptions:r}),w("div",{css:Nt.innerPanel,children:[d("div",{css:Nt.molecule,children:d(Ed,{onChange:M=>u(M),defaultIndex:a,children:p&&p.length>0?p.map((M,D)=>{var P;return w("div",{css:Nt.items,children:[w("span",{css:Nt.toolbar,children:[d(ti,{mf:M.mf})," - ",(P=M.mw)==null?void 0:P.toFixed(2)]}),d("div",{css:Nt.slider,className:"mol-svg-container",onDoubleClick:()=>E(M),style:{backgroundColor:(D+1)%2!==0?"#fafafa":"white"},children:d(ni,{children:({height:A,width:R})=>d(Wp,{OCL:Xt,id:`molSVG${D}`,width:R,height:A,molfile:M.molfile||"",setMolfile:I=>C(M.key,I),setSelectedAtom:k,atomHighlightColor:x&&x.length>0?"red":"#FFD700",atomHighlightOpacity:.35,highlights:x&&x.length>0?x:v,setHoverAtom:y})})})]},M.key)}):d("div",{css:Nt.slider,style:{height:"100%"},onClick:()=>E(),children:d("span",{children:"Click to draw molecule"})})})}),l]})]})}const CS=c.exports.memo(vS),kS={ranges:{},zones:{}};function Rd({onMoleculeChange:e,children:t,actionsOptions:n}){const{molecules:o,displayerMode:s,activeTab:i}=$(),r=Ce(kS),l=(r==null?void 0:r.ranges)||{},a=(r==null?void 0:r.zones)||{};return d(CS,{molecules:o,displayerMode:s,activeTab:i,ranges:l,zones:a,onMoleculeChange:e,actionsOptions:n,children:t})}const SS=[{key:1,value:"manual",label:"Manual"}];function wS({onClose:e=()=>null,nucleus:t}){const n=c.exports.useRef(),o=Y(),s=c.exports.useMemo(()=>{const a=Ot[t]?Object.entries(Ot[t]).map(u=>({key:u[0],value:u[0],label:u[0]}),[]):[];return SS.concat(a)},[t]),i=c.exports.useCallback(()=>{n.current.submitForm()},[]),r=c.exports.useCallback(a=>{o({type:au,payload:a}),e()},[o,e]);c.exports.useEffect(()=>{function a(u){const[p,h]=u.range;n.current.setValues(S(b({},n.current.values),{from:p,to:h}))}return de.on("brushEnd",a),()=>{de.off("brushEnd",a)}},[]);const l=c.exports.useCallback(a=>{const m=Ot[t][a]||{delta:0},{delta:p=0}=m,h=G(m,["delta"]);n.current.setValues(b(S(b({},n.current.values),{targetX:p}),h))},[t]);return w("div",{css:mt,children:[w("div",{className:"header handle",children:[d("span",{children:"Spectra calibration"}),d(fe,{onClick:e,className:"close-bt"})]}),d("div",{className:"inner-content",style:{flex:1},children:w(ce,{ref:n,initialValues:{from:-1,to:1,nbPeaks:1,targetX:0},onSubmit:r,children:[w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Options :"}),d(Ne,{data:s,style:{width:270,height:30,marginBottom:"20px"},onChange:l})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Range :"}),d(Q,{title:"From : ",children:d(W,{name:"from",type:"number"})}),d(Q,{title:"To : ",children:d(W,{name:"to",type:"number"})})]}),d("div",{className:" margin-10",children:d(Q,{className:"custom-label",title:"Number of Peaks : ",children:d(W,{name:"nbPeaks",type:"number"})})}),d("div",{className:" margin-10",children:d(Q,{className:"custom-label",title:"Target PPM :",children:d(W,{name:"targetX",type:"number"})})})]})}),d("div",{className:"footer-container",children:d(me.Done,{onClick:i,children:"Done"})})]})}function Id(e,t=null){try{return new Function("args",`return ${e}`)(t)}catch(n){return n}}const ES=`function run(data) {

  return JSON.stringify(data,undefined, 2);
  
}(args);
`;function AS({data:e}){const{values:t,setFieldValue:n}=pe(),[o,s]=c.exports.useState(t.code?t.code:ES),[i,r]=c.exports.useState("");return c.exports.useEffect(()=>{const l=Id(o,e);l instanceof Error?r(l.message):(n("code",o),r(l))},[o,e,n]),w("div",{style:{marginTop:"20px"},children:[d("textarea",{value:o,onChange:l=>s(l.target.value),style:{fontFamily:'"Fira code", "Fira Mono", monospace',fontSize:12,padding:"1em",width:"90%",backgroundColor:"#fcfcfc",marginBottom:"10px",minHeight:"100px",overflow:"auto",maxHeight:"200px"}}),d("p",{style:{marginBottom:"5px"},children:"Result:"}),d("textarea",{value:i,readOnly:!0,style:{border:"0.55px solid #f3f3f3",fontFamily:'"Fira code", "Fira Mono", monospace',fontSize:12,padding:"1em",width:"90%",marginBottom:"10px",minHeight:"100px",overflow:"auto",maxHeight:"200px"}})]})}var TS=c.exports.memo(AS);const DS=N`
  width: 100%;
  thead {
...
`;function JS({text:e,onClose:t,onCopyClick:n}){return w("div",{css:qS,children:[w("div",{className:"mainButtonsContainer handle",children:[d("button",{type:"button",onClick:()=>n(e),children:d(si,{})}),d(fe,{onClick:t})]}),d("div",{className:"innerContainer",dangerouslySetInnerHTML:{__html:e}})]})}const QS=N`
  .btn {
    background-color: transparent;
    border: none;
  }
...
`;function hw({push:e,remove:t,onFocus:n,onBlur:o}){const{values:s,setFieldValue:i}=pe(),r=c.exports.useCallback((a,u)=>{Zn(a)||i(u,"")},[i]),l=c.exports.useMemo(()=>Wn.map(a=>S(b({key:a.value},a),{value:a.label})),[]);return d("table",{css:pw,children:w("tbody",{children:[w("tr",{children:[d("th",{children:"#"}),d("th",{children:"Multiplicity"}),d("th",{children:"J (Hz)"}),d("th",{children:""})]}),V(s,`signals[${s.activeTab}].js`,[]).map((a,u)=>w("tr",{children:[d("td",{children:u+1}),d("td",{children:d(sn,{className:"selectBox",name:`signals.${s.activeTab}.js.${u}.multiplicity`,data:l,onChange:p=>r(p,`signals.${s.activeTab}.js.${u}.coupling`)})}),d("td",{children:d(W,{name:`signals.${s.activeTab}.js.${u}.coupling`,type:"number",placeholder:"J (Hz)",disabled:!Zn(a.multiplicity),onFocus:n,onBlur:o,style:{input:{width:"100%",height:"26px"}},checkErrorAfterInputTouched:!1})}),d("td",{children:d(me,{className:"delete-button",onClick:()=>{t(u)},children:d(Et,{className:"icon",title:"Delete coupling"})})})]},`editCouplings${s.activeTab}${u}`)),d("tr",{}),d("tr",{children:d("td",{colSpan:4,children:d(me,{className:"add-button",onClick:()=>e({multiplicity:Ht("m"),coupling:""}),children:d(yn,{title:"Add new coupling"})})})})]})})}var fw=c.exports.memo(hw);const mw=N`
  border-spacing: 0;
  width: 100%;
  font-size: 12px;
  height: 100%;
  ...
  padding: 0.4rem;
  text-align: center;
`;function gw({onFocus:e,onBlur:t}){const{values:n}=pe();return d("div",{css:mw,children:d(eh,{name:`signals.${n.activeTab}.js`,render:({push:o,remove:s})=>d("div",{children:d(fw,{push:o,remove:s,onFocus:e,onBlur:t})})})})}var xw=c.exports.memo(gw);const bw=N`
  text-align: center;
  width: 100%;
...
`;function Ew({onSaveEditRangeModal:e=()=>null,onCloseEditRangeModal:t=()=>null,onZoomEditRangeModal:n=()=>null,range:o,automaticZoom:s=!0}){const i=c.exports.useRef(null),{activeTab:r}=$(),l=Y(),a=Xe(r),u=Sw(),p=c.exports.useCallback(()=>{n(o)},[n,o]);c.exports.useEffect(()=>{s&&p()},[s,p]);const h=c.exports.useCallback(()=>{t()},[t]),m=c.exports.useCallback(v=>v.filter(C=>C.coupling!=="").map(C=>S(b({},C),{multiplicity:Ht(C.multiplicity)})),[]),g=c.exports.useCallback(v=>v.map(C=>S(b({id:U()},C),{multiplicity:C.js.map(E=>Ht(E.multiplicity)).join(""),js:m(C.js)})),[m]),x=c.exports.useCallback(v=>{(async()=>{const C=b({},o);C.signals=g(v.signals),await e(C),h()})()},[g,h,e,o]),y=c.exports.useMemo(()=>{const v=o.signals.map(C=>{let E=0;const T=[];return C.multiplicity.split("").forEach(M=>{let D={multiplicity:M,coupling:""};Zn(M)&&(D=b({},C.js[E]),D.coupling=Number(a(D.coupling)),E++),D.multiplicity=Ht(D.multiplicity),T.push(D)}),S(b({},C),{js:T})});return{activeTab:"0",signals:v}},[a,o]),k=c.exports.useCallback(v=>{const C=g(v.signals);l({type:Cu,payload:{tempRange:Object.assign({},o,{signals:C})}})},[l,g,o]);return d("div",{css:ww,children:w(ce,{ref:i,initialValues:y,validationSchema:u,onSubmit:x,children:[w("div",{className:"header handle",children:[d(me,{onClick:p,className:"zoom-button",children:d(qn,{title:"Set to default view on range in spectrum"})}),d("span",{children:` Range and Signal edition: ${a(o.from)} ppm to ${a(o.to)} ppm`}),d(tr,{onClick:()=>i.current.submitForm(),popupTitle:"Save and exit"}),d(fe,{onClick:h})]}),d(kw,{range:o}),d(lw,{onChange:k})]})})}function Aw(e){const t=Y(),n=he(),o=Be(),s=c.exports.useCallback(()=>{const p=Math.abs(e.from-e.to);t({type:ls,xDomain:[e.from-p,e.to+p]})},[t,e.from,e.to]),i=c.exports.useCallback(()=>{t({type:ds,payload:{data:{id:e.id,assignmentData:o}}})},[o,t,e.id]),r=c.exports.useCallback(p=>{t({type:Qc,payload:{data:{rowData:e,value:p}}})},[t,e]),l=c.exports.useCallback(p=>{t({type:eu,payload:{editedRowData:p,assignmentData:o}})},[o,t]),a=c.exports.useCallback(()=>{t({type:ze}),n.close()},[t,n]),u=c.exports.useCallback(()=>{t({type:lo,payload:{selectedTool:F.editRange.id,tempRange:e}}),n.show(f(Ew,{onCloseEditRangeModal:a,onSaveEditRangeModal:l,onZoomEditRangeModal:s,range:e}),{position:te.MIDDLE_RIGHT,transition:et.SCALE,isBackgroundBlur:!1})},[a,t,n,e,l,s]);return c.exports.useMemo(()=>({editRange:u,deleteRange:i,zoomRange:s,changeRangeSignalKind:r}),[r,i,u,s])}const Tw=N`
  width: 66px;
  padding: 0 !important;
...
`,Dw={marginLeft:2,marginRight:2,border:"none",height:"20px"};function Pw({rowData:e,onHoverSignal:t,rowSpanTags:n}){const{editRange:o,deleteRange:s,changeRangeSignalKind:i,zoomRange:r}=Aw(e);return w(c.exports.Fragment,{children:[d("td",S(b({},t),{children:d(Ne,{onChange:i,data:ri,defaultValue:e.tableMetaInfo.signal.kind,style:Dw})})),w("td",S(b({},n),{css:Tw,children:[d("button",{type:"button",className:"delete-button",onClick:s,children:d(Et,{})}),d("button",{type:"button",className:"zoom-button",onClick:r,children:d(qn,{title:"Zoom to range in spectrum"})}),d("button",{type:"button",className:"edit-button",onClick:o,children:d(Wl,{color:"blue"})})]}))]})}function Rw({rowData:e,onHoverSignal:t}){const n=V(e,"tableMetaInfo.signal.js");return f("td",S(b({},t),{children:n==null?void 0:n.map(o=>isNaN(o.coupling)?"":o.coupling.toFixed(1)).join(",")}))}const al={color:"red",fontWeight:"bold"};function Iw({rowData:e,assignment:t,highlight:n,onUnlinkVisibilityChange:o,unlinkVisibility:s,onLink:i,onUnlink:r,rowSpanTags:l,onHover:a,highlightData:u}){var g;const p=c.exports.useMemo(()=>V(e,"diaIDs",0),[e]),h=c.exports.useCallback(x=>{o==null||o(x)},[o]),m=c.exports.useMemo(()=>{var y;return t.isActive||t.isOnHover||n.isActive&&((y=u.highlight.sourceData)==null?void 0:y.type)!==ue.SIGNAL?{color:"red",fontWeight:"bold"}:{color:"black",fontWeight:"normal"}},[t.isActive,t.isOnHover,n.isActive,(g=u.highlight.sourceData)==null?void 0:g.type]);return f("td",S(b(b({},l),a),{onClick:x=>i==null?void 0:i(x,t),children:e.nbAtoms!==void 0&&e.nbAtoms>0?e.diaIDs&&e.diaIDs.length>0?_("div",{onMouseEnter:()=>h(!0),onMouseLeave:()=>h(!1),children:[e.nbAtoms," "," ( ",f("span",{style:m,children:p.length})," ) ",f("sup",{children:f("button",{type:"button",style:{visibility:s?"visible":"hidden",padding:0,margin:0},onClick:x=>r==null?void 0:r(x,!0),children:f(Qo,{color:"red"})})})]}):t.isActive?_("div",{children:[`${e.nbAtoms} (`,f("span",{style:al,children:"0"}),")"]}):e.nbAtoms:t.isActive?_("div",{children:["0 (",f("span",{style:al,children:"0"}),")"]}):""}))}var Mw=c.exports.memo(Iw);function Nw({value:e,rowSpanTags:t,onHoverRange:n,format:o}){return f("td",S(b(b({},t),n),{children:Ge(e,o)}))}var cl=c.exports.memo(Nw);function _w({rowData:e,rowSpanTags:t,onHoverRange:n,format:o}){const s=Y(),i=c.exports.useMemo(()=>{const l=$a(e),a=Ge(e.integration,o);return l?a:`[ ${a} ]`},[o,e]),r=c.exports.useCallback(l=>{s({type:qc,payload:{data:{value:l.target.value,id:e.id}}})},[s,e.id]);return f("td",S(b(b({},t),n),{children:f(ct,{value:i,onSave:r,type:"number",style:{padding:"0.1rem 0.4rem"}})}))}function Fw({rowData:e,onHover:t,assignment:n,highlight:o,onUnlinkVisibilityChange:s,unlinkVisibility:i,onLink:r,onUnlink:l}){const a=c.exports.useMemo(()=>V(e,"tableMetaInfo.signal.diaIDs",[]),[e]),u=c.exports.useMemo(()=>n.isActive||o.isActive?{color:"red",fontWeight:"bold"}:void 0,[n.isActive,o.isActive]),p=c.exports.useCallback(m=>{s==null||s(m)},[s]),h=c.exports.useCallback(m=>{r==null||r(m,n)},[n,r]);return f("td",S(b({},t),{onClick:h,style:u,children:a&&a.length>0?_("div",{onMouseEnter:()=>p(!0),onMouseLeave:()=>p(!1),children:[a.length," ",f("sup",{children:f("button",{type:"button",style:{visibility:i?"visible":"hidden",padding:0,margin:0},onClick:m=>l==null?void 0:l(m,!1),children:f(Qo,{color:"red"})})})]}):n.isActive?"0":""}))}var Lw=c.exports.memo(Fw);function Nd(e){return(t,n,o="",s="")=>{const i=V(e,n,"0.000");return Ge(t,i,o,s)}}function Ow({rowData:e,onHoverSignal:t,preferences:n}){const o=Y(),s=e.tableMetaInfo.signal,i=Nd(n),r=c.exports.useCallback(l=>{o({type:Jc,payload:{value:l.target.value,rangeID:e.id,signalID:s.id}})},[o,e.id,s.id]);return s?f("td",S(b({},t),{children:Ui(s.multiplicity,["m"])?f(ct,{value:s.delta.toFixed(3),onSave:r,type:"number",style:{padding:"0.1rem 0.4rem"}}):`${i(e.from,"fromFormat")} - ${i(e.to,"toFormat")}`})):f("td",{children:""})}const $w=N`
  background-color: #ff6f0057;
`,Hw=N`
  background-color: #f5f5dc;
`;function zw({rowData:e,onUnlink:t,onContextMenu:n,preferences:o}){const s=Be(),i=dt(e.id),r=ie([i.id].concat(i.assigned.x||[]).concat(Yi(s,e.signals.map(P=>P.id))),{type:ue.RANGE}),l=ie(i.assigned.x||[],{type:ue.RANGE}),a=dt(e.tableMetaInfo.id),u=ie([a.id].concat(a.assigned.x||[]),{type:ue.SIGNAL}),p=An(),[h,m]=c.exports.useState(!1),[g,x]=c.exports.useState(!1),y=Nd(o),k=c.exports.useMemo(()=>({rowSpan:e.tableMetaInfo.rowSpan,style:V(e.tableMetaInfo,"hide",!1)?{display:"none"}:void 0}),[e.tableMetaInfo]),v=c.exports.useCallback((P,A)=>{P&&P.stopPropagation(),A!==void 0?A?(t(e),m(!1),i.removeAll("x")):(t(e,V(e,"tableMetaInfo.signalIndex",void 0)),x(!1),a.removeAll("x")):(m(!1),x(!1))},[i,a,t,e]),C=c.exports.useCallback((P,A)=>{P.stopPropagation(),A.onClick("x")},[]),E=c.exports.useMemo(()=>({onMouseEnter:()=>{i.onMouseEnter("x"),r.show()},onMouseLeave:()=>{i.onMouseLeave("x"),r.hide()}}),[i,r]),T=c.exports.useMemo(()=>({onMouseEnter:()=>{i.onMouseEnter("x"),l.show()},onMouseLeave:()=>{i.onMouseLeave("x"),l.hide()}}),[i,l]),M=c.exports.useMemo(()=>({onMouseEnter:()=>{a.onMouseEnter("x"),u.show()},onMouseLeave:()=>{a.onMouseLeave("x"),u.hide()}}),[a,u]),D=c.exports.useMemo(()=>r.isActive||i.isActive?$w:V(e,"tableMetaInfo.isConstantlyHighlighted",!1)?Hw:null,[i.isActive,r.isActive,e]);return w("tr",{onContextMenu:P=>n(P,e),css:D,children:[d("td",S(b(b({},k),E),{children:e.tableMetaInfo.rowIndex+1})),yo(o,"showFrom")&&d(cl,{value:e.from,rowSpanTags:k,onHoverRange:E,format:y("showFrom",void 0)}),yo(o,"showTo")&&d(cl,{value:e.to,rowSpanTags:k,onHoverRange:E,format:y("toFormat",void 0)}),d(Ow,{rowData:e,onHoverSignal:M,preferences:o}),yo(o,"showRelative")&&d(_w,{rowData:e,rowSpanTags:k,onHoverRange:E,format:y("relativeFormat",void 0)}),yo(o,"showAbsolute")&&d(rw,{value:e.absolute,rowSpanTags:k,onHoverRange:E,format:y("absoluteFormat",void 0)}),d("td",S(b({},M),{children:V(e,"tableMetaInfo.signal.multiplicity","")})),d(Rw,{rowData:e,onHoverSignal:M}),d(Lw,{rowData:e,assignment:a,highlight:u,onHover:M,unlinkVisibility:g,onUnlinkVisibilityChange:P=>x(P),onLink:C,onUnlink:v}),d(Mw,{rowData:e,assignment:i,highlight:l,onHover:T,unlinkVisibility:h,onUnlinkVisibilityChange:P=>m(P),onLink:C,onUnlink:v,rowSpanTags:k,highlightData:p}),d(Pw,{rowData:e,onHoverSignal:M,onHoverRange:E,rowSpanTags:k})]})}function Vw(e){return c.exports.useMemo(()=>{const t=[];return e.forEach((n,o)=>{n.signals.length===1?t.push(S(b({rowKey:U()},n),{tableMetaInfo:S(b({},n.tableMetaInfo),{signal:n.signals[0],rowIndex:o,signalIndex:0,id:n.signals[0].id})})):n.signals.length>1&&n.signals.forEach((s,i)=>{let r=!1,l=null;i<n.signals.length-1&&i===0?l=n.signals.length:r=!0,t.push(S(b({rowKey:U()},n),{tableMetaInfo:S(b({},n.tableMetaInfo),{signal:s,rowSpan:l,hide:r,rowIndex:o,signalIndex:i,id:s.id})}))})}),t},[e])}const jw=N`
  border-spacing: 0;
  border: 1px solid #dedede;
  width: 100%;
  font-size: 12px;
...
`;function bE({position:e,data:t,onClose:n}){const o=Y(),{id:s,info:i}=t,r=c.exports.useCallback(p=>{o({type:fc,id:s,display:p})},[o,s]),l=c.exports.useCallback(p=>{p.target===p.currentTarget&&n()},[n]);if(!e)return null;const{x:a,y:u}=e;return d("div",{css:xE,onClick:l,children:d("div",{className:"inner-conatiner",style:{left:i.dimension===2?a-450:a-240,width:i.dimension===2?450:240,padding:i.dimension===2?"10px 0":"",top:u},children:i.dimension===2?d(gE,{onSubmit:r,data:t}):d(uE,{onSubmit:r,data:t})})})}function yE(){return!0}var vE=c.exports.memo(bE,yE);function CE({data:e,activeSpectrum:t,activeTab:n,onTabChange:o}){const s=c.exports.useRef(),[i,r]=c.exports.useState([]),[l,a]=c.exports.useState(null),[u,p]=c.exports.useState(null),[h,m]=c.exports.useState(!1),g=le(),x=Y();c.exports.useEffect(()=>{if(e){const A=e.reduce((R,I)=>(I.info.dimension===1&&I.display.isPeaksMarkersVisible===!0&&R.push({id:I.id}),R),[]);r(A)}},[e,x]);const y=c.exports.useMemo(()=>e?ss("nucleus")(e,!0):[],[e]);c.exports.useEffect(()=>{o({tab:n,data:y[n]})},[n,o,y]);const k=c.exports.useCallback(A=>{const R=i.findIndex(O=>O.id===A.id),I=[...i];R===-1?I.push({id:A.id}):I.splice(R,1),x({type:Di,data:I}),r(I)},[x,i]),v=c.exports.useCallback(A=>{o({tab:A.tabid,data:y[A.tabid]}),x({type:Oi,tab:A.tabid})},[x,o,y]),C=c.exports.useMemo(()=>[{label:"Copy to Clipboard",onClick:A=>{(async()=>{const{x:R,y:I,info:O}=A;await xs(JSON.stringify({x:R,y:I,info:O},void 0,2))?g.success("Data copied to clipboard"):g.error("Copy to clipboard failed")})()}},{label:"Delete",onClick:A=>{setTimeout(()=>{x({type:Mi,id:A.id})},0)}}],[g,x]),E=c.exports.useCallback((A,R)=>{Yt(A)||(A.preventDefault(),s.current.handleContextMenu(A,R))},[s]),T=c.exports.useCallback((A,R)=>{p({x:R.nativeEvent.clientX,y:R.nativeEvent.clientY}),a(A),m(!0)},[]),M=c.exports.useCallback((A,R)=>{x({type:Gn,id:A.id,key:R,value:!A.display[R]})},[x]),D=c.exports.useCallback(A=>{setTimeout(()=>{t&&t.id===A.id?x({type:zo,data:null}):x({type:zo,data:{id:A.id}})},0)},[t,x]),P=c.exports.useCallback(()=>{m(!1)},[]);return _("div",{style:{height:"calc(100% - 25px)"},children:[f(Tn,{activeTab:n,onClick:v,children:y&&Object.keys(y).map(A=>{var R;return f(Me,{tablabel:A,tabid:A,children:(R=y[A])==null?void 0:R.map(I=>f(sE,{activeSpectrum:t,markersVisible:i,data:I,onChangeVisibility:M,onChangeMarkersVisibility:k,onChangeActiveSpectrum:D,onOpenSettingModal:T,onContextMenu:O=>E(O,I)},I.id))},A)})}),f(Ut,{ref:s,context:C}),h?f(vE,{onClose:P,data:l,position:u}):null]})}const kE=c.exports.memo(CE);function SE({onTabChange:e}){const{data:t,activeSpectrum:n,activeTab:o}=$();return f(kE,{data:t,activeSpectrum:n,activeTab:o,onTabChange:e})}const wE={overflow:"hidden",height:"100%",display:"flex",flexDirection:"column",width:"100%"};function EE(){const[e,t]=c.exports.useState([]),n=c.exports.useCallback(o=>{t(o.data?o.data:[])},[]);return _("div",{style:wE,children:[f(Kw,{spectrums:e}),f(SE,{onTabChange:n})]})}var AE=c.exports.memo(EE);const ve={hmbc:{from:2,to:3},cosy:{from:3,to:4},hsqc:{from:1,to:1},hmqc:{from:1,to:1},inadequate:{from:1,to:1}};function _d(e,t){return ve[t]&&e.from===ve[t].from&&e.to===ve[t].to}function Fd(e){return e.split(/\d+/)[1]}function Ld(e,t){const n=V(e,`state.${t.atomType}.error`,null);if(n){for(let{key:o,color:s}of yi)if(o!=="incomplete"&&(o==="notAttached"||o==="ambiguousAttachment")&&V(n,`${o}`,[]).some(i=>e.values[i].id===t.id))return s}return null}function Od(e,t,n,o,s){var i;if(e&&e.info.dimension===2){const r=Xn(e,t.signal.id);if(r){const l=t.axis==="x"?"y":"x",a=(i=r[l])==null?void 0:i.delta;if(a!==void 0)return a*n>=o&&a*n<=s}}return!1}function Go(e,t,n,o,s,i,r){if(e&&e.info.dimension===2){const l=Xn(e,t.signal.id);if((l==null?void 0:l.x.delta)&&(l==null?void 0:l.y.delta))return l.x.delta*n>=o&&l.x.delta*n<=s&&l.y.delta*n>=i&&l.y.delta*n<=r}return!1}function dl(e){var o;let t="X";e.experimentType==="hsqc"||e.experimentType==="hmqc"?t=!e.signal||e.signal.sign===0?"S":`S${e.signal.sign===1?"+":"-"}`:e.experimentType==="hmbc"||e.experimentType==="cosy"||e.experimentType==="tocsy"?t="M":e.experimentType==="noesy"||e.experimentType==="roesy"?t="NOE":e.experimentType==="inadequate"?t="I":e.experimentType==="adequate"&&(t="A");const n=(o=e.signal.j)==null?void 0:o.pathLength;if(n){const s=ve[e.experimentType]&&n.from>=ve[e.experimentType].from&&n.from<=ve[e.experimentType].to&&n.to>=ve[e.experimentType].from&&n.to<=ve[e.experimentType].to;return`${t}${s?"":"*"}`}return t}function $d(e){return es(S(b({},e),{edited:S(b({},e.edited),{moved:!0})}))}function $n(e,t){const n=e.id.split("_");return es(S(b({},e),{id:n[t==="x"?0:1],axis:t,match:[],edited:S(b({},e.edited),{moved:!0})}))}function be(e,t,n,o){const s=Ie(t),i=Ve(e),r=t.id.split("_");return o==="add"?dh(i,s===1?$d(t):$n(t,n)):(o==="remove"||o==="unmove")&&ph(i,n==="x"?r[0]:r[1]),i}function TE({correlationDim1:e,correlationDim2:t,selectedCorrelationIdDim1:n,selectedCorrelationIdDim2:o,action:s,link:i,correlations:r}){const l=r.find(x=>x.id===n),a=r.find(x=>x.id===o),u=(l==null?void 0:l.id)!==e.id,p=t&&(a==null?void 0:a.id)!==(t==null?void 0:t.id),h=Ie(i),m=[],g={};if(s==="move"){if(h===1){const x=be(e,i,"x","remove");let y;l?y=be(u?l:x,i,"x","add"):y=In({atomType:e.atomType,link:[$d(i)]}),m.push(x,y),g.skipDataUpdate=!0}else if(h===2){const x=be(e,i,"x","remove");m.push(x);const y=be(t,i,"y","remove");m.push(y),l&&a?(m.push(be(u?l:x,i,"x","add")),m.push(be(p?a:y,i,"y","add"))):l&&o==="new"?(m.push(be(u?l:x,i,"x","add")),m.push(In({atomType:t.atomType,link:[$n(i,"y")]}))):n==="new"&&a?(m.push(In({atomType:e.atomType,link:[$n(i,"x")]})),m.push(be(p?a:y,i,"y","add"))):n==="new"&&o==="new"&&(m.push(In({atomType:e.atomType,link:[$n(i,"x")]})),m.push(In({atomType:t.atomType,link:[$n(i,"y")]}))),g.skipDataUpdate=!0}}else if(s==="remove"){const x=be(e,i,"x","remove");if(m.push(x),Ie(i)===2){const y=be(t,i,"y","remove");m.push(y)}}else s==="unmove"?h===1?l&&m.push(be(l,i,"x","unmove")):h===2&&l&&a&&(m.push(be(l,i,"x","unmove")),m.push(be(a,i,"y","unmove"))):s==="setPathLength"&&(m.push(pl(e,i,"x")),m.push(pl(t,i,"y")));return{editedCorrelations:m,buildCorrelationDataOptions:g}}function pl(e,t,n){var i,r;const o=Ve(e);if(Ie(t)===2){const l=t.id.split("_")[n==="x"?0:1],a=o.link.find(u=>u.id===l);if(a){const u=(i=t.signal.j)==null?void 0:i.pathLength;_d(u,a.experimentType)?((r=a.signal.j)==null||delete r.pathLength,a.signal.j&&Object.keys(a.signal.j).length===0&&delete a.signal.j,delete a.edited.pathLength):(a.signal.j?a.signal.j.pathLength=u:a.signal.j={pathLength:u},a.edited.pathLength=!0)}}return o}function DE(e,t){e=e.toLowerCase().replace(/\s+/g,"").split(",").map(s=>s==="sp"?"sp1":s).join(","),e=e.replaceAll("sp","");let n=[];return/^(?:[0-9],{0,1})+$/g.test(e)&&(n=e.split(",").filter(s=>s.length>0).map(s=>Number(s))),n=n.filter(s=>s>=(t==="protonsCount"?0:1)&&(t==="protonsCount"||s<=3)),n.filter((s,i,r)=>r.indexOf(s)===i)}function PE(e,t,n,o,s,i,r){if(r.pseudo===!0||n===null||!r.link.some(g=>g.experimentID===n.id))return!1;const l=t.split(",").map(g=>Fd(g)),a=1e4,u=o[0]*a,p=o[1]*a,h=s[0]*a,m=s[1]*a;if(i===B.DM_1D){const g=r.link.find(k=>Ie(k)===1);if(!g)return!1;let x=ql(g);if(x===void 0)return!1;if(x*=a,Re(e,g.experimentID,!0)&&l[0]===r.atomType&&x>=u&&x<=p||r.link.some(k=>{const v=Re(e,k.experimentID,!0);return Od(v,k,a,u,p)}))return!0}else if(i===B.DM_2D){if(!l.includes(r.atomType))return!1;const g=r.link.find(y=>Ie(y)===2);if(!g)return!1;const x=Re(e,g.experimentID,!0);if(Go(x,g,a,u,p,h,m))return!0;if(r.link.some(y=>{const k=Re(e,y.experimentID,!0);return Go(k,y,a,u,p,h,m)}))return!0}return!1}function Wo({correlation:e}){const{data:t,xDomain:n,yDomain:o,displayerMode:s,activeTab:i,activeSpectrum:r}=$();return c.exports.useMemo(()=>PE(t,i,r,n,o,s,e),[r,i,e,s,t,n,o])}const RE=N`
  margin-top: 10px;
  padding: 5px;
  text-align: center;
...
`;function hl({description:e,onConfirm:t}){const n=c.exports.useCallback(o=>{o.preventDefault(),o.stopPropagation(),t()},[t]);return w("div",{css:RE,children:[d("p",{children:e}),d("button",{type:"button",onClick:n,children:"Confirm"})]})}const IE=N`
  width: 100%;
  height: 100%;
  margin-top: 10px;
  text-align: center;
...
`;function ME({signal:e,experimentType:t,onEdit:n}){var p,h,m,g;const[o,s]=c.exports.useState(((p=e.j)==null?void 0:p.pathLength)!==void 0?e.j.pathLength.from:((h=ve[t])==null?void 0:h.from)||0),[i,r]=c.exports.useState(((m=e.j)==null?void 0:m.pathLength)!==void 0?e.j.pathLength.to:((g=ve[t])==null?void 0:g.to)||0),[l,a]=c.exports.useState(!1),u=c.exports.useCallback(()=>{const x={from:o,to:i},y=S(b({},e),{j:S(b({},e.j),{pathLength:x})});n(y)},[i,o,n,e]);return c.exports.useEffect(()=>{a(o<=0||o>i)},[i,o]),w("div",{css:IE,children:[d("p",{children:"Setting of the minimum and maximum path length (J coupling)."}),w("div",{className:"input-container",children:[d(Q,{title:"Min:",style:{label:{marginRight:"5px",fontSize:"14px",fontWeight:"normal"}},children:d(wt,{type:"number",value:o,onChange:x=>{s(Number(x.target.value))},style:{input:{color:l?"red":"black"}}})}),d(Q,{title:"Max:",style:{label:{marginRight:"5px",fontSize:"14px",fontWeight:"normal"}},children:d(wt,{type:"number",value:i,onChange:x=>{r(Number(x.target.value))}})})]}),l?w("p",{className:"warning",children:["Minimum must not be 0 or higher than the maximum value."," "]}):d(me,{type:"button",onClick:u,disabled:l,children:"Set"})]})}const NE=N`
  width: 100%;
  height: 100%;
  margin-top: 10px;
  text-align: center;
...
`;function ir({correlationDim1:e,correlationDim2:t,link:n,correlations:o,onClose:s,onEdit:i}){const[r,l]=c.exports.useState("move"),a=c.exports.useCallback(()=>{const h=Ie(n);return h===1?` 1D (${n.signal.delta.toFixed(3)})`:h===2?`${n.signal.x?`${n.signal.x.delta.toFixed(2)}`:"?"} (${e.label.origin}), ${n.signal.y?n.signal.y.delta.toFixed(2):"?"} (${t.label.origin})`:""},[e.label.origin,n,t]),u=c.exports.useCallback((h,m,g,x)=>{const{editedCorrelations:y,buildCorrelationDataOptions:k}=TE({correlationDim1:e,correlationDim2:t,selectedCorrelationIdDim1:m,selectedCorrelationIdDim2:g,action:h,link:x||n,correlations:o});i(y,h,x||n,k),s==null||s()},[e,t,o,n,s,i]),p=c.exports.useMemo(()=>d("div",{className:"tabs-container",children:w(Tn,{position:er.TOP,activeTab:r,onClick:h=>l(h.tabid),children:[d(Me,{tablabel:"Move",tabid:"move",children:d(_E,{correlationDim1:e,correlationDim2:t,link:n,correlations:o,onEdit:(h,m)=>u("move",h,m)})}),d(Me,{tablabel:"Unmove",tabid:"unmove",children:d(hl,{description:"Movement of signal to its original place.",onConfirm:()=>u("unmove",e.id,t.id)})}),d(Me,{tablabel:"Remove",tabid:"remove",children:d(hl,{description:"Deletion of signal.",onConfirm:()=>u("remove",void 0,void 0)})}),d(Me,{tablabel:"J Coupling",tabid:"setPathLength",children:d(ME,{signal:n.signal,experimentType:n.experimentType,onEdit:h=>{const m=S(b({},n),{signal:h});u("setPathLength",e,t,m)}})})]})}),[r,e,t,o,u,n]);return w("div",{css:FE,children:[w("div",{className:"header handle",children:[d(fe,{onClick:s}),d("p",{className:"header-info",children:`${n.experimentType.toUpperCase()} signal at ${a()}`})]}),p]})}function LE({spectraData:e,correlationsData:t,correlation:n,onEdit:o}){var C;const s=c.exports.useRef(),i=he(),r=c.exports.useMemo(()=>{if(n.pseudo===!0)return[];const E=[];return n.link.forEach(T=>{if(T.pseudo===!1){E.push(T.signal.id),E.push(ke(T.signal.id,"Crosshair_X"));const M=Ci(e,T.experimentID,T.signal.id,!0);M&&E.push(M)}}),E},[n,e]),l=ie(r),a=c.exports.useCallback(E=>{E.currentTarget.focus(),l.show()},[l]),u=c.exports.useCallback(E=>{E.currentTarget.blur(),l.hide()},[l]),p=Wo({correlation:n}),h=c.exports.useMemo(()=>({style:{color:Ld(t,n)||void 0,backgroundColor:l.isActive?"#ff6f0057":p?"#f5f5dc":"inherit"},title:n.pseudo===!1&&n.link.reduce((E,T)=>(T.pseudo===!1&&!E.includes(T.experimentType.toUpperCase())&&E.push(T.experimentType.toUpperCase()),E),[]).sort().join("/"),onMouseEnter:a,onMouseLeave:u}),[n,t,l.isActive,p,a,u]),m=c.exports.useMemo(()=>n.edited.equivalence?{backgroundColor:"#F7F2E0"}:{color:Number.isInteger(n.equivalence)?n.equivalence===1?"#bebebe":"black":"red"},[n]),g=c.exports.useMemo(()=>n.pseudo===!1?n.link.filter(E=>Ie(E)===1&&E.pseudo===!1).map(E=>{var T;return{label:`edit 1D (${E.signal.delta.toFixed(3)}${((T=E.edited)==null?void 0:T.moved)===!0?"[MOVED]":""})`,onClick:()=>{l.hide(),i.show(d(ir,{onClose:()=>i.close(),onEdit:o,link:E,correlationDim1:n,correlationDim2:void 0,correlations:t.values}),{position:te.MIDDLE_RIGHT,isBackgroundBlur:!1})}}}).concat([{label:`delete all (${n.label.origin})`,onClick:()=>{i.showConfirmDialog({message:`All signals of ${n.label.origin} (${at(n).toFixed(2)}) will be deleted. Are you sure?`,buttons:[{text:"Yes",handler:()=>{o([n],"removeAll")}},{text:"No"}]}),l.hide()}}]):[],[n,t.values,l,i,o]),x=c.exports.useCallback(E=>{E.preventDefault(),s.current.handleContextMenu(E)},[s]),v=h,{title:y}=v,k=G(v,["title"]);return d("th",S(b({},k),{title:y===!1?void 0:y,children:w("div",{style:{display:"block"},onContextMenu:E=>{g.length>0&&x(E)},children:[d("p",{children:n.label.origin}),d("p",{children:at(n)?(C=at(n))==null?void 0:C.toFixed(2):""}),d("p",{style:m,children:Number.isInteger(n.equivalence)?n.equivalence:n.equivalence.toFixed(2)}),d(Ut,{ref:s,context:g})]})}))}function OE({rowCorrelation:e,columnCorrelation:t,commonLinks:n,correlations:o,spectraData:s,onEdit:i}){const r=c.exports.useRef(),l=he(),a=c.exports.useMemo(()=>{const E=[];return n.forEach(T=>{if(T.pseudo===!1){E.push(T.signal.id),E.push(ke(T.signal.id,"Crosshair"));const M=Ci(s,T.experimentID,T.signal.id,!0);M&&E.push(M)}}),E},[n,s]),u=ie(a),p=c.exports.useCallback(E=>{E.currentTarget.focus(),u.show()},[u]),h=c.exports.useCallback(E=>{E.currentTarget.blur(),u.hide()},[u]),m=c.exports.useCallback(E=>{E.preventDefault(),r.current.handleContextMenu(E)},[r]),g=c.exports.useCallback((E,T)=>{const M=e.link.filter(A=>(A.experimentType==="hsqc"||A.experimentType==="hmqc")&&A.pseudo===!0).length;let D,P;if(E==="add"){const A=es({experimentType:"hsqc",experimentID:U(),atomType:[t.atomType,e.atomType],id:U(),pseudo:!0,signal:{id:U(),sign:0}});D=be(t,A,"x","add"),P=be(e,A,"y","add"),P.edited.protonsCount||(P.protonsCount=[M+1])}else D=be(t,T,"x","remove"),P=be(e,T,"y","remove"),P.edited.protonsCount||(P.protonsCount=M-1>0?[M-1]:[]);i([D,P],E,T,{skipDataUpdate:!0})},[t,i,e]),x=c.exports.useMemo(()=>{const E=n.map(M=>{var P;const D=`${dl(M)} (${M.signal.x?M.signal.x.delta.toFixed(2):"?"}, ${M.signal.y?M.signal.y.delta.toFixed(2):"?"})${((P=M.edited)==null?void 0:P.moved)===!0?"[MOVED]":""}`;return M.pseudo===!1?[{label:`edit ${D}`,onClick:()=>{u.hide(),l.show(f(ir,{onClose:()=>l.close(),onEdit:i,link:M,correlationDim1:t,correlationDim2:e,correlations:o}),{position:te.MIDDLE_RIGHT,isBackgroundBlur:!1})}}]:[]}).flat(),T=n.find(M=>M.pseudo===!0&&M.experimentType==="hsqc");return e.pseudo===!0&&(T?E.push({label:"remove pseudo HSQC",onClick:()=>g("remove",T)}):E.push({label:"add pseudo HSQC",onClick:()=>g("add")})),E},[t,n,o,g,u,l,i,e]),y=c.exports.useMemo(()=>n.map((E,T)=>{var M;return _("label",{children:[f("label",{style:{color:E.pseudo===!0||((M=E.edited)==null?void 0:M.moved)===!0?"blue":"black"},children:dl(E)}),T<n.length-1&&f("label",{children:"/"})]},E.id)}),[n]),k=c.exports.useMemo(()=>n.reduce((E,T)=>(E.includes(T.experimentType.toUpperCase())||E.push(T.experimentType.toUpperCase()),E),[]).join("/"),[n]),v=Wo({correlation:e}),C=Wo({correlation:t});return _("td",{onContextMenu:E=>{x.length>0&&m(E)},style:{backgroundColor:u.isActive?"#ff6f0057":C||v?"#f5f5dc":"inherit"},title:k,onMouseEnter:p,onMouseLeave:h,children:[y,f(Ut,{ref:r,context:x})]})}function $E({additionalColumnData:e,correlations:t,correlation:n,styleRow:o,styleLabel:s,onSaveEditEquivalences:i,onSaveEditNumericValues:r,onEditCorrelationTableCellHandler:l,spectraData:a}){var O;const u=c.exports.useRef(),p=he(),h=c.exports.useMemo(()=>{if(n.pseudo===!0)return[];const L=[];return n.link.forEach(H=>{if(H.pseudo===!1){L.push(H.signal.id),L.push(ke(H.signal.id,"Crosshair_Y"));const X=Ci(a,H.experimentID,H.signal.id,!0);X&&L.push(X)}}),L},[n,a]),m=ie(h),g=c.exports.useCallback(L=>{i(n,L.target.value)},[n,i]),x=c.exports.useCallback((L,H)=>{r({correlation:n,values:DE(L.target.value,H),key:H})},[n,r]),y=c.exports.useMemo(()=>e.map(L=>{const H=[];return n.link.forEach(X=>{L.link.forEach(J=>{if(X.axis!==J.axis&&X.experimentID===J.experimentID&&X.signal.id===J.signal.id&&!H.some(z=>z.signal.id===X.signal.id)){let z=X.experimentType;X.signal&&X.signal.sign!==0&&(z+=X.signal.sign===1?" (+)":" (-)"),H.push(es(S(b({},X),{experimentLabel:z,axis:void 0,id:`${J.id}_${X.id}`})))}})}),f(OE,{rowCorrelation:n,columnCorrelation:L,commonLinks:H,correlations:t,spectraData:a,onEdit:l},`addColData_${n.id}_${L.id}`)}),[e,n,t,l,a]),k=c.exports.useMemo(()=>n.edited.equivalence?{color:"blue"}:{color:n.equivalence===1?"#bebebe":"black"},[n]),v=c.exports.useCallback(L=>{L.currentTarget.focus(),m.show()},[m]),C=c.exports.useCallback(L=>{L.currentTarget.blur(),m.hide()},[m]),E=Wo({correlation:n}),T=c.exports.useMemo(()=>({style:S(b({},o),{backgroundColor:m.isActive?"#ff6f0057":E?"#f5f5dc":"inherit"}),title:n.pseudo===!1&&n.link.reduce((L,H)=>(H.pseudo===!1&&!L.includes(H.experimentType.toUpperCase())&&L.push(H.experimentType.toUpperCase()),L),[]).sort().join("/"),onMouseEnter:v,onMouseLeave:C}),[n.link,n.pseudo,m.isActive,E,v,C,o]),M=c.exports.useMemo(()=>n.pseudo===!1?n.link.filter(L=>Ie(L)===1&&L.pseudo===!1).map(L=>{var H;return{label:`edit 1D (${L.signal.delta.toFixed(3)})${((H=L.edited)==null?void 0:H.moved)===!0?"[MOVED]":""}`,onClick:()=>{m.hide(),p.show(f(ir,{onClose:()=>p.close(),onEdit:l,link:L,correlationDim1:n,correlationDim2:void 0,correlations:t}),{position:te.MIDDLE_RIGHT,isBackgroundBlur:!1})}}}).concat([{label:`delete ${n.label.origin}`,onClick:()=>{p.showConfirmDialog({message:`All signals of ${n.label.origin} (${at(n).toFixed(2)}) will be deleted. Are you sure?`,buttons:[{text:"Yes",handler:()=>{l([n],"removeAll")}},{text:"No"}]}),m.hide()}}]):[],[n,m,p,l,t]),D=c.exports.useCallback(L=>{L.preventDefault(),u.current.handleContextMenu(L)},[u]),I=T,{title:P}=I,A=G(I,["title"]),R=P||"";return _("tr",{style:o,children:[_("td",S(b({title:R},A),{style:S(b({},T.style),{styleLabel:s}),onContextMenu:L=>{M.length>0&&D(L)},children:[hh(t,n),f(Ut,{ref:u,context:M})]})),f("td",S(b({title:R},A),{children:at(n)?(O=at(n))==null?void 0:O.toFixed(2):""})),f("td",S(b({title:R},A),{children:n.pseudo===!1?n.atomType!=="H"?f(ct,{type:"number",value:n.equivalence,style:k,onSave:g}):f("text",{style:k,children:n.equivalence}):""})),f("td",S(b({title:R},A),{children:n.atomType!=="H"?f(ct,{type:"text",value:n.protonsCount.join(","),style:n.edited.protonsCount?{color:"blue"}:{},onSave:L=>x(L,"protonsCount")}):""})),f("td",S(b({title:R},A),{style:S(b({},T.style),{borderRight:"1px solid"}),children:n.atomType!=="H"?f(ct,{type:"text",value:n.hybridization.map(L=>`sp${L}`).join(","),style:n.edited.hybridization?{color:"blue"}:{},onSave:L=>x(L,"hybridization")}):""})),y]})}const HE=N`
  overflow: auto;
  height: 100%;
  display: block;
  table {
...
`;function WE({onClose:e,onSave:t,molecules:n,previousMF:o}){const[s,i]=c.exports.useState(0);c.exports.useEffect(()=>{n&&n.length>0&&i(0)},[n]);const r=c.exports.useCallback(u=>{t==null||t(u),e==null||e()},[e,t]),l=c.exports.useCallback(()=>{t==null||t(n[s].mf),e==null||e()},[s,n,e,t]),a=c.exports.useCallback(u=>{i(u)},[]);return w("div",{css:GE,children:[d("div",{className:"header handle",children:d(fe,{onClick:e})}),d("div",{children:d("p",{className:"info",children:"Please type in a molecular formula!"})}),d(YE,{onSave:r,previousMF:o}),w("div",{children:[d("p",{className:"optional",children:"OR"}),d("p",{className:"optional2",children:"Select a molecule as reference!"})]}),d(Ad,{molecules:n,onChange:a}),d("button",{type:"button",onClick:l,children:"Set"})]})}const ZE=N`
  width: 220px;
  height: 270px;
  padding: 5px;
  text-align: center;
...
`;function UE({onClose:e,onSave:t,previousTolerance:n}){const[o,s]=c.exports.useState(),[i,r]=c.exports.useState({});c.exports.useEffect(()=>{if(n){s(n);const p={};Object.keys(n).forEach(h=>{p[h]=!0}),r(p)}else s(void 0)},[n]);const l=c.exports.useCallback(()=>{t==null||t(o),e==null||e()},[e,t,o]),a=c.exports.useCallback((p,h)=>{const m=p.target.value;m.trim().length>0?(s(S(b({},o),{[h]:Number(m)})),r(S(b({},i),{[h]:!0}))):r(S(b({},i),{[h]:!1}))},[i,o]),u=c.exports.useMemo(()=>o?Object.keys(o).map(p=>w("tr",{children:[d("td",{children:p}),d("td",{children:d("input",{type:"number",onChange:h=>a(h,p),defaultValue:o[p],style:i[p]?{}:{backgroundColor:"orange"}})})]},`tolerance_${p}`)):void 0,[i,a,o]);return w("div",{css:ZE,children:[w("div",{className:"header handle",children:[d("span",{children:"Set Shift Tolerances"}),d(fe,{onClick:e})]}),w("table",{children:[d("thead",{children:w("tr",{children:[d("th",{children:"Atom"}),d("th",{children:"Value"})]})}),d("tbody",{children:u})]}),d("button",{type:"button",onClick:l,disabled:Object.keys(i).some(p=>!i[p]),children:"Set"})]})}const KE=N`
  display: flex;
  flex-direction: column;
  text-align: center;
  height: 100%;
...
`;function qE(){const{molecules:e,correlations:t,data:n,xDomain:o,yDomain:s,displayerMode:i,activeTab:r}=$(),l=Y(),a=he(),u=Be(),[p,h]=c.exports.useState([]),[m,g]=c.exports.useState("H"),[x,y]=c.exports.useState(!1),[k,v]=c.exports.useState(!1),C=c.exports.useMemo(()=>{const z=j=>{if(j.pseudo===!0)return!1;const K=r.split(",").map(rt=>Fd(rt)),ne=1e4,_e=o[0]*ne,gt=o[1]*ne,qt=s[0]*ne,Jt=s[1]*ne;if(i===B.DM_1D){const rt=j.link.find(en=>Ie(en)===1);if(!rt)return!1;let Qt=ql(rt);if(Qt===void 0)return!1;if(Qt*=ne,Re(n,rt.experimentID,!0)&&K[0]===j.atomType&&Qt>=_e&&Qt<=gt||j.link.some(en=>{const Bd=Re(n,en.experimentID,!0);return Od(Bd,en,ne,_e,gt)}))return!0}else if(i===B.DM_2D){if(!K.includes(j.atomType))return!1;const rt=j.link.find(Pn=>Ie(Pn)===2);if(!rt)return!1;const Qt=Re(n,rt.experimentID,!0);if(Go(Qt,rt,ne,_e,gt,qt,Jt))return!0;if(j.link.some(Pn=>{const en=Re(n,Pn.experimentID,!0);return Go(en,Pn,ne,_e,gt,qt,Jt)}))return!0}return!1};if(t){const j=k?t.values.filter(K=>z(K)):t.values;return S(b({},t),{values:j})}},[r,t,i,k,n,o,s]),E=c.exports.useCallback(z=>{l({type:vc,payload:{mf:z}})},[l]),T=c.exports.useCallback(z=>{l({type:Cc,payload:{tolerance:z}})},[l]),M=c.exports.useCallback(()=>{a.show(d(WE,{onClose:()=>a.close(),onSave:E,molecules:e,previousMF:t.options.mf}))},[t,E,a,e]),D=c.exports.useCallback(()=>{a.show(d(UE,{onClose:()=>a.close(),onSave:T,previousTolerance:t.options.tolerance}))},[t,T,a]),P=c.exports.useMemo(()=>["H","H-H"].concat(t?t.values.map(j=>j.atomType).filter((j,K,ne)=>j!=="H"&&ne.indexOf(j)===K):[]).map(j=>({key:j,label:j,value:j})),[t]);c.exports.useEffect(()=>{const z=m.split("-")[0];h(C?C.values.filter(j=>j.atomType===z).reverse():[])},[C,m]);const A=c.exports.useCallback((z,j)=>{l({type:Ws,payload:{id:z.id,correlation:S(b({},z),{equivalence:j,edited:S(b({},z.edited),{equivalence:j!==1})})}})},[l]),R=c.exports.useCallback(({correlation:z,values:j,key:K})=>{l({type:Ws,payload:{id:z.id,correlation:S(b({},z),{[K]:j,edited:S(b({},z.edited),{[K]:!0})}),options:{skipDataUpdate:!0}}})},[l]),I=c.exports.useCallback((z,j)=>{l({type:bc,payload:{correlations:z,options:j}})},[l]),O=c.exports.useCallback(z=>{l({type:yc,payload:{correlation:z,assignmentData:u}})},[u,l]),L=c.exports.useCallback(z=>{const j=Ie(z);if(j===1){const K=Re(n,z.experimentID,!1),ne=vi(K,z.signal.id),_e=ec(K,z.signal.id);l({type:Fc,payload:{spectrum:K,range:ne,signal:_e,assignmentData:u}})}else if(j===2){const K=Re(n,z.experimentID,!1),ne=_o(K,z.signal.id),_e=Xn(K,z.signal.id);l({type:Wc,payload:{spectrum:K,zone:ne,signal:_e,assignmentData:u}})}},[u,l,n]),H=c.exports.useCallback(z=>{var K;if(Ie(z)===2){const ne=Re(n,z.experimentID,!1),_e=_o(ne,z.signal.id),gt=Xn(ne,z.signal.id);l({type:Zc,payload:{spectrum:ne,zone:_e,signal:gt,pathLength:(K=z.signal.j)==null?void 0:K.pathLength}})}},[l,n]),X=c.exports.useCallback((z,j,K,ne)=>{j==="add"||j==="move"||j==="remove"||j==="unmove"||j==="setPathLength"?(K&&K.pseudo===!1&&(j==="remove"?L(K):j==="setPathLength"&&H(K)),I(z,ne)):j==="removeAll"&&O(z[0])},[H,O,L,I]),J=c.exports.useCallback(()=>{v(!k)},[k]);return w("div",{css:KE,children:[w(it,{canDelete:!1,counter:t?t.values.length:0,onFilter:J,filterToolTip:k?"Show all correlations":"Hide correlations out of view",filterIsActive:k,counterFiltered:C==null?void 0:C.values.length,children:[d(Ee,{title:`Set molecular formula (${t.options.mf})`,popupPlacement:"right",children:d("button",{type:"button",onClick:M,children:d(mh,{})})}),d(Ee,{title:"Set shift tolerance",popupPlacement:"right",children:d("button",{type:"button",onClick:D,children:d(gh,{})})}),w("div",{className:"extra-header-content",children:[d("div",{className:"overview-container",children:d(BE,{correlationsData:t})}),d("div",{className:"table-view-selection",children:w("span",{children:[d("label",{children:"View:"}),d(Ne,{onChange:z=>{g(z),y(z==="H-H")},data:P,defaultValue:m,style:{fontSize:"12px",width:"70px",height:"18px",border:"1px solid grey"}})]})})]})]}),d(zE,{correlationsData:t,filteredCorrelationsData:C,additionalColumnData:p,editEquivalencesSaveHandler:A,onSaveEditNumericValues:R,onEditCorrelationTableCellHandler:X,showProtonsAsRows:x,spectraData:n})]})}var JE=c.exports.memo(qE);const Ms={container:{padding:10,backgroundColor:"#f1f1f1",height:"100%",overflowY:"auto"},groupContainer:{padding:"5px",borderRadius:"5px",margin:"10px 0px",backgroundColor:"white"},row:{display:"flex",margin:"5px 0px"},header:{borderBottom:"1px solid #e8e8e8",paddingBottom:"5px",fontWeight:"bold",color:"#4a4a4a"},inputLabel:{flex:2,fontSize:"11px",fontWeight:"bold",color:"#232323"},input:{width:"30%",textAlign:"center"}},QE=[{id:1,label:"From :",checkController:"showFrom",formatController:"fromFormat"},{id:2,label:"To :",checkController:"showTo",formatController:"toFormat"},{id:3,label:"Absolute :",checkController:"showAbsolute",formatController:"absoluteFormat"},{id:4,label:"Relative :",checkController:"showRelative",formatController:"relativeFormat"}];function e2({nucleus:e,innerRef:t}){const n=le(),o=re(),s=c.exports.useRef(),i=c.exports.useCallback(()=>{if(e){const l=e.reduce((u,p)=>(u[p]=Zv,u),{}),a=ft(o.current,"formatting.panels.zones");s.current.setValues(a||l)}},[e,o]);c.exports.useEffect(()=>{i()},[i]);const r=c.exports.useCallback(l=>{o.dispatch({type:"SET_PANELS_PREFERENCES",payload:{key:"zones",value:l}}),n.success("zones preferences saved successfully")},[n,o]);return c.exports.useImperativeHandle(t,()=>({saveSetting:()=>{s.current.submitForm()}}),[]),f("div",{style:Ms.container,children:f(ce,{onSubmit:r,ref:s,children:e==null?void 0:e.map(l=>_("div",{style:Ms.groupContainer,children:[f(Le,{style:Ms.header,value:l}),QE.map(a=>f(Fe,{label:a.label,checkControllerName:`${l}.${a.checkController}`,formatControllerName:`${l}.${a.formatController}`},a.id))]},l))})})}const t2=c.exports.memo(e2);function n2(e,t){const n=ys();return f(t2,{innerRef:t,nucleus:n})}var o2=c.exports.forwardRef(n2);const s2=N`
  width: 100%;
  height: 100%;
  margin-top: 10px;
  text-align: center;
...
`;function h2({onSaveEditZoneModal:e=()=>null,onCloseEditZoneModal:t=()=>null,onZoomEditZoneModal:n=()=>null,rowData:o}){const s=c.exports.useRef(null),i=d2(),r=c.exports.useCallback(()=>{n(o)},[n,o]);c.exports.useEffect(()=>{r()},[r]);const l=c.exports.useCallback(()=>{t()},[t]),a=c.exports.useCallback(p=>{(async()=>{const h=S(b({},o),{signals:p.signals.map(m=>{var g,x;return _d((g=m.j)==null?void 0:g.pathLength,o.tableMetaInfo.experiment)&&((x=m.j)==null||delete x.pathLength,m.j&&Object.keys(m.j).length===0&&delete m.j),m})});await e(h),l()})()},[l,e,o]),u=c.exports.useMemo(()=>({activeTab:"0",signals:o.signals.map(p=>{var h,m;return S(b({},p),{j:b({pathLength:{from:((h=ve[o.tableMetaInfo.experiment])==null?void 0:h.from)||1,to:((m=ve[o.tableMetaInfo.experiment])==null?void 0:m.to)||1}},p.j)})})}),[o.signals,o.tableMetaInfo.experiment]);return d("div",{css:p2,children:w(ce,{ref:s,initialValues:u,validationSchema:i,onSubmit:a,children:[w("div",{className:"header handle",children:[d(me,{onClick:r,className:"zoom-button",children:d(qn,{title:"Set to default view on range in spectrum"})}),d("span",{children:"Zone and Signal edition"}),d(tr,{onClick:()=>s.current.submitForm(),popupTitle:"Save and exit"}),d(fe,{onClick:l})]}),d(u2,{})]})})}const f2={marginLeft:2,marginRight:2,border:"none",height:"20px"};function m2({rowData:e,rowSpanTags:t}){const n=Y(),o=Be(),s=he(),i=c.exports.useCallback(p=>{n({type:cu,payload:{rowData:e,value:p}})},[n,e]),r=c.exports.useCallback(()=>{n({type:ps,payload:{id:e.id,assignmentData:o}})},[o,n,e]),l=c.exports.useCallback(()=>{const p=Math.abs(e.x.from-e.x.to)*10;n({type:ls,xDomain:e.x.from<=e.x.to?[e.x.from-p,e.x.to+p]:[e.x.to-p,e.x.from+p]});const h=Math.abs(e.y.from-e.y.to)*10;n({type:Ai,yDomain:e.y.from<=e.y.to?[e.y.from-h,e.y.to+h]:[e.y.to-h,e.y.from+h]})},[n,e.x.from,e.x.to,e.y.from,e.y.to]),a=c.exports.useCallback(p=>{n({type:uu,payload:{editedRowData:p}})},[n]),u=c.exports.useCallback(()=>{n({type:lo,payload:{selectedTool:F.editRange.id,tempRange:e}}),s.show(f(h2,{onCloseEditZoneModal:()=>s.close(),onSaveEditZoneModal:a,onZoomEditZoneModal:()=>l(),rowData:e}),{position:te.MIDDLE_RIGHT,transition:et.SCALE,isBackgroundBlur:!1})},[n,s,e,a,l]);return _(c.exports.Fragment,{children:[f("td",{children:f(Ne,{onChange:p=>{i(p)},data:ri,defaultValue:e.tableMetaInfo.signal.kind,style:f2})}),_("td",S(b({},t),{children:[f("button",{type:"button",className:"delete-button",onClick:r,children:f(Et,{})}),f("button",{type:"button",className:"zoom-button",onClick:l,children:f(qn,{title:"Zoom to zone in spectrum"})}),f("button",{type:"button",className:"edit-button",onClick:u,children:f(Wl,{color:"blue"})})]}))]})}function fl({rowData:e,assignment:t,highlight:n,onHover:o,onClick:s,onUnlink:i,axis:r,showUnlinkButton:l,setShowUnlinkButton:a}){return f("td",S(b({},o),{onClick:u=>s(u,t,r),style:n.isActive||t.isActive&&t.activeAxis===r?{color:"red",fontWeight:"bold"}:void 0,children:V(e,`tableMetaInfo.signal.${r}.diaIDs`,[]).length>0?_("div",{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),children:[e.tableMetaInfo.signal[r].diaIDs.length," ",f("sup",{children:f("button",{type:"button",style:{visibility:l?"visible":"hidden",padding:0,margin:0},onClick:u=>i(u,!1,r),children:f(Qo,{color:"red"})})})]}):t.isActive&&t.activeAxis===r?"0":""}))}function g2({rowData:e,assignmentSignal:t,onHoverSignalX:n,onHoverSignalY:o,showUnlinkButtonSignalX:s,showUnlinkButtonSignalY:i,setShowUnlinkButtonSignalX:r,setShowUnlinkButtonSignalY:l,onClick:a,onUnlink:u,highlightSignalX:p,highlightSignalY:h}){return _(c.exports.Fragment,{children:[f(fl,{rowData:e,assignment:t,highlight:p,onHover:n,onClick:a,onUnlink:u,axis:"x",showUnlinkButton:s,setShowUnlinkButton:r}),f(fl,{rowData:e,assignment:t,highlight:h,onHover:o,onClick:a,onUnlink:u,axis:"y",showUnlinkButton:i,setShowUnlinkButton:l})]})}function x2({rowData:e,onHoverSignalX:t,onHoverSignalY:n}){const o=Y(),s=V(e,"tableMetaInfo.signal.x.delta",null),i=V(e,"tableMetaInfo.signal.y.delta",null),r=V(e,"tableMetaInfo.signal.id",void 0),l=c.exports.useCallback(u=>{const p=u.target.value;o({type:Zs,payload:{zoneID:e.id,signal:{id:r,x:p}}})},[o,r,e.id]),a=c.exports.useCallback(u=>{const p=u.target.value;o({type:Zs,payload:{zoneID:e.id,signal:{id:r,y:p}}})},[o,r,e.id]);return _(c.exports.Fragment,{children:[f("td",S(b({},t),{children:s!==null?f(ct,{value:s.toFixed(2),onSave:l,type:"number",style:{padding:"0.1rem 0.4rem"}}):""})),f("td",S(b({},n),{children:i!==null?f(ct,{value:i.toFixed(2),onSave:a,type:"number",style:{padding:"0.1rem 0.4rem"}}):""}))]})}function ml({rowData:e,assignment:t,highlight:n,onHover:o,onClick:s,onUnlink:i,axis:r,showUnlinkButton:l,setShowUnlinkButton:a,rowSpanTags:u}){return f("td",S(b(b({},u),o),{onClick:p=>s(p,t,r),children:V(e,`${r}.nbAtoms`,0)>0?V(e,`${r}.diaIDs`,0).length>0?_("div",{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),children:[e[r].nbAtoms," ","(",f("span",{style:t.isActive&&t.activeAxis===r||t.isOnHover&&t.onHoverAxis===r||n.isActive?{color:"red",fontWeight:"bold"}:{color:"black",fontWeight:"normal"},children:V(e,`${r}.diaIDs`,[]).length}),")"," ",f("sup",{children:f("button",{type:"button",style:{visibility:l?"visible":"hidden",padding:0,margin:0},onClick:p=>i(p,!0,r),children:f(Qo,{color:"red"})})})]}):t.isActive&&t.activeAxis===r?_("div",{children:[`${V(e,`${r}.nbAtoms`,"")} (`,f("span",{style:{color:"red",fontWeight:"bold"},children:"0"}),")"]}):e[r].nbAtoms:t.isActive&&t.activeAxis===r?_("div",{children:["0 (",f("span",{style:{color:"red",fontWeight:"bold"},children:"0"}),")"]}):""}))}function b2({rowData:e,assignmentZone:t,onHoverZoneX:n,onHoverZoneY:o,showUnlinkButtonZoneX:s,showUnlinkButtonZoneY:i,setShowUnlinkButtonZoneX:r,setShowUnlinkButtonZoneY:l,rowSpanTags:a,onClick:u,onUnlink:p,highlightZoneX:h,highlightZoneY:m}){return _(c.exports.Fragment,{children:[f(ml,{rowData:e,assignment:t,highlight:h,onHover:n,onClick:u,onUnlink:p,axis:"x",showUnlinkButton:s,setShowUnlinkButton:r,rowSpanTags:a}),f(ml,{rowData:e,assignment:t,highlight:m,onHover:o,onClick:u,onUnlink:p,axis:"y",showUnlinkButton:i,setShowUnlinkButton:l,rowSpanTags:a})]})}const y2={backgroundColor:"#ff6f0057"},v2={backgroundColor:"#f5f5dc"};function C2({rowData:e,onUnlink:t,onContextMenu:n,rowIndex:o}){const s=dt(e.id),i=ie([s.id]),r=ie([ke(s.id,"X")].concat(s.assigned.x||[])),l=ie([ke(s.id,"Y")].concat(s.assigned.y||[])),a=dt(e.tableMetaInfo.id),u=ie([ke(a.id,"X")].concat(a.assigned.x||[],ke(a.id,"Crosshair"))),p=ie([ke(a.id,"Y")].concat(a.assigned.y||[],ke(a.id,"Crosshair"))),[h,m]=c.exports.useState(!1),[g,x]=c.exports.useState(!1),[y,k]=c.exports.useState(!1),[v,C]=c.exports.useState(!1),E=c.exports.useMemo(()=>({rowSpan:e.tableMetaInfo.rowSpan,style:V(e,"tableMetaInfo.hide",!1)===!0?{display:"none"}:null}),[e]),T=c.exports.useCallback((I,O,L)=>{I&&I.stopPropagation(),t(e,O,e.tableMetaInfo.signalIndex,L),L==="x"?O!==void 0?O?(m(!1),s.removeAll("x")):(k(!1),a.removeAll("x")):(m(!1),k(!1)):L==="y"?O!==void 0?O?(x(!1),s.removeAll("y")):(C(!1),a.removeAll("y")):(x(!1),C(!1)):(m(!1),s.removeAll("x"),k(!1),a.removeAll("x"),x(!1),s.removeAll("y"),C(!1),a.removeAll("y"))},[a,s,t,e]),M=c.exports.useCallback((I,O,L)=>{I.stopPropagation(),O.onClick(L)},[]),D=c.exports.useMemo(()=>({onMouseEnter:()=>{s.onMouseEnter("x"),r.show()},onMouseLeave:()=>{s.onMouseLeave("x"),r.hide()}}),[s,r]),P=c.exports.useMemo(()=>({onMouseEnter:()=>{s.onMouseEnter("y"),l.show()},onMouseLeave:()=>{s.onMouseLeave("y"),l.hide()}}),[s,l]),A=c.exports.useMemo(()=>({onMouseEnter:()=>{a.onMouseEnter("x"),u.show()},onMouseLeave:()=>{a.onMouseLeave("x"),u.hide()}}),[a,u]),R=c.exports.useMemo(()=>({onMouseEnter:()=>{a.onMouseEnter("y"),p.show()},onMouseLeave:()=>{a.onMouseLeave("y"),p.hide()}}),[a,p]);return w("tr",S(b({onContextMenu:I=>n(I,e),style:i.isActive||s.isActive?y2:V(e,"tableMetaInfo.isConstantlyHighlighted",!1)===!0?v2:null},i.onHover),{children:[d("td",S(b({},E),{children:o+1})),d(x2,{rowData:e,onHoverSignalX:A,onHoverSignalY:R}),d(g2,{rowData:e,assignmentSignal:a,onHoverSignalX:A,onHoverSignalY:R,showUnlinkButtonSignalX:y,showUnlinkButtonSignalY:v,setShowUnlinkButtonSignalX:I=>k(I),setShowUnlinkButtonSignalY:I=>C(I),onClick:M,onUnlink:T,highlightSignalX:u,highlightSignalY:p}),d(b2,{rowData:e,assignmentZone:s,onHoverZoneX:D,onHoverZoneY:P,showUnlinkButtonZoneX:h,showUnlinkButtonZoneY:g,setShowUnlinkButtonZoneX:I=>m(I),setShowUnlinkButtonZoneY:I=>x(I),rowSpanTags:E,onClick:M,onUnlink:T,highlightZoneX:r,highlightZoneY:l}),d(m2,{rowData:e,rowSpanTags:E})]}))}const k2=N`
  border-spacing: 0;
  border: 1px solid #dedede;
  width: 100%;
  font-size: 12px;
...
`,bl={solvent:"",searchKeywords:""};function z2({nucleus:e,selectedTool:t}){const n=Y(),{handleChangeOption:o}=vs(),s=Xe(e),[i,r]=c.exports.useState(!1),l=c.exports.useRef(),[a,u]=c.exports.useState(bl),p=c.exports.useRef(null),[h,m]=c.exports.useState({data:[],databases:[],solvents:[]}),{item:g}=Ch("Database"),x=c.exports.useCallback(()=>{r(!i)},[i]),y=c.exports.useCallback(()=>{l.current.saveSetting(),r(!1)},[]),k=c.exports.useCallback(D=>{if(typeof D=="string"||D===-1){const P=String(D);u(A=>S(b({},A),{solvent:P}))}else u(P=>S(b({},P),{searchKeywords:D.target.value}))},[]);c.exports.useEffect(()=>{g!=null&&g.isOpen&&setTimeout(()=>{const D=B2(R2());p.current=gl(D[0].key,e);const P=p.current.data,A=yl(p.current.getSolvents());m({data:P,databases:D,solvents:A})})},[g==null?void 0:g.isOpen,e]),c.exports.useEffect(()=>{const{solvent:D,searchKeywords:P}=a;setTimeout(()=>{if(p.current)if(!D&&!P){const A=p.current.data,R=yl(p.current.getSolvents());m(I=>S(b({},I),{data:A,solvents:R}))}else{const A=[...P.split(",")];D!=="-1"&&A.unshift(`solvent:${D}`);const R=p.current.search(A);m(I=>S(b({},I),{data:R}))}})},[a]),c.exports.useEffect(()=>{function D(P){t===F.databaseRangesSelection.id&&u(A=>{const R=A.searchKeywords?A.searchKeywords.split(","):[],[I,O]=P.range,L=[...R,`delta:${s(I)}..${s(O)}`].join(",");return S(b({},A),{searchKeywords:L})})}return de.on("brushEnd",D),()=>{de.off("brushEnd",D)}},[s,t]);const v=c.exports.useCallback(D=>{p.current=gl(D,e),u(bl)},[e]),C=c.exports.useMemo(()=>M2(h.data),[h.data]),E=c.exports.useCallback(D=>{const{index:P}=D.original,{ranges:A,solvent:R,names:I=[]}=h.data[P];n({type:Tu,payload:{ranges:A,info:{solvent:R,nucleus:e,name:I[0]}}})},[n,e,h.data]),T=c.exports.useCallback(()=>{u(D=>S(b({},D),{searchKeywords:""}))},[]),M=c.exports.useCallback(D=>{const P=D?F.databaseRangesSelection.id:F.zoom.id;o(P)},[o]);return w("div",{css:[Rt,H2,i&&N`
            .table-container {
              table,
              th {
                position: relative !important;
...
`;function TA({onClose:e=()=>null}){return w("div",{css:AA,children:[w("div",{className:"header handle",children:[d("span",{children:"About NMRium"}),d(fe,{onClick:e})]}),w("div",{className:"container",children:[w("div",{className:"center-container",children:[d(EA,{width:160,height:50}),"Version ",d(DA,{}),d("span",{className:"separator"}),d("a",{href:"https://git.nmrium.org",target:"_blank",rel:"noreferrer",children:"GitHub ( https://git.nmrium.org )"})]}),d("div",{className:"center-container",children:d("span",{className:"separator"})}),d("span",{className:"content",children:"This project is developed by Zakodium S\xE0rl (Switzerland), the University of Cologne (Germany), Johannes Gutenberg University Mainz (Germany) and Universidad del Valle (Colombia)."}),w("div",{className:"center-container",children:[d("span",{className:"separator"}),d("span",{className:"title",children:"Funding is provided by"}),d("span",{className:"separator"})]}),d("div",{className:"content",children:w("ul",{children:[d("li",{children:"IDNMR grant, which part of the Scientific Library Services and Information Systems (LIS) initiative of the DFG."}),d("li",{children:"Zakodium S\xE0rl (Switzerland)."}),d("li",{children:"Universidad del Valle (Cali, Colombia)."})]})})]})]})}function DA(){const{version:e}=wA;return e==="HEAD"?d(je,{children:"HEAD"}):e.startsWith("git-")?w("a",{href:`https://github.com/cheminfo/nmrium/tree/${e.slice(4)}`,target:"_blank",rel:"noreferrer",children:["git-",e.slice(4,14)]}):d("a",{href:`https://github.com/cheminfo/nmrium/tree/${e}`,target:"_blank",rel:"noreferrer",children:e})}function PA(){return _(tt,{children:[f("p",{className:"section-header",children:"Spectra"}),f(Q,{title:"Transparency of Dimmed Spectra [ 0 - 1 ]",children:f(W,{name:"controllers.dimmedSpectraTransparency",checkValue:e=>e>=0&&e<=1,type:"number"})})]})}const RA=[{label:"Spectra selection panel",name:"panels.spectraPanel"},{label:"Spectra information Panel",name:"panels.informationPanel"},{label:"Peaks and peak picking",name:"panels.peaksPanel"},{label:"Integration and integrals",name:"panels.integralsPanel"},{label:"1D ranges peak picking",name:"panels.rangesPanel"},{label:"Chemical structure panel",name:"panels.structuresPanel"},{label:"Filters Panel",name:"panels.filtersPanel"},{label:"2D zones peak picking",name:"panels.zonesPanel"},{label:"Assignment summary Panel",name:"panels.summaryPanel"},{label:"Multiple Spectra Analysis Panel",name:"panels.multipleSpectraAnalysisPanel"},{label:"Database Panel",name:"panels.databasePanel"},{label:"Prediction Panel",name:"panels.predictionPanel"},{label:"Experimental Features",name:"general.experimentalFeatures",hideOpenOption:!0}];function Cl(e){return f(xt,{style:{container:{display:"block",margin:"0 auto",width:"fit-content"}},className:"checkbox-element",name:e.name},e.name)}function IA({preferences:e}){const t=c.exports.useMemo(()=>[{index:1,Header:"#",Cell:({row:o})=>o.index+1},{index:1,Header:"Feature",accessor:"label",style:{width:"60%"}},{index:2,Header:"Active",Cell:({row:o})=>f(Cl,{name:`display.${o.original.name}.display`})},{index:3,Header:"Open on load",Cell:({row:o})=>o.original.hideOpenOption?f("div",{}):f(Cl,{name:`display.${o.original.name}.open`})}],[]),n=c.exports.useMemo(()=>RA.filter(o=>V(e,`${o.name}.hidden`)!==!0),[e]);return f("div",{style:{width:"100%",overflow:"hidden"},children:f(po,{columns:t,data:n})})}const MA=N`
  .counter-col {
    width: 30px;
  }
  .nucleus-label-col {
...
`,iT=N`
  ...
  flex-direction: 'column';
  height: 100%;
`;function rT(e){const{width:t,height:n}=$(),o=Y(),s=le(),i=c.exports.useCallback(async(g,x)=>{for(let y of x){const k=g.filter(v=>rn(v.name)===y);switch(y){case xe.MOL:{const v=await So(k);o({type:Ys,files:v});break}case xe.NMRIUM:case xe.JSON:{const v=await So(k,{asBuffer:!0});if(k.length===1){const C=new TextDecoder("utf8");v[0].binary=C.decode(v[0].binary),o({type:gn,files:v})}else throw new Error("You can add only one json file");break}case xe.JDX:case xe.DX:{const v=await So(k,{asBuffer:!0});o({type:$o,files:v});break}case xe.JDF:{const v=await So(k,{asBuffer:!0});o({type:Gs,files:v});break}}}},[o]),r=c.exports.useCallback(async g=>{const x=[...new Set(g.map(y=>rn(y.name)))];for(let y of x){const k=g.filter(v=>rn(v.name)===y);try{switch(y){case xe.MOL:{const v=await _t(k);o({type:Ys,files:v});break}case xe.NMRIUM:case xe.JSON:if(k.length===1){const v=await _t(k,{asBuffer:!0});if(eT(v[0].binary)===QA.ZIP){const E=await un.loadAsync(v[0].binary);await i(Object.values(E.files),[xe.NMRIUM])}else{const E=new TextDecoder("utf8");v[0].binary=E.decode(v[0].binary),o({type:gn,files:v})}}else throw new Error("You can add only one json file");break;case xe.JDX:case xe.DX:{const v=await _t(k,{asBuffer:!0});o({type:$o,files:v});break}case xe.JDF:{const v=await _t(k,{asBuffer:!0});o({type:Gs,files:v});break}case xe.ZIP:{const v=await _t(k,{asBuffer:!0});for(const C of v){const E=await un.loadAsync(C.binary),T=[...new Set(Object.values(E.files).map(D=>rn(D.name)))];T.some(D=>xe[D.toUpperCase()]&&D!==xe.ZIP)?(Object.keys(E.files).some(P=>["2rr","fid","1r"].some(A=>P.endsWith(A)))&&o({type:Ho,files:v}),await i(Object.values(E.files),T)):o({type:Ho,files:v})}break}case xe.NMREDATA:_t(k,{asBuffer:!0}).then(async v=>{for(const C of v)o({type:Yn,file:C})});break;default:throw new Error("The file extension must be zip, dx, jdx, json, mol, nmredata or nmrium.")}}catch(v){o({type:kt,isLoading:!1}),s.error(v.message)}}},[s,o,i]),l=c.exports.useCallback(g=>{o({type:kt,isLoading:!0}),r(g)},[o,r]),{getRootProps:a,getInputProps:u,isDragActive:p,open:h}=Rh({onDrop:l,noClick:!0,noKeyboard:!0}),m=c.exports.useCallback(()=>{h()},[h]);return d(Qy,{value:m,children:w("div",S(b({},a()),{role:"none",css:iT,children:[d("input",b({"data-test-id":"dropzone-input"},u())),p&&w("div",{css:sT,style:{width:`${t}px`,height:`${n}px`,marginTop:"30px",marginLeft:"30px"},children:[d(Ih,{}),d("p",{children:"Drop your files here"})]}),e.children]}))})}const lT=[$i,us,Sc,ze,Vo,kt,dc,hc,Lc,lo,Li,Fi,pc,Ti,ls,Ai,cs,Pi,_i,Ni,xn,ny,ty,Oi,Gn,Di,zo,mc,jo];function aT(e){return!lT.includes(e)}const cT=N`
  .menu {
    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);
    padding: 0px;
    margin: 0px;
