...
`;function Qh(e){const t=c.exports.useMemo(()=>Bh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(Yh,e.menuIsClosed?Zh:Gh),children:[w("div",{css:Uh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(Kh,qh),children:"NMRium"})}),p("button",{type:"button",css:Wh,onClick:e.onMenuToggle,children:p($d,{})})]}),p("div",{css:Jh,style:{display:n},children:p(Hd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var ef=Od(c.exports.memo(Qh));const tf="modulepreload",hl={},nf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${nf}${o}`,o in hl)return;hl[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":tf,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",a)})})).then(()=>t())},ti={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.bc0a7d2e.js"),["assets/Exam.bc0a7d2e.js","assets/vendor.3abbb066.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.af87bb71.js"),["assets/Exercise.af87bb71.js","assets/vendor.3abbb066.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.aee9ee03.js"),["assets/SingleView.aee9ee03.js","assets/vendor.3abbb066.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return AT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.a3292205.js"),["assets/View.a3292205.js","assets/vendor.3abbb066.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.b1b11e7c.js"),["assets/TwoInstances.b1b11e7c.js","assets/vendor.3abbb066.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.e69e300b.js"),["assets/Teaching.e69e300b.js","assets/vendor.3abbb066.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.be409ca9.js"),["assets/Prediction.be409ca9.js","assets/View.a3292205.js","assets/vendor.3abbb066.js"])))},of=P`
  position: relative;
  float: right;
  height: 100%;
...
`;function BC(e){const[t,n]=c.exports.useState(),{setFieldValue:o,errors:s,values:i}=pe(),{molecules:l,activeTab:r}=$(),a=Ea(r),u=c.exports.useMemo(()=>a&&l&&l.length>0&&t!==void 0&&l[t].atoms[a]?l[t].atoms[a]:0,[t,a,l]),d=c.exports.useCallback(m=>{n(m),o(e.name,l[m])},[l,e.name,o]);c.exports.useEffect(()=>{if(l&&l.length>0){const m=i[e.name]?l.findIndex(g=>g.key===i[e.name].key):-1;d(m!==-1?m:0)}},[l,e.name,d,i]);const h=c.exports.useCallback(m=>{d(m)},[d]);return p("div",{css:jC,children:a&&l&&l.length>0?w("div",{className:"molecule-container",children:[p("p",{className:"title",children:"Select a molecule as reference!"}),w("div",{className:"molecule-selection-container",children:[p(fd,{index:t,molecules:l,onChange:h}),w("p",{className:"newSumText",children:["New sum for ",a," will be ",u,"!"]})]})]}):p("p",{className:"empty",style:{color:s[e.name]?"red":"black"},children:"You have to Select a spectrum and Add a molecule from the Structure panel to select as a reference!"})})}const XC=P`
  width: 450px;
  height: 400px;
  .header {
    display: flex;
...
`;function md({onSave:e,onClose:t,header:n,sumOptions:o}){var g;const{current:{display:{general:s,panels:i}}}=ce(),[l,r]=c.exports.useState("auto"),a=c.exports.useRef(null),u=c.exports.useCallback(x=>{x.key==="Enter"&&a.current.submitForm()},[]),d=c.exports.useCallback(x=>{r(x.tabid)},[]);c.exports.useEffect(()=>{var x;if((o==null?void 0:o.sumAuto)&&!(s==null?void 0:s.hideSetSumFromMolecule)&&!((x=i==null?void 0:i.structuresPanel)==null?void 0:x.hidden)){r("auto");const{mf:y,moleculeKey:C}=o;a.current.setValues({sum:null,molecule:C&&y?{mf:y,key:C}:null})}else r("manual"),a.current.setValues({sum:(o==null?void 0:o.sum)||"",molecule:null})},[s==null?void 0:s.hideSetSumFromMolecule,i==null?void 0:i.structuresPanel,o]);const h=c.exports.useCallback(x=>{switch(l){case"auto":{const{molecule:{mf:y,key:C}}=x;e({sumAuto:!0,mf:y,moleculeKey:C});break}case"manual":{const{sum:y}=x;e({sum:y,sumAuto:!1});break}default:return}t()},[t,e,l]),m=c.exports.useMemo(()=>{switch(l){case"auto":return ee({molecule:ee().required()});case"manual":return ee({sum:ae().required()});default:return null}},[l]);return w("div",{css:[ht,XC],children:[w("div",{className:"header handle",children:[p("span",{children:n}),p(me,{onClick:t})]}),p("div",{className:"tab-content",children:p(re,{ref:a,onSubmit:h,initialValues:{sum:null,molecule:null},validationSchema:m,children:w(Rn,{activeTab:l,onClick:d,children:[!(s==null?void 0:s.hideSetSumFromMolecule)&&!((g=i==null?void 0:i.structuresPanel)==null?void 0:g.hidden)&&p(Ne,{tablabel:"Auto",tabid:"auto",children:p(BC,{name:"molecule"})}),p(Ne,{tablabel:"Manual",tabid:"manual",children:p("div",{className:"manual-container",children:p(W,{name:"sum",type:"number",placeholder:"Enter the new value",onKeyDown:u})})})]})})}),p("div",{className:"footer-container",children:p("button",{type:"button",onClick:()=>a.current.submitForm(),className:"btn",children:"Set"})})]})}const YC=P`
  background-color: transparent;
  border: none;
  height: 100%;
  svg {
