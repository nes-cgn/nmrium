var I=Object.defineProperty,D=Object.defineProperties;var E=Object.getOwnPropertyDescriptors;var M=Object.getOwnPropertySymbols;var F=Object.prototype.hasOwnProperty,z=Object.prototype.propertyIsEnumerable;var v=(t,e,s)=>e in t?I(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s,S=(t,e)=>{for(var s in e||(e={}))F.call(e,s)&&v(t,s,e[s]);if(M)for(var s of M(e))z.call(e,s)&&v(t,s,e[s]);return t},k=(t,e)=>D(t,E(e));var Q=typeof require!="undefined"?require:t=>{throw new Error('Dynamic require of "'+t+'" is not supported')};import{r,j as o,c as n}from"./vendor.e10e3af8.js";import{f as h,N as J,S as O,M as H}from"./NMRium.83a05698.js";import"./index.531d50e3.js";let m=JSON.parse(localStorage.getItem("nmrium-exercises")||"{}");async function T(t){const e=await fetch(t);return $(e),await e.json()}function $(t){if(!t.ok)throw new Error(`HTTP ${t.status} - ${t.statusText}`);return t}const B=n`
  text-transform: none;
  margin: 0;
  padding: 5px;
