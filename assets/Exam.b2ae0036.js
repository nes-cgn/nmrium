import{r as e,j as t,c as o,e as n,f as i}from"./vendor.226db6eb.js";import{f as l,N as s,S as r,M as a,c}from"./NMRium.ff7ac365.js";import"./index.40454a95.js";let d=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function u(e){const t=await fetch(e);!function(e){if(!e.ok)throw new Error(`HTTP ${e.status} - ${e.statusText}`)}(t);return await t.json()}const f=o`
  display: flex;
...
//# sourceMappingURL=Exam.b2ae0036.js.map
