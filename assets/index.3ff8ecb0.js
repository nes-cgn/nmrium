...
`;function vf(e){const t=c.exports.useMemo(()=>uf(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:M(pf,e.menuIsClosed?ff:hf),children:[w("div",{css:gf,children:[d("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:d("a",{css:M(xf,bf),children:"NMRium"})}),d("button",{type:"button",css:mf,onClick:e.onMenuToggle,children:d(tp,{})})]}),d("div",{css:yf,style:{display:n},children:d(np,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+$t(o.item.props.file)}`)},mode:"inline",children:t})})]})}var Cf=ep(c.exports.memo(vf));const Sf="modulepreload",wr={},kf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${kf}${o}`,o in wr)return;wr[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const r=document.createElement("link");if(r.rel=s?"stylesheet":Sf,s||(r.as="script",r.crossOrigin=""),r.href=o,document.head.appendChild(r),s)return new Promise((l,a)=>{r.addEventListener("load",l),r.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},li={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.9cfd42c4.js"),["assets/Exam.9cfd42c4.js","assets/vendor.cb0f3979.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.b1706373.js"),["assets/Exercise.b1706373.js","assets/vendor.cb0f3979.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.f4e6a1a2.js"),["assets/SingleView.f4e6a1a2.js","assets/vendor.cb0f3979.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return cD}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.fce53427.js"),["assets/View.fce53427.js","assets/vendor.cb0f3979.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.27537c9a.js"),["assets/TwoInstances.27537c9a.js","assets/vendor.cb0f3979.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.e2471a49.js"),["assets/Teaching.e2471a49.js","assets/vendor.cb0f3979.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.e3ef2777.js"),["assets/Prediction.e3ef2777.js","assets/View.fce53427.js","assets/vendor.cb0f3979.js"])))},wf=M`
  position: relative;
  float: right;
  height: 100%;
...
`;function Bu({isEmpty:e=!0,emptyText:t="Drag and drop here a JCAMP-DX, zipped Bruker folder, Jeol jdf or NMRium file",canOpenLoader:n=!0}){const o=Yi();return e?d("div",k(b({css:u0},n&&{onClick:o}),{children:d("p",{children:t})})):null}const d0=M`
  display: flex;
  align-items: center;
  justify-content: center;
  background-color: rgba(255, 255, 255, 0.25);
...
`;function Nv(){return d("div",{css:Pv})}function Rv(a){var u=a,{children:e,wrapperRef:t=null,offset:n="5px",position:o=ne.BOTTOM_CENTER,timeout:s=3e3,type:i,transition:r=Qe.FADE}=u,l=G(u,["children","wrapperRef","offset","position","timeout","type","transition"]);const p=c.exports.useRef(null),h=c.exports.useRef([]),[m,g]=c.exports.useState([]);c.exports.useEffect(()=>{p.current=document.createElement("div");const A=p.current,I=h.current;return t&&t.appendChild(A),()=>{A&&t&&(I.forEach(clearTimeout),t.removeChild(A))}},[t]);const x=c.exports.useCallback(A=>{g(I=>{const R=I.length,H=I.filter(L=>L.id!==A.id);return R>H.length&&A.options.onClose&&A.options.onClose(),H})},[]),y=c.exports.useCallback((A="",I={})=>{const R=Math.random().toString(36).substr(2,9),H=b({position:I.position||o,timeout:s,type:i,backgroundColor:"black",color:"white"},I),L={id:R,message:A,options:H};if(L.close=()=>x(L),L.options.timeout){const z=setTimeout(()=>{x(L),h.current.splice(h.current.indexOf(z),1)},L.options.timeout);h.current.push(z)}return g(z=>z.concat(L)),L.options.onOpen&&L.options.onOpen(),L},[o,x,s,i]),S=c.exports.useCallback((A="",I={})=>(I.type=_n.SUCCESS,I=b({backgroundColor:"#28ba62",color:"white"},I),y(A,I)),[y]),v=c.exports.useCallback((A="",I={})=>(I.type=_n.ERROR,I=b({backgroundColor:"#cf3c4f",color:"white"},I),y(A,I)),[y]),C=c.exports.useCallback((A="",I={})=>(I.type=_n.INFO,I.color="#28ba62",y(A,I)),[y]),E=c.exports.useCallback((A="Process in progress",I={})=>(I.type=_n.PROGRESS_INDICATOR,I.timeout=0,I.backgroundColor="#232323",new Promise(R=>{const H=y(A,I);setTimeout(()=>{R(()=>x(H))},500)})),[x,y]),T=c.exports.useCallback(A=>{x(A)},[x]),N=Iv(m,A=>A.options.position),D=c.exports.useMemo(()=>t?t.getBoundingClientRect():{top:0,left:0,width:window.innerWidth,height:window.innerHeight},[t]),P=c.exports.useMemo(()=>({show:y,success:S,error:v,info:C,showLoading:E}),[y,S,v,C,E]);return _(Ev,{value:P,children:[e,p.current&&Ko.exports.createPortal(f(c.exports.Fragment,{children:Object.keys(ne).map(A=>{const I=ne[A];return f(jl,k(b({appear:!0,options:{position:I,zIndex:999999},component:cd,containerStyle:D},l),{children:N[I]?N[I].map(R=>f(ad,{type:r,children:_("div",{style:{margin:n,padding:"25px",borderRadius:"10px",pointerEvents:"all",backgroundColor:R.options.backgroundColor,color:R.options.color,minHeight:"60px",position:"relative"},children:[f("button",{style:{position:"absolute",right:"5px",top:"5px",border:"none",backgroundColor:"transparent",color:"white"},type:"button",onClick:()=>T(R),children:f(ii,{})}),f("span",{children:R.message}),R.options.type===_n.PROGRESS_INDICATOR&&f(Nv,{})]},R.id)},R.id)):null}),I)})}),p.current)]})}var Mv=c.exports.memo(Rv);const ud=c.exports.createContext({}),_v=ud.Provider;function fe(){return c.exports.useContext(ud)}const Fv=M`
  display: block;
  border-radius: 5px;
  overflow: hidden;
  width: 300px;
...
`;function Gv({data:e,activeSpectrum:t,scaleX:n,startX:o,endX:s,onClose:i}){var m;const[r,l]=c.exports.useState(),[a,u]=c.exports.useState(!1),[p,h]=c.exports.useState(!1);return c.exports.useEffect(()=>{setTimeout(()=>{u(!0)},400)},[]),c.exports.useEffect(()=>{if(t&&o&&s&&a){const g=e[t.index];if(Ys(g))throw new Error("unreachable");const{data:{x,re:y},info:S}=g,v=n().invert(o),C=n().invert(s),{fromIndex:E,toIndex:T}=Jn(x,{from:v,to:C}),N={x:x.slice(E,T),y:y.slice(E,T)};try{const D=Ml(N,{frequency:S.originFrequency,takeBestPartMultiplet:!0,symmetrizeEachStep:!0,debug:!0});h(!0),l(D)}catch(D){console.log(D)}}},[o,s,e,n,t,a]),p?w("div",{css:Xv,children:[w("div",{className:"header handle",children:[d("span",{children:"Analyse Multiplet"}),d(me,{onClick:i})]}),d("div",{className:"container",children:(m=r==null?void 0:r.debug)==null?void 0:m.steps.map((g,x)=>{var y,S;return w("div",{className:"row",children:[w(dn,{width:400,height:200,svgStyle:{overflow:"visible"},seriesViewportStyle:{stroke:"black"},children:[d(qe,{data:br(g.multiplet)}),d($e,{id:"y",position:"left",tickPosition:"inner",displayPrimaryGridLines:!0,hiddenTicks:!0,paddingStart:.1,paddingEnd:.1}),d($e,{id:"x",position:"bottom",tickPosition:"inner",displayPrimaryGridLines:!0})]}),d("div",{className:"multiplicity",children:d("p",{children:r.js[x]?`${(y=r.js[x])==null?void 0:y.multiplicity}: ${(S=r.js[x])==null?void 0:S.coupling.toFixed(3)} Hz`:""})}),w(dn,{width:400,height:200,seriesViewportStyle:{stroke:"black"},children:[d(qe,{data:br(g.errorFunction),lineStyle:{strokeWidth:1}}),d($e,{id:"y",position:"left",tickPosition:"inner",displayPrimaryGridLines:!0,hiddenTicks:!0,paddingStart:.1,paddingEnd:.1}),d($e,{id:"x",position:"bottom",tickPosition:"inner",displayPrimaryGridLines:!0})]})]},x)})})]}):w("div",{css:Yv,children:[d("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 841.9 595.3",children:w("g",{fill:"#61DAFB",children:[d("path",{d:"M666.3 296.5c0-32.5-40.7-63.3-103.1-82.4 14.4-63.6 8-114.2-20.2-130.4-6.5-3.8-14.1-5.6-22.4-5.6v22.3c4.6 0 8.3.9 11.4 2.6 13.6 7.8 19.5 37.5 14.9 75.7-1.1 9.4-2.9 19.3-5.1 29.4-19.6-4.8-41-8.5-63.5-10.9-13.5-18.5-27.5-35.3-41.6-50 32.6-30.3 63.2-46.9 84-46.9V78c-27.5 0-63.5 19.6-99.9 53.6-36.4-33.8-72.4-53.2-99.9-53.2v22.3c20.7 0 51.4 16.5 84 46.6-14 14.7-28 31.4-41.3 49.9-22.6 2.4-44 6.1-63.6 11-2.3-10-4-19.7-5.2-29-4.7-38.2 1.1-67.9 14.6-75.8 3-1.8 6.9-2.6 11.5-2.6V78.5c-8.4 0-16 1.8-22.6 5.6-28.1 16.2-34.4 66.7-19.9 130.1-62.2 19.2-102.7 49.9-102.7 82.3 0 32.5 40.7 63.3 103.1 82.4-14.4 63.6-8 114.2 20.2 130.4 6.5 3.8 14.1 5.6 22.5 5.6 27.5 0 63.5-19.6 99.9-53.6 36.4 33.8 72.4 53.2 99.9 53.2 8.4 0 16-1.8 22.6-5.6 28.1-16.2 34.4-66.7 19.9-130.1 62-19.1 102.5-49.9 102.5-82.3zm-130.2-66.7c-3.7 12.9-8.3 26.2-13.5 39.5-4.1-8-8.4-16-13.1-24-4.6-8-9.5-15.8-14.4-23.4 14.2 2.1 27.9 4.7 41 7.9zm-45.8 106.5c-7.8 13.5-15.8 26.3-24.1 38.2-14.9 1.3-30 2-45.2 2-15.1 0-30.2-.7-45-1.9-8.3-11.9-16.4-24.6-24.2-38-7.6-13.1-14.5-26.4-20.8-39.8 6.2-13.4 13.2-26.8 20.7-39.9 7.8-13.5 15.8-26.3 24.1-38.2 14.9-1.3 30-2 45.2-2 15.1 0 30.2.7 45 1.9 8.3 11.9 16.4 24.6 24.2 38 7.6 13.1 14.5 26.4 20.8 39.8-6.3 13.4-13.2 26.8-20.7 39.9zm32.3-13c5.4 13.4 10 26.8 13.8 39.8-13.1 3.2-26.9 5.9-41.2 8 4.9-7.7 9.8-15.6 14.4-23.7 4.6-8 8.9-16.1 13-24.1zM421.2 430c-9.3-9.6-18.6-20.3-27.8-32 9 .4 18.2.7 27.5.7 9.4 0 18.7-.2 27.8-.7-9 11.7-18.3 22.4-27.5 32zm-74.4-58.9c-14.2-2.1-27.9-4.7-41-7.9 3.7-12.9 8.3-26.2 13.5-39.5 4.1 8 8.4 16 13.1 24 4.7 8 9.5 15.8 14.4 23.4zM420.7 163c9.3 9.6 18.6 20.3 27.8 32-9-.4-18.2-.7-27.5-.7-9.4 0-18.7.2-27.8.7 9-11.7 18.3-22.4 27.5-32zm-74 58.9c-4.9 7.7-9.8 15.6-14.4 23.7-4.6 8-8.9 16-13 24-5.4-13.4-10-26.8-13.8-39.8 13.1-3.1 26.9-5.8 41.2-7.9zm-90.5 125.2c-35.4-15.1-58.3-34.9-58.3-50.6 0-15.7 22.9-35.6 58.3-50.6 8.6-3.7 18-7 27.7-10.1 5.7 19.6 13.2 40 22.5 60.9-9.2 20.8-16.6 41.1-22.2 60.6-9.9-3.1-19.3-6.5-28-10.2zM310 490c-13.6-7.8-19.5-37.5-14.9-75.7 1.1-9.4 2.9-19.3 5.1-29.4 19.6 4.8 41 8.5 63.5 10.9 13.5 18.5 27.5 35.3 41.6 50-32.6 30.3-63.2 46.9-84 46.9-4.5-.1-8.3-1-11.3-2.7zm237.2-76.2c4.7 38.2-1.1 67.9-14.6 75.8-3 1.8-6.9 2.6-11.5 2.6-20.7 0-51.4-16.5-84-46.6 14-14.7 28-31.4 41.3-49.9 22.6-2.4 44-6.1 63.6-11 2.3 10.1 4.1 19.8 5.2 29.1zm38.5-66.7c-8.6 3.7-18 7-27.7 10.1-5.7-19.6-13.2-40-22.5-60.9 9.2-20.8 16.6-41.1 22.2-60.6 9.9 3.1 19.3 6.5 28.1 10.2 35.4 15.1 58.3 34.9 58.3 50.6-.1 15.7-23 35.6-58.4 50.6zM320.8 78.4z"}),d("path",{d:"M520.5 78.1z"})]})}),d("p",{children:"Analyse Multiplet in progress. Please wait ..."})]})}function pd(){const{data:e,activeTab:t}=$();return c.exports.useMemo(()=>e?e.filter(n=>t===It(n.info.nucleus))||[]:[],[t,e])}function hd(e){const{activeSpectrum:t}=$(),n=le();return c.exports.useMemo(()=>{const o=t===null?!0:e===t.id,s=o?1:B(n.current,"controllers.dimmedSpectraTransparency",.1);return{isActive:o,opacity:s}},[t,e,n])}function Wv({zone:e,color:t,vAlign:n,spectrumID:o}){const{scaleX:s,scaleY:i}=ge(),r=re([e.id],{type:ue.EXCLUSION_ZONE,extra:{id:e.id,spectrumID:o}}),{opacity:l}=hd(o);return f("g",{transform:`translate(${s()(e.to)},0)`,children:f("rect",b({x:"0",transform:`translate(0,${i()(0)-(n+5)})`,width:`${s()(e.from)-s()(e.to)}`,height:"10px",style:{fill:r.isActive?"#ff6f0057":t,opacity:l}},r.onHover))},e.id)}var Zv=c.exports.memo(Wv);function gs(e,t){const{index:n=1,align:o="stack"}=t||{index:1,align:"stack"};return e.align===o?n*e.verticalShift:0}function Uv({displayerKey:e,xDomains:t,spectra:n,verticalAlign:o}){return f("g",{className:"spectrum-exclusion-zones-group",clipPath:`url(#${e}clip-chart-1d)`,children:n.filter(s=>s.display.isVisible===!0&&t[s.id]).map((s,i)=>Jv(s).map(r=>f(Zv,{spectrumID:s.id,vAlign:gs(o,{index:i}),zone:r,color:s.display.color},r.id)))})}const Kv=c.exports.memo(Uv);function qv(){const{displayerKey:e,xDomains:t,displayerMode:n,verticalAlign:o}=$(),s=pd();return n!==Y.DM_1D?null:f(Kv,{spectra:s,displayerKey:e,xDomains:t,verticalAlign:o})}function Jv(e){var t;return((t=e.filters.find(n=>n.name===no&&n.flag))==null?void 0:t.value)||[]}function Qv(){const{width:e,margin:t,xDomains:n,xDomain:o,mode:s}=$();return c.exports.useMemo(()=>Xt({width:e,margin:t,xDomains:n,xDomain:o,mode:s}),[t,s,e,o,n])}function e1(){const{height:e,margin:t,verticalAlign:n,activeSpectrum:o,integralsYDomains:s}=$();return c.exports.useMemo(()=>Sx({height:e,margin:t,verticalAlign:n,activeSpectrum:o,integralsYDomains:s}),[o,e,s,t,n])}function fd(e){const{data:t,activeSpectrum:n}=$(),o=Qv(),s=e1(),i=c.exports.useMemo(()=>{if(n){const{x:l,re:a}=t[n==null?void 0:n.index].data,{from:u,to:p}=e;return Fp({x:l,y:a},{from:u,to:p,reverse:!0})}return{x:[],y:[]}},[n,t,e]);return c.exports.useMemo(()=>{if(i){const l=zl(i,{nbPoints:200,optimize:!0}),a=new Ut;a.moveTo(o(l.x[0]),s(l.y[0]));for(let u=1;u<l.x.length;u++)a.lineTo(o(l.x[u]),s(l.y[u]));return a.toString()}else return""},[i,o,s])}const Ot={showAbsolute:!1,absoluteFormat:"0.00",showRelative:!0,relativeFormat:"0.00",color:"#000000",strokeWidth:1},t1={showFrom:!1,fromFormat:"0.00",showTo:!1,toFormat:"0.00",showAbsolute:!1,absoluteFormat:"0.00",showRelative:!0,relativeFormat:"0.00"},Ki=e=>({showFrom:!1,fromFormat:"0.00",showTo:!1,toFormat:"0.00",showAbsolute:!1,absoluteFormat:"0.00",showRelative:!0,relativeFormat:"0.00",jGraphTolerance:e==="1H"?.2:e==="13C"?2:0}),md={showPeakNumber:!0,peakNumberFormat:"0",showPeakIndex:!1,peakIndexFormat:"0.00",showDeltaPPM:!0,deltaPPMFormat:"0.00",showDeltaHz:!1,deltaHzFormat:"0.00",showPeakWidth:!1,peakWidthFormat:"00.0000",showIntensity:!0,intensityFormat:"0.00"},gd={showSmiles:!0,showSolvent:!1,showNames:!0,showRange:!1,showDelta:!0,showAssignment:!1,showCoupling:!0,showMultiplicity:!0};function Xo(e){const{x:t,anchor:n}=e,o=c.exports.useRef(!1),s=c.exports.useRef({relativeX:t,x:t}),[i,r]=c.exports.useState({x:t,action:null});return c.exports.useEffect(()=>{s.current={relativeX:t,x:t},r({x:t,action:null})},[t]),{onMouseDown:c.exports.useCallback(a=>{r({x:s.current.x,action:"start"}),s.current.relativeX=a.clientX-s.current.relativeX,o.current=!0,a.stopPropagation();function u(h){if(h.stopPropagation(),o.current){const m=h.clientX-s.current.relativeX;s.current={relativeX:m,x:m},r({x:m,action:"end"}),o.current=!1}window.removeEventListener("mousemove",p),window.removeEventListener("mouseup",u)}function p(h){h.stopPropagation(),o.current&&r({x:h.clientX-s.current.relativeX,action:"move"})}window.addEventListener("mousemove",p),window.addEventListener("mouseup",u)},[]),position:i,previousPosition:s.current.x,isActive:o.current,anchor:n}}const Gr={marginLeft:"5px",width:"2px",height:"100%",pointerEvents:"none",position:"relative"},Ts={container:e=>M`
  ...
  `,content:(e,t,n)=>{const o=n.previousPosition-t.previousPosition,s=M`
    ...
    `;if(n.position.action==="move"||t.position.action==="move"){const i=(n.position.x-t.position.x)/o;if(e==="RIGHT")return[s,M`
        ...
        `])}};function n1(e){const{children:t,initialPosition:n={x1:10,x2:40},onStart:o,onMove:s,onEnd:i}=e,r=Xo({x:n.x2,anchor:"RIGHT"}),l=Xo({x:n.x1,anchor:"LEFT"}),a=l.isActive?l.anchor:r.isActive?r.anchor:"";return c.exports.useEffect(()=>{const u={x1:l.position.x,x2:r.position.x};switch(l.isActive?l.position.action:r.isActive?r.position.action:""){case"start":o==null||o(u);break;case"move":s==null||s(u);break;case"end":i==null||i(u);break}},[l,i,s,o,r]),w(Ve,{children:[d("div",{"data-no-export":"true",onMouseDown:r.onMouseDown,css:Ts.container(r.position.x),children:d("div",{style:Gr})}),d("div",{css:Ts.content(a,l,r),children:typeof t=="function"?t==null?void 0:t(l.position.x,r.position.x):t}),d("div",{"data-no-export":"true",onMouseDown:l.onMouseDown,css:Ts.container(l.position.x),children:d("div",{style:Gr})})]})}const o1={width:"2px",height:"100%",pointerEvents:"none",fill:"transparent"},Wr={container:e=>M`
    transform: translateX(${e}px);
...
`;function K1({rangeData:e,showMultiplicityTrees:t,selectedTool:n,startEditMode:o}){var D;const{id:s,from:i,to:r,integration:l,signals:a}=e,u=je(),p=dt(s),h=re([p.id].concat(((D=p.assigned)==null?void 0:D.x)||[]).concat(Ji(u,a.map(P=>P.id))),{type:ue.RANGE,extra:{id:s}}),{scaleX:m}=ge(),g=X(),[x,y]=c.exports.useState(!1),[S,v]=c.exports.useState(!1);c.exports.useEffect(()=>{n&&n===F.editRange.id?v(!0):v(!1)},[n]),c.exports.useEffect(()=>{y(!Ba(e))},[e]);const C=c.exports.useCallback(P=>{g({type:Gc,data:k(b({},e),{from:m().invert(P.x2),to:m().invert(P.x1)})})},[g,e,m]),E=c.exports.useCallback(()=>{p.show("x"),h.show()},[p,h]),T=c.exports.useCallback(()=>{p.hide(),h.hide()},[p,h]),N=c.exports.useCallback(P=>{n===F.rangesPicking.id&&P.shiftKey&&!S&&p.setActive("x")},[p,S,n]);return w("g",{"data-test-id":"range",style:{outline:"none"},css:S||h.isActive||p.isActive?U1:Z1,onMouseEnter:E,onMouseLeave:T,onClick:N,children:[d(qi,{tag:"svg",initialPosition:{x1:m()(r),x2:m()(i)},onEnd:C,children:(P,A)=>w("g",{transform:"translate(0,10)",children:[d("rect",{"data-no-export":"true",x:"0",width:A-P,height:"6",className:"range-area",fill:"green",fillOpacity:!x||h.isActive||p.isActive?1:.4}),d("text",{textAnchor:"middle",x:(A-P)/2,y:"20",fontSize:"10",fill:"red",fillOpacity:!x||h.isActive||p.isActive?1:.6,children:l!==void 0?l.toFixed(2):""})]})}),o?d(W1,{}):t&&a&&a.length>0&&a.map(P=>d(yd,{rangeFrom:i,rangeTo:r,signal:P},P.id))]},s)}function q1({range:e}){const t=fd(e);return f("path",{className:"line",stroke:"black",strokeWidth:"1",fill:"none",d:t})}function J1({ranges:e,displayerKey:t,selectedTool:n,editRangeID:o,showMultiplicityTrees:s,showRangesIntegrals:i}){var r;return f("g",{clipPath:`url(#${t}clip-chart-1d)`,children:(r=e==null?void 0:e.values)==null?void 0:r.map(l=>_(c.exports.Fragment,{children:[f(K1,{rangeData:l,selectedTool:n,showMultiplicityTrees:s,startEditMode:!!(o&&o===l.id)}),i&&f(q1,{range:l})]},l.id))})}const Q1=c.exports.memo(J1),eC={ranges:{}};function tC(){const{displayerKey:e,toolOptions:{selectedTool:t,data:{tempRange:n,showMultiplicityTrees:o,showRangesIntegrals:s}}}=$(),{ranges:i}=Ce(eC);return f(Q1,{ranges:i,showMultiplicityTrees:o,showRangesIntegrals:s,selectedTool:t,displayerKey:e,editRangeID:(n==null?void 0:n.id)||""})}const nC=M`
  pointer-events: bounding-box;
  user-select: 'none';
  -webkit-user-select: none; /* Chrome all / Safari all */
  -moz-user-select: none; /* Firefox all */
...
`,SC={name:"",compressed:!1,pretty:!1,dataExportOption:vt.ROW_DATA};function kC({onClose:e,onSave:t,name:n}){const o=c.exports.useRef(),s=c.exports.useCallback(()=>{o.current.submitForm()},[]),i=c.exports.useCallback(r=>{t(r),e==null||e()},[e,t]);return w("div",{css:[mt,CC],children:[w("div",{className:"header handle",children:[d("span",{children:"Save as ... "}),d(me,{onClick:e,className:"close-bt"})]}),d("div",{className:"inner-content",children:w(ce,{ref:o,initialValues:k(b({},SC),{name:n}),onSubmit:i,children:[w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Name"}),d(Z,{name:"name",className:"name",style:{inputWrapper:{width:"100%"}}})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Compressed"}),d(xt,{name:"compressed"})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Pretty Format"}),d(xt,{name:"pretty"})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:" Include "}),w("div",{className:"data-export-group",children:[w("label",{children:[d(yr,{type:"radio",name:"dataExportOption",value:vt.ROW_DATA}),"Raw Data"]}),w("label",{children:[d(yr,{type:"radio",name:"dataExportOption",value:vt.DATA_SOURCE}),"Data Source"]})]})]})]})}),d("div",{className:"footer-container",children:d(Kt,{style:{flexDirection:"row-reverse",margin:0},onDone:s,doneLabel:"Save",onCancel:()=>e==null?void 0:e()})})]})}function wC(e){var s,i;let t=document.createElement("div");t.innerHTML=e,t.style.position="fixed",t.style.pointerEvents="none",t.style.opacity="0";let n=Array.prototype.slice.call(document.styleSheets).filter(r=>!r.disabled);document.body.appendChild(t),(s=window.getSelection())==null||s.removeAllRanges();let o=document.createRange();o.selectNode(t),(i=window.getSelection())==null||i.addRange(o),document.execCommand("copy");for(const r of n)r.disabled=!0;document.execCommand("copy");for(const r of n)r.disabled=!1;document.body.removeChild(t)}async function EC(e){try{return wC(e),!0}catch{return!1}}async function bs(e){try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}async function tl(e,t="experiment",n=0,o=!1){const s=JSON.stringify(e,(i,r)=>ArrayBuffer.isView(r)?Array.from(r):r,n);if(o)try{const i=new un;i.file(`${t}.nmrium`,s);const r=await i.generateAsync({type:"blob",compression:"DEFLATE",compressionOptions:{level:9}});pn.exports.saveAs(r,`${t}.nmrium`)}catch(i){console.log(i)}else{const i=new Blob([s],{type:"text/plain"});pn.exports.saveAs(i,`${t}.nmrium`)}}function AC(e,t,n="experiment"){const o=["name","experiment"];for(const r of e[0].data.x)o.push(r);let s=`${o.join("	")}
...
Larmor=${Number(l.info.baseFrequency).toFixed(2)}\\`);const{source:x={}}=l;u+=await kd(t,{spectrum:l,source:x});let y=nr(h)[0];for(let S of p){let v=S.signals;for(let C of v){let{multiplicity:E}=C;if((!E||E==="m")&&h==="1H")u+=`
${Number(S.from).toFixed(y)}-${Number(S.to).toFixed(y)}`;else if(C.delta)u+=`
${Number(C.delta).toFixed(y)}`;else continue;let T="";if(C.diaIDs&&C.diaIDs.length>0&&(C.diaIDs.forEach((N,D,P)=>{let A=", ";D===P.length-1&&(A=""),T+=`${s.byDiaID[N].label||N}${A}`}),u+=`, L=${T}`),h==="1H"){C.multiplicity&&(u+=`, S=${C.multiplicity}`);let N=C.js;if(Array.isArray(N)&&N.length){let D=", J=";for(const P of N){if(u+=`${D}${Number(P.coupling).toFixed(3)}`,P.diaIDs){let{diaIDs:A}=P;if(Array.isArray(A)||(A=[A]),!A.length)continue;u+=`(${s.byDiaID[A[0]].label||String(A[0])})`}D=", "}}S.integration?u+=`, E=${Number(S.integration).toFixed(y)}`:S.nbAtoms?u+=`, E=${S.nbAtoms.toFixed(y)}`:S.signals[0].nbAtoms!==void 0&&(u+=`, E=${S.signals[0].nbAtoms}`)}}v.length&&(u+="\\")}u+=`
...
> <NMREDATA_2D_`;for(let r of e){if(r.info.dimension<2)continue;let l="";const{info:a,source:u}=r;let{nucleus:p,experiment:h,pulseSequence:m}=a,g=FC(h);p&&(l+=`${i}${p[1]}_${g}_${p[0]}>`);let x=nr(p);l+=await kd(t,{spectrum:r,source:u}),h&&(l+=`
CorType=${h} \\`),m&&(l+=`
PulseProgram=${m} \\`),r.info.baseFrequency&&(l+=`
Larmor=${Number(r.info.baseFrequency[0]).toFixed(2)}\\`);let y=r.zones.values||[];for(let S of y){let v=S.signals;for(let C of v){let{x:E,y:T,peaks:N}=C,D=nl(E,o,x[0]),P=nl(T,o,x[1]),A=Math.max(...N.map(I=>I.z));l+=`
${D}/${P}, I=${A.toFixed(2)}\\`}}s+=l}return s.length>0?`${s}
`:""}function nl(e,t,n){let{diaIDs:o,delta:s}=e;if(o){if(LC(o)||(o=[o]),o.length<1)return Number(s).toFixed(n);let i=o.map(r=>t[r].label).join(",");return o.length>1?`(${i})`:i}return Number(s).toFixed(n)}function $C(e){let t=[];for(const{x:n,y:o}of e)t.push(n,o);return t}function HC(e,t={groupedDiaIDs:[]}){const{groupedDiaIDs:n,molecule:o}=t;let s=zp(o,{toLabel:"H",maxLength:1}),i={},r={};for(let l of e){let{dimension:a,nucleus:u}=l.info,p=nr(u),[h,m]=a>1?["zones",$C]:["ranges",x=>x||[]],g=l[h].values||[];for(let x of g){let y=m(x.signals);for(let S=0;S<y.length;S++){let v=y[S].diaIDs||[];for(let C of v){let E=Number(y[S].delta).toFixed(p[S%a]),T=n.find(D=>D.oclID===C),N={atom:T.atoms[0],molecule:o,connections:s,atomLabel:T.atomLabel};i[C]={atoms:T.atoms.map(D=>D+1),shift:E,label:ol(N)};for(let D of T.atoms)N.atom=D,r[D]={shift:E,diaID:C,label:ol(N)}}}}}return{byAssignNumber:r,byDiaID:i}}function ol(e){const{atom:t,molecule:n,atomLabel:o,connections:s}=e;let i="";if(o!=="C"){let l=s[t].find(p=>p&&p.length>1),a=`${o}${l[0]+1}`,u=`${n.getAtomLabel(l[1])}${l[1]+1}`;i=`${a}${u}`}else i=`${o}${t+1}`;return i}const or={solvent:"SOLVENT",temperature:"TEMPERATURE",assignment:"ASSIGNMENT",j:"J",signals:"SIGNALS",id:"ID"};async function zC(e,t={}){const{data:n,molecules:o}=e||{data:[],molecules:[]};let s=new un;for(const i of o)await sl(n,s,k(b({},t),{molecule:i}));return o.length||await sl(n,s,t),s}async function sl(e,t,n={}){let{id:o,prefix:s=`
...
`;function JC(e){const t=e.original.id;return t?t instanceof Array?t:[String(t)]:[""]}function QC(e,t){const{row:n,highlightedSource:o=ue.UNKNOWN,onContextMenu:s,onClick:i}=e,r=c.exports.useMemo(()=>({type:o,extra:n.original}),[o,n]),l=re(JC(n),r);c.exports.useEffect(()=>()=>{l.hide()},[]);const a=c.exports.useCallback(u=>{i==null||i(u,n)},[i,n]);return c.exports.useMemo(()=>d("tr",k(b(b({ref:t,onContextMenu:s,css:[KC(l.isActive,n),i&&qC]},n.getRowProps()),l.onHover),{children:n.cells.map(u=>{const{style:p,padding:h}=u.column;return u.isRowSpanned?null:d("td",k(b({rowSpan:u.rowSpan},u.getCellProps()),{onContextMenu:m=>(m.preventDefault(),!1),style:b({padding:h},p),onClick:a,children:u.render("Cell")}),u.key)})}),n.getRowProps().key),[a,l.isActive,l.onHover,i,s,t,n])}var eS=c.exports.forwardRef(QC);const Td=M`
  border-spacing: 0;
...
`;var ir=(e=>(e.TOP="TOP",e.LEFT="LEFT",e))(ir||{});function wS({children:e,onClick:t,position:n,onDelete:o=()=>null,activeTab:s}){const i=c.exports.useCallback(u=>{const{tablabel:p,tabid:h}=u;t({tablabel:p,tabid:h})},[t]);let r;const l=c.exports.Children.map(e,u=>{if(!c.exports.isValidElement(u))return null;const{tabid:p}=u.props;return p===s&&(r=u.props.children),d(SS,k(b({},u.props),{isActive:p===s,onClick:i,onDelete:o}))}),a=c.exports.useMemo(()=>{switch(n){case"TOP":return ll;case"LEFT":return kS;default:return ll}},[n]);return w("div",{className:"tabs",css:a,children:[d("ol",{className:"tab-list",children:l}),d("div",{className:"tab-content",children:r})]})}var In=c.exports.memo(wS);function al({direction:e,onClick:t}){return d("div",{onClick:t,css:M`
        display: flex;
        position: absolute;
        top: calc(50% - 20px);
      ...
      `,children:d(Wp,{style:{transform:`scaleX(${e==="right"?"-1":"1"})`}})})}const ES=.45;function AS({children:e,loop:t=!1,defaultIndex:n=0,onChange:o=()=>null}){const[s,{width:i}]=Xl(),[r,l]=c.exports.useState(0);c.exports.useEffect(()=>{l(n)},[n]);const a=c.exports.useMemo(()=>c.exports.Children.map(e,h=>d("div",{css:M`
              width: ${i}px;
              height: 100%;
      ...
      `,ref:s,children:[d("div",{css:M`
          ...
          display: flex;
        `,children:a}),r!==0&&d(al,{direction:"left",onClick:p}),a&&r!==a.length-1&&d(al,{direction:"right",onClick:u})]})}var Pd=c.exports.memo(AS);const TS=M`
  display: flex;
  flex-direction: row;
...
`;function MS(e){const{className:t="",disabled:n=!1,popupPlacement:o="left",popupTitle:s="Save",onClick:i}=e;return d("div",{className:t,children:d(Ee,{title:s,popupPlacement:o,children:d("button",{css:RS,type:"button",onClick:i,disabled:n,className:t,children:d(Kp,{})})})})}var rr=c.exports.memo(MS);const _S=M`
  display: flex;
  flex-direction: row-reverse;
  border-bottom: 0.55px solid rgb(240, 240, 240);
...
`,Ek=[{id:"molfile",icon:d(ri,{}),label:"Copy as molfile"},{id:"png",icon:d(Ul,{}),label:"Copy as PNG"},{id:"svg",icon:d(Kl,{}),label:"Export as SVG"}];function Ak({currentIndex:e,molecules:t,onMoleculeIndexChange:n=()=>null,onOpenMoleculeEditor:o=()=>null,actionsOptions:s={}}){const{rootRef:i}=ms(),r=se(),l=X(),a=fe(),u=je(),p=c.exports.useCallback(()=>{!i||Cd(i,`molSVG${e}`,"molFile")},[i,e]),h=c.exports.useCallback(()=>{!i||(Sd(i,`molSVG${e}`),r.success("MOL copied as PNG to clipboard"))},[i,r,e]),m=c.exports.useCallback(()=>{t[e]&&bs(t[e].molfile).then(v=>{v?r.success("MOLFile copied to clipboard"):r.error("copied not completed")})},[r,e,t]),g=c.exports.useCallback(({id:v})=>{switch(v){case"molfile":m();break;case"png":h();break;case"svg":p();break}},[m,h,p]),x=c.exports.useCallback(()=>{navigator.clipboard.readText().then(v=>{l({type:Ri,molfile:v})})},[l]),y=c.exports.useCallback(()=>{var v;(v=t[e])!=null&&v.key&&(n(0),l({type:Cc,payload:{key:t[e].key,assignmentData:u}}))},[t,e,n,l,u]),S=c.exports.useCallback(()=>{a.show(d(kk,{molfile:t[e]}),{position:ne.TOP_CENTER,enableResizing:!0,width:600})},[a,t,e]);return w("div",{css:wk,children:[!s.hideExport&&d(xk,{component:d(qo,{}),toolTip:"Export As",items:Ek,onClick:g}),!s.hidePast&&d(Ee,{title:"Paste molfile",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:x,children:d(eh,{})})}),!s.hideAdd&&d(Ee,{title:"Add Molecule",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:o,"data-test-id":"panel-structures-button-add",children:d(yn,{})})}),!s.hideDelete&&d(Ee,{title:"Delete Molecule",popupPlacement:"left",children:d("button",{className:"bar-button",type:"button",onClick:y,children:d(At,{})})}),!s.hidePredict&&t&&t.length>0&&d(ke,{popupTitle:"Predict Spectra",popupPlacement:"left",onClick:S,children:d(Zl,{})}),w("p",{children:[t&&t.length>0&&`${+(e+1)} / ${t.length}`," "]})]})}function Tk(e){return e.split(",").map(n=>n.replace(/[0-9]/g,""))}function dl(e,t,n){const o=Tk(t);if(o.length>0&&Object.keys(e).length>0){const s=n==="x"?0:n==="y"?1:null;switch(s!==null&&o[s]){case e.atomLabel:return{oclIDs:[e.oclID],nbAtoms:e.nbAtoms};case"H":return{oclIDs:e.hydrogenOCLIDs,nbAtoms:e.nbAtoms*e.nbHydrogens};default:return{oclIDs:[e.oclID].concat(e.hydrogenOCLIDs),nbAtoms:e.nbAtoms+e.nbAtoms*e.nbHydrogens}}}return{oclIDs:[],nbAtoms:0}}function Qs(e,t){let n=e.find(s=>s.id===t),o;if(!n){for(const s of e)if(o=s.signals.findIndex(i=>i.id===t),o>=0){n=s;break}}return{datum:n,signalIndex:o}}function Dk(e,t,n){var i;let o=[];const s=e.data.assignments;for(const r in s){const l=s[r];for(const a in l)if((i=l[a])!=null&&i.some(u=>t.includes(u))){o=o.concat(l[a]);const{datum:u,signalIndex:p}=Qs(n,r);u&&(o.push(u.id),p!==void 0&&o.push(u.signals[p].id))}}return o}function Ik(e){const{highlighted:t,assignments:n}=e.data,o=t?n[t.id]:null,s=t?t.axis:null;return s&&o&&o[s]?o[s]:((o==null?void 0:o.x)||[]).concat((o==null?void 0:o.y)||[])}function Pk(e,t){let n=e?e.slice():[];const{nbAtoms:o,oclIDs:s}=t;let i=o;return s.forEach(r=>{n.includes(r)?(i*=-1,n=n.filter(l=>l!==r)):n.push(r)}),[n,i]}function Nk({displayerMode:e,activeTab:t,zones:n,ranges:o}){var T;const s=se(),i=X(),r=Tn(),l=je(),a=dt(l.data.activated?l.data.activated.id:td),[u,p]=c.exports.useState([]),[h,m]=c.exports.useState(null);c.exports.useEffect(()=>{h&&(h==="show"?r.dispatch({type:"SHOW",payload:{convertedHighlights:u}}):h==="hide"&&(r.dispatch({type:"HIDE",payload:{convertedHighlights:u}}),p([])),m(null))},[h,u,r]);const g=c.exports.useMemo(()=>{if(n||o){if(e===Y.DM_1D&&o&&o.values)return o.values;if(e===Y.DM_2D&&n&&n.values)return n.values}return[]},[e,o,n]),x=c.exports.useMemo(()=>{const N={x:[],y:[]},D=l.data.assignments;for(let P in D)D[P].x&&N.x.push(...D[P].x),D[P].y&&N.y.push(...D[P].y);return N},[l.data]),y=c.exports.useMemo(()=>x.x.concat(x.y),[x.x,x.y]),S=c.exports.useMemo(()=>{let N=[];return r.highlight.highlighted.forEach(D=>{var A;if(l.data.assignments[D]){const{datum:I}=Qs(g,D),R=(A=r.highlight.sourceData)==null?void 0:A.type;I&&(R===ue.ZONE||R===ue.RANGE)&&(N=N.concat(I.signals.map(H=>Ji(l,[H.id]).length>0?H.diaIDs:[]).flat()))}}),Ik(l).concat(N)},[l,g,r.highlight.highlighted,(T=r.highlight.sourceData)==null?void 0:T.type]),v=c.exports.useCallback((N,D)=>Pk(N,D),[]),C=c.exports.useCallback((N,D)=>{var P,A,I;if(!Gt(D)&&a.activated){const{axis:R,id:H}=a.activated;if(H&&R){const L=dl(N,t,R);if(L.nbAtoms>0){const z=e===Y.DM_1D?"1D":"2D";a.toggle(L.oclIDs,z);const{datum:V,signalIndex:W}=Qs(g,a.id);if(V)if(e===Y.DM_1D){const O=V;let j=[];W===void 0?j=(O==null?void 0:O.diaIDs)||[]:j=((P=O==null?void 0:O.signals[W])==null?void 0:P.diaIDs)||[];const[U,ee]=v(j,L);i({type:ru,payload:{nbAtoms:ee,rangeData:V,diaIDs:U,signalIndex:W}})}else{const O=V;let j=[];W===void 0?j=((A=O[R])==null?void 0:A.diaIDs)||[]:j=((I=O==null?void 0:O.signals[W][R])==null?void 0:I.diaIDs)||[];const[U,ee]=v(j,L);i({type:gu,payload:{nbAtoms:ee,zoneData:V,diaIDs:U,axis:R,signalIndex:W}})}a.setActive(R)}else s.info("Not assigned! Different atom type or no attached hydrogens found!")}}},[a,s,g,i,e,t,v]);return{handleOnAtomHover:c.exports.useCallback(N=>{const{oclIDs:D}=dl(N,t);if(D.length>0){const P=Dk(l,D,g);p(P),m("show")}else m("hide")},[l,g,t]),handleOnClickAtom:C,currentDiaIDsToHighlight:S,assignedDiaIDsMerged:y}}const Ft={panel:M({display:"flex",overflow:"auto",flexGrow:1,width:"100%",height:"100%",flexDirection:"column"}),innerPanel:M({display:"flex",flex:"1",flexDirection:"column",overflow:"auto"}),molecule:M({display:"flex",flex:"1"}),toolbar:M({display:"flex",borderBottom:"0.55px solid rgb(240, 240, 240)",padding:"0px 10px",justifyContent:"end",height:22}),slider:M({display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",flexGrow:1,minHeight:0}),items:M({display:"flex",flexDirection:"column",flex:"1 1 0%",height:"100%",minHeight:0})};function Rk({zones:e,ranges:t,molecules:n,activeTab:o,displayerMode:s,onMoleculeChange:i,actionsOptions:r,children:l}){const[a,u]=c.exports.useState(0),[p,h]=c.exports.useState([]),m=X(),g=fe(),{currentDiaIDsToHighlight:x,handleOnAtomHover:y,handleOnClickAtom:S,assignedDiaIDsMerged:v}=Nk({zones:e,ranges:t,activeTab:o,displayerMode:s});c.exports.useEffect(()=>{n&&h(N=>(n.length>N.length&&u(p.length),n))},[p.length,n]),c.exports.useEffect(()=>{i==null||i(p[a]||null)},[a,p,i]);const C=c.exports.useCallback((N,D)=>{m({type:Mi,molfile:D,key:N})},[m]),E=c.exports.useCallback((N=null)=>{g.show(d(hk,{selectedMolecule:N}),{position:ne.TOP_CENTER,width:700,height:500})},[g]),T=c.exports.useCallback(N=>{u(N)},[]);return w("div",{css:Ft.panel,children:[d(Ak,{currentIndex:a,molecules:p,onOpenMoleculeEditor:()=>E(),onMoleculeIndexChange:T,actionsOptions:r}),w("div",{css:Ft.innerPanel,children:[d("div",{css:Ft.molecule,children:d(Pd,{onChange:N=>u(N),defaultIndex:a,children:p&&p.length>0?p.map((N,D)=>{var P;return w("div",{css:Ft.items,children:[w("span",{css:Ft.toolbar,children:[d(oi,{mf:N.mf})," - ",(P=N.mw)==null?void 0:P.toFixed(2)]}),d("div",{css:Ft.slider,className:"mol-svg-container",onDoubleClick:()=>E(N),style:{backgroundColor:(D+1)%2!==0?"#fafafa":"white"},children:d(si,{children:({height:A,width:I})=>d(th,{OCL:Et,id:`molSVG${D}`,width:I,height:A,molfile:N.molfile||"",setMolfile:R=>C(N.key,R),setSelectedAtom:S,atomHighlightColor:x&&x.length>0?"red":"#FFD700",atomHighlightOpacity:.35,highlights:x&&x.length>0?x:v,setHoverAtom:y})})})]},N.key)}):d("div",{css:Ft.slider,style:{height:"100%"},onClick:()=>E(),children:d("span",{children:"Click to draw molecule"})})})}),l]})]})}const Mk=c.exports.memo(Rk),_k={ranges:{},zones:{}};function _d({onMoleculeChange:e,children:t,actionsOptions:n}){const{molecules:o,displayerMode:s,activeTab:i}=$(),r=Ce(_k),l=(r==null?void 0:r.ranges)||{},a=(r==null?void 0:r.zones)||{};return d(Mk,{molecules:o,displayerMode:s,activeTab:i,ranges:l,zones:a,onMoleculeChange:e,actionsOptions:n,children:t})}const Fk=[{key:1,value:"manual",label:"Manual"}];function Lk({onClose:e=()=>null,nucleus:t}){const n=c.exports.useRef(),o=X(),s=c.exports.useMemo(()=>{const a=Ht[t]?Object.entries(Ht[t]).map(u=>({key:u[0],value:u[0],label:u[0]}),[]):[];return Fk.concat(a)},[t]),i=c.exports.useCallback(()=>{n.current.submitForm()},[]),r=c.exports.useCallback(a=>{o({type:pu,payload:a}),e()},[o,e]);c.exports.useEffect(()=>{function a(u){const[p,h]=u.range;n.current.setValues(k(b({},n.current.values),{from:p,to:h}))}return pe.on("brushEnd",a),()=>{pe.off("brushEnd",a)}},[]);const l=c.exports.useCallback(a=>{const m=Ht[t][a]||{delta:0},{delta:p=0}=m,h=G(m,["delta"]);n.current.setValues(b(k(b({},n.current.values),{targetX:p}),h))},[t]);return w("div",{css:mt,children:[w("div",{className:"header handle",children:[d("span",{children:"Spectra calibration"}),d(me,{onClick:e,className:"close-bt"})]}),d("div",{className:"inner-content",style:{flex:1},children:w(ce,{ref:n,initialValues:{from:-1,to:1,nbPeaks:1,targetX:0},onSubmit:r,children:[w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Options :"}),d(Me,{data:s,style:{width:270,height:30,marginBottom:"20px"},onChange:l})]}),w("div",{className:"row margin-10",children:[d("span",{className:"custom-label",children:"Range :"}),d(te,{title:"From : ",children:d(Z,{name:"from",type:"number"})}),d(te,{title:"To : ",children:d(Z,{name:"to",type:"number"})})]}),d("div",{className:" margin-10",children:d(te,{className:"custom-label",title:"Number of Peaks : ",children:d(Z,{name:"nbPeaks",type:"number"})})}),d("div",{className:" margin-10",children:d(te,{className:"custom-label",title:"Target PPM :",children:d(Z,{name:"targetX",type:"number"})})})]})}),d("div",{className:"footer-container",children:d(de.Done,{onClick:i,children:"Done"})})]})}function Fd(e,t=null){try{return new Function("args",`return ${e}`)(t)}catch(n){return n}}const Ok=`function run(data) {
...
`;function Vk({data:e,onAfterSave:t},n){const o=X(),s=c.exports.useRef(),[i,r]=c.exports.useState({});c.exports.useImperativeHandle(n,()=>({saveSetting(){s.current.submitForm()}})),c.exports.useEffect(()=>{const h=Object.keys(e.columns).reduce((m,g)=>(m[g]=k(b({},e.columns[g]),{tempKey:g}),m),{});r(h),s.current.setValues({columns:h,code:e.code})},[e]);const l=c.exports.useMemo(()=>Object.keys(i),[i]),a=c.exports.useMemo(()=>{function h(){return l.reduce((m,g)=>(m[g]=Q().shape(k(b({tempKey:rt().required().test("unique","must be unique column name",x=>{const y=s.current.values.columns;return Object.keys(y).reduce((S,v)=>(y[v].tempKey===x&&S.push(x),S),[]).length===1})},i[g].type===Bo.FORMULA?{formula:rt().required()}:{}),{index:rt().required()})),m),{})}return Q().shape({columns:Q().shape(h())})},[i,l,s]),u=c.exports.useCallback(h=>{t==null||t(!0);const m=Object.entries(h.columns).reduce((g,[x,y])=>(g[x]=b(b({},i[x]),y),g),{});o({type:uu,payload:{code:h.code,columns:m}})},[i,o,t]),p=c.exports.useCallback(h=>{r(m=>k(b({},m),{[`temp${h}`]:{tempKey:"",type:"FORMULA",valueKey:"value",formula:"",index:h}}))},[]);return w(ce,{ref:s,initialValues:{columns:i,code:null},validationSchema:a,onSubmit:u,children:[l&&w("table",{css:zk,children:[d("thead",{children:w("tr",{children:[d("th",{className:"counter",children:"#"}),d("th",{className:"label",children:"Label"}),d("th",{children:"value"}),d("th",{className:"index",children:"index"})]})}),d("tbody",{children:l.map((h,m)=>w("tr",{children:[d("td",{className:"counter",children:m+1}),d("td",{className:"label",children:d(Z,{name:`columns.${h}.tempKey`,value:i[h].tempKey},h)}),d("td",{children:i[h].type===Bo.FORMULA?d(Z,{name:`columns.${h}.formula`,value:i[h].formula}):d("div",{className:"input disbale"})}),d("td",{className:"index",children:d(Z,{name:`columns.${h}.index`,value:i[h].index})}),d("td",{className:"operation-col",children:l.length===m+1&&d("button",{className:"add",type:"button",onClick:()=>p(m+1),children:d(yn,{})})})]},h))})]}),d(Hk,{data:e})]})}var jk=c.exports.forwardRef(Vk);const bo={container:M`
  ...
  `,label:M`
    padding: 5px 20px;
    display: block;
  `};function Bk({data:e=[],onSelect:t,renderItem:n=null}){const o=c.exports.useRef(null);return c.exports.useLayoutEffect(()=>{var s;if(o.current){const i=(s=o.current)==null?void 0:s.getBoundingClientRect();i.right>window.innerWidth&&(o.current.style.right=`${i.right-window.innerWidth}px`)}},[]),d("div",{css:bo.container,ref:o,children:d("ul",{css:bo.ul,children:e.map((s,i)=>d("li",{css:bo.li,onClick:()=>t(i),children:(n==null?void 0:n(s))||d("span",{css:bo.label,children:s.label})},s.key))})})}const pl={container:M`
    position: relative;
    padding: 2px;
    border-radius: 10px;
    width: max-content;
...
`;function bl({description:e,onConfirm:t}){const n=c.exports.useCallback(o=>{o.preventDefault(),o.stopPropagation(),t()},[t]);return w("div",{css:jE,children:[d("p",{children:e}),d("button",{type:"button",onClick:n,children:"Confirm"})]})}const BE=M`
  width: 100%;
  height: 100%;
  margin-top: 10px;
  text-align: center;
...
`;function cr({correlationDim1:e,correlationDim2:t,link:n,correlations:o,onClose:s,onEdit:i}){const[r,l]=c.exports.useState("move"),a=c.exports.useCallback(()=>{const h=Ne(n);return h===1?` 1D (${n.signal.delta.toFixed(3)})`:h===2?`${n.signal.x?`${n.signal.x.delta.toFixed(2)}`:"?"} (${e.label.origin}), ${n.signal.y?n.signal.y.delta.toFixed(2):"?"} (${t.label.origin})`:""},[e.label.origin,n,t]),u=c.exports.useCallback((h,m,g,x)=>{const{editedCorrelations:y,buildCorrelationDataOptions:S}=HE({correlationDim1:e,correlationDim2:t,selectedCorrelationIdDim1:m,selectedCorrelationIdDim2:g,action:h,link:x||n,correlations:o});i(y,h,x||n,S),s==null||s()},[e,t,o,n,s,i]),p=c.exports.useMemo(()=>d("div",{className:"tabs-container",children:w(In,{position:ir.TOP,activeTab:r,onClick:h=>l(h.tabid),children:[d(Re,{tablabel:"Move",tabid:"move",children:d(GE,{correlationDim1:e,correlationDim2:t,link:n,correlations:o,onEdit:(h,m)=>u("move",h,m)})}),d(Re,{tablabel:"Unmove",tabid:"unmove",children:d(bl,{description:"Movement of signal to its original place.",onConfirm:()=>u("unmove",e.id,t.id)})}),d(Re,{tablabel:"Remove",tabid:"remove",children:d(bl,{description:"Deletion of signal.",onConfirm:()=>u("remove",void 0,void 0)})}),d(Re,{tablabel:"J Coupling",tabid:"setPathLength",children:d(XE,{signal:n.signal,experimentType:n.experimentType,onEdit:h=>{const m=k(b({},n),{signal:h});u("setPathLength",e,t,m)}})})]})}),[r,e,t,o,u,n]);return w("div",{css:WE,children:[w("div",{className:"header handle",children:[d(me,{onClick:s}),d("p",{className:"header-info",children:`${n.experimentType.toUpperCase()} signal at ${a()}`})]}),p]})}function ZE({spectraData:e,correlationsData:t,correlation:n,onEdit:o}){var C;const s=c.exports.useRef(),i=fe(),r=c.exports.useMemo(()=>{if(n.pseudo===!0)return[];const E=[];return n.link.forEach(T=>{if(T.pseudo===!1){E.push(T.signal.id),E.push(Se(T.signal.id,"Crosshair_X"));const N=wi(e,T.experimentID,T.signal.id,!0);N&&E.push(N)}}),E},[n,e]),l=re(r),a=c.exports.useCallback(E=>{E.currentTarget.focus(),l.show()},[l]),u=c.exports.useCallback(E=>{E.currentTarget.blur(),l.hide()},[l]),p=Go({correlation:n}),h=c.exports.useMemo(()=>({style:{color:zd(t,n)||void 0,backgroundColor:l.isActive?"#ff6f0057":p?"#f5f5dc":"inherit"},title:n.pseudo===!1&&n.link.reduce((E,T)=>(T.pseudo===!1&&!E.includes(T.experimentType.toUpperCase())&&E.push(T.experimentType.toUpperCase()),E),[]).sort().join("/"),onMouseEnter:a,onMouseLeave:u}),[n,t,l.isActive,p,a,u]),m=c.exports.useMemo(()=>n.edited.equivalence?{backgroundColor:"#F7F2E0"}:{color:Number.isInteger(n.equivalence)?n.equivalence===1?"#bebebe":"black":"red"},[n]),g=c.exports.useMemo(()=>n.pseudo===!1?n.link.filter(E=>Ne(E)===1&&E.pseudo===!1).map(E=>{var T;return{label:`edit 1D (${E.signal.delta.toFixed(3)}${((T=E.edited)==null?void 0:T.moved)===!0?"[MOVED]":""})`,onClick:()=>{l.hide(),i.show(d(cr,{onClose:()=>i.close(),onEdit:o,link:E,correlationDim1:n,correlationDim2:void 0,correlations:t.values}),{position:ne.MIDDLE_RIGHT,isBackgroundBlur:!1})}}}).concat([{label:`delete all (${n.label.origin})`,onClick:()=>{i.showConfirmDialog({message:`All signals of ${n.label.origin} (${lt(n).toFixed(2)}) will be deleted. Are you sure?`,buttons:[{text:"Yes",handler:()=>{o([n],"removeAll")}},{text:"No"}]}),l.hide()}}]):[],[n,t.values,l,i,o]),x=c.exports.useCallback(E=>{E.preventDefault(),s.current.handleContextMenu(E)},[s]),v=h,{title:y}=v,S=G(v,["title"]);return d("th",k(b({},S),{title:y===!1?void 0:y,children:w("div",{style:{display:"block"},onContextMenu:E=>{g.length>0&&x(E)},children:[d("p",{children:n.label.origin}),d("p",{children:lt(n)?(C=lt(n))==null?void 0:C.toFixed(2):""}),d("p",{style:m,children:Number.isInteger(n.equivalence)?n.equivalence:n.equivalence.toFixed(2)}),d(qt,{ref:s,context:g})]})}))}function UE({rowCorrelation:e,columnCorrelation:t,commonLinks:n,correlations:o,spectraData:s,onEdit:i}){const r=c.exports.useRef(),l=fe(),a=c.exports.useMemo(()=>{const E=[];return n.forEach(T=>{if(T.pseudo===!1){E.push(T.signal.id),E.push(Se(T.signal.id,"Crosshair"));const N=wi(s,T.experimentID,T.signal.id,!0);N&&E.push(N)}}),E},[n,s]),u=re(a),p=c.exports.useCallback(E=>{E.currentTarget.focus(),u.show()},[u]),h=c.exports.useCallback(E=>{E.currentTarget.blur(),u.hide()},[u]),m=c.exports.useCallback(E=>{E.preventDefault(),r.current.handleContextMenu(E)},[r]),g=c.exports.useCallback((E,T)=>{const N=e.link.filter(A=>(A.experimentType==="hsqc"||A.experimentType==="hmqc")&&A.pseudo===!0).length;let D,P;if(E==="add"){const A=Qo({experimentType:"hsqc",experimentID:q(),atomType:[t.atomType,e.atomType],id:q(),pseudo:!0,signal:{id:q(),sign:0}});D=be(t,A,"x","add"),P=be(e,A,"y","add"),P.edited.protonsCount||(P.protonsCount=[N+1])}else D=be(t,T,"x","remove"),P=be(e,T,"y","remove"),P.edited.protonsCount||(P.protonsCount=N-1>0?[N-1]:[]);i([D,P],E,T,{skipDataUpdate:!0})},[t,i,e]),x=c.exports.useMemo(()=>{const E=n.map(N=>{var P;const D=`${gl(N)} (${N.signal.x?N.signal.x.delta.toFixed(2):"?"}, ${N.signal.y?N.signal.y.delta.toFixed(2):"?"})${((P=N.edited)==null?void 0:P.moved)===!0?"[MOVED]":""}`;return N.pseudo===!1?[{label:`edit ${D}`,onClick:()=>{u.hide(),l.show(f(cr,{onClose:()=>l.close(),onEdit:i,link:N,correlationDim1:t,correlationDim2:e,correlations:o}),{position:ne.MIDDLE_RIGHT,isBackgroundBlur:!1})}}]:[]}).flat(),T=n.find(N=>N.pseudo===!0&&N.experimentType==="hsqc");return e.pseudo===!0&&(T?E.push({label:"remove pseudo HSQC",onClick:()=>g("remove",T)}):E.push({label:"add pseudo HSQC",onClick:()=>g("add")})),E},[t,n,o,g,u,l,i,e]),y=c.exports.useMemo(()=>n.map((E,T)=>{var N;return _("label",{children:[f("label",{style:{color:E.pseudo===!0||((N=E.edited)==null?void 0:N.moved)===!0?"blue":"black"},children:gl(E)}),T<n.length-1&&f("label",{children:"/"})]},E.id)}),[n]),S=c.exports.useMemo(()=>n.reduce((E,T)=>(E.includes(T.experimentType.toUpperCase())||E.push(T.experimentType.toUpperCase()),E),[]).join("/"),[n]),v=Go({correlation:e}),C=Go({correlation:t});return _("td",{onContextMenu:E=>{x.length>0&&m(E)},style:{backgroundColor:u.isActive?"#ff6f0057":C||v?"#f5f5dc":"inherit"},title:S,onMouseEnter:p,onMouseLeave:h,children:[y,f(qt,{ref:r,context:x})]})}function KE({additionalColumnData:e,correlations:t,correlation:n,styleRow:o,styleLabel:s,onSaveEditEquivalences:i,onSaveEditNumericValues:r,onEditCorrelationTableCellHandler:l,spectraData:a}){var H;const u=c.exports.useRef(),p=fe(),h=c.exports.useMemo(()=>{if(n.pseudo===!0)return[];const L=[];return n.link.forEach(z=>{if(z.pseudo===!1){L.push(z.signal.id),L.push(Se(z.signal.id,"Crosshair_Y"));const V=wi(a,z.experimentID,z.signal.id,!0);V&&L.push(V)}}),L},[n,a]),m=re(h),g=c.exports.useCallback(L=>{i(n,L.target.value)},[n,i]),x=c.exports.useCallback((L,z)=>{r({correlation:n,values:zE(L.target.value,z),key:z})},[n,r]),y=c.exports.useMemo(()=>e.map(L=>{const z=[];return n.link.forEach(V=>{L.link.forEach(W=>{if(V.axis!==W.axis&&V.experimentID===W.experimentID&&V.signal.id===W.signal.id&&!z.some(O=>O.signal.id===V.signal.id)){let O=V.experimentType;V.signal&&V.signal.sign!==0&&(O+=V.signal.sign===1?" (+)":" (-)"),z.push(Qo(k(b({},V),{experimentLabel:O,axis:void 0,id:`${W.id}_${V.id}`})))}})}),f(UE,{rowCorrelation:n,columnCorrelation:L,commonLinks:z,correlations:t,spectraData:a,onEdit:l},`addColData_${n.id}_${L.id}`)}),[e,n,t,l,a]),S=c.exports.useMemo(()=>n.edited.equivalence?{color:"blue"}:{color:n.equivalence===1?"#bebebe":"black"},[n]),v=c.exports.useCallback(L=>{L.currentTarget.focus(),m.show()},[m]),C=c.exports.useCallback(L=>{L.currentTarget.blur(),m.hide()},[m]),E=Go({correlation:n}),T=c.exports.useMemo(()=>({style:k(b({},o),{backgroundColor:m.isActive?"#ff6f0057":E?"#f5f5dc":"inherit"}),title:n.pseudo===!1&&n.link.reduce((L,z)=>(z.pseudo===!1&&!L.includes(z.experimentType.toUpperCase())&&L.push(z.experimentType.toUpperCase()),L),[]).sort().join("/"),onMouseEnter:v,onMouseLeave:C}),[n.link,n.pseudo,m.isActive,E,v,C,o]),N=c.exports.useMemo(()=>n.pseudo===!1?n.link.filter(L=>Ne(L)===1&&L.pseudo===!1).map(L=>{var z;return{label:`edit 1D (${L.signal.delta.toFixed(3)})${((z=L.edited)==null?void 0:z.moved)===!0?"[MOVED]":""}`,onClick:()=>{m.hide(),p.show(f(cr,{onClose:()=>p.close(),onEdit:l,link:L,correlationDim1:n,correlationDim2:void 0,correlations:t}),{position:ne.MIDDLE_RIGHT,isBackgroundBlur:!1})}}}).concat([{label:`delete ${n.label.origin}`,onClick:()=>{p.showConfirmDialog({message:`All signals of ${n.label.origin} (${lt(n).toFixed(2)}) will be deleted. Are you sure?`,buttons:[{text:"Yes",handler:()=>{l([n],"removeAll")}},{text:"No"}]}),m.hide()}}]):[],[n,m,p,l,t]),D=c.exports.useCallback(L=>{L.preventDefault(),u.current.handleContextMenu(L)},[u]),R=T,{title:P}=R,A=G(R,["title"]),I=P||"";return _("tr",{style:o,children:[_("td",k(b({title:I},A),{style:k(b({},T.style),{styleLabel:s}),onContextMenu:L=>{N.length>0&&D(L)},children:[Ch(t,n),f(qt,{ref:u,context:N})]})),f("td",k(b({title:I},A),{children:lt(n)?(H=lt(n))==null?void 0:H.toFixed(2):""})),f("td",k(b({title:I},A),{children:n.pseudo===!1?n.atomType!=="H"?f(at,{type:"number",value:n.equivalence,style:S,onSave:g}):f("text",{style:S,children:n.equivalence}):""})),f("td",k(b({title:I},A),{children:n.atomType!=="H"?f(at,{type:"text",value:n.protonsCount.join(","),style:n.edited.protonsCount?{color:"blue"}:{},onSave:L=>x(L,"protonsCount")}):""})),f("td",k(b({title:I},A),{style:k(b({},T.style),{borderRight:"1px solid"}),children:n.atomType!=="H"?f(at,{type:"text",value:n.hybridization.map(L=>`sp${L}`).join(","),style:n.edited.hybridization?{color:"blue"}:{},onSave:L=>x(L,"hybridization")}):""})),y]})}const qE=M`
  overflow: auto;
  height: 100%;
  display: block;
  table {
...
`;function o2({onSave:e=()=>null,previousMF:t}){const[n,o]=c.exports.useState(""),[s,i]=c.exports.useState(!0),[r,l]=c.exports.useState(!1),a=c.exports.useCallback(h=>{if(h.trim().length===0)return!1;try{return qa(h),!0}catch{return!1}},[]),u=c.exports.useCallback(h=>{l(!0),a(h.target.value)?(i(!0),o(h.target.value)):(i(!1),o(""))},[a]),p=c.exports.useCallback(()=>{e(r?n.trim():t)},[r,n,e,t]);return w("div",{css:n2,children:[d("input",{type:"text",onChange:u,defaultValue:t}),d("button",{type:"button",onClick:p,disabled:!s,children:s?"Set":"Invalid"})]})}const s2=M`
  overflow: auto;
  width: 400px;
  height: 550px;
  padding: 5px;
...
`;function E2({onSaveEditZoneModal:e=()=>null,onCloseEditZoneModal:t=()=>null,onZoomEditZoneModal:n=()=>null,rowData:o}){const s=c.exports.useRef(null),i=k2(),r=c.exports.useCallback(()=>{n(o)},[n,o]);c.exports.useEffect(()=>{r()},[r]);const l=c.exports.useCallback(()=>{t()},[t]),a=c.exports.useCallback(p=>{(async()=>{const h=k(b({},o),{signals:p.signals.map(m=>{var g,x;return $d((g=m.j)==null?void 0:g.pathLength,o.tableMetaInfo.experiment)&&((x=m.j)==null||delete x.pathLength,m.j&&Object.keys(m.j).length===0&&delete m.j),m})});await e(h),l()})()},[l,e,o]),u=c.exports.useMemo(()=>({activeTab:"0",signals:o.signals.map(p=>{var h,m;return k(b({},p),{j:b({pathLength:{from:((h=ve[o.tableMetaInfo.experiment])==null?void 0:h.from)||1,to:((m=ve[o.tableMetaInfo.experiment])==null?void 0:m.to)||1}},p.j)})})}),[o.signals,o.tableMetaInfo.experiment]);return d("div",{css:w2,children:w(ce,{ref:s,initialValues:u,validationSchema:i,onSubmit:a,children:[w("div",{className:"header handle",children:[d(de,{onClick:r,className:"zoom-button",children:d(eo,{title:"Set to default view on range in spectrum"})}),d("span",{children:"Zone and Signal edition"}),d(rr,{onClick:()=>s.current.submitForm(),popupTitle:"Save and exit"}),d(me,{onClick:l})]}),d(S2,{})]})})}const A2={marginLeft:2,marginRight:2,border:"none",height:"20px"};function T2({rowData:e,rowSpanTags:t}){const n=X(),o=je(),s=fe(),i=c.exports.useCallback(p=>{n({type:hu,payload:{rowData:e,value:p}})},[n,e]),r=c.exports.useCallback(()=>{n({type:ds,payload:{id:e.id,assignmentData:o}})},[o,n,e]),l=c.exports.useCallback(()=>{const p=Math.abs(e.x.from-e.x.to)*10;n({type:rs,xDomain:e.x.from<=e.x.to?[e.x.from-p,e.x.to+p]:[e.x.to-p,e.x.from+p]});const h=Math.abs(e.y.from-e.y.to)*10;n({type:Di,yDomain:e.y.from<=e.y.to?[e.y.from-h,e.y.to+h]:[e.y.to-h,e.y.from+h]})},[n,e.x.from,e.x.to,e.y.from,e.y.to]),a=c.exports.useCallback(p=>{n({type:fu,payload:{editedRowData:p}})},[n]),u=c.exports.useCallback(()=>{n({type:co,payload:{selectedTool:F.editRange.id,tempRange:e}}),s.show(f(E2,{onCloseEditZoneModal:()=>s.close(),onSaveEditZoneModal:a,onZoomEditZoneModal:()=>l(),rowData:e}),{position:ne.MIDDLE_RIGHT,transition:Qe.SCALE,isBackgroundBlur:!1})},[n,s,e,a,l]);return _(c.exports.Fragment,{children:[f("td",{children:f(Me,{onChange:p=>{i(p)},data:ai,defaultValue:e.tableMetaInfo.signal.kind,style:A2})}),_("td",k(b({},t),{children:[f("button",{type:"button",className:"delete-button",onClick:r,children:f(At,{})}),f("button",{type:"button",className:"zoom-button",onClick:l,children:f(eo,{title:"Zoom to zone in spectrum"})}),f("button",{type:"button",className:"edit-button",onClick:u,children:f(Ql,{color:"blue"})})]}))]})}function yl({rowData:e,assignment:t,highlight:n,onHover:o,onClick:s,onUnlink:i,axis:r,showUnlinkButton:l,setShowUnlinkButton:a}){var u,p;return f("td",k(b({},o),{onClick:h=>s(h,t,r),style:n.isActive||t.isActive&&((u=t.activated)==null?void 0:u.axis)===r?{color:"red",fontWeight:"bold"}:void 0,children:B(e,`tableMetaInfo.signal.${r}.diaIDs`,[]).length>0?_("div",{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),children:[e.tableMetaInfo.signal[r].diaIDs.length," ",f("sup",{children:f("button",{type:"button",style:{visibility:l?"visible":"hidden",padding:0,margin:0},onClick:h=>i(h,!1,r),children:f(Jo,{color:"red"})})})]}):t.isActive&&((p=t.activated)==null?void 0:p.axis)===r?"0":""}))}function D2({rowData:e,assignmentSignal:t,onHoverSignalX:n,onHoverSignalY:o,showUnlinkButtonSignalX:s,showUnlinkButtonSignalY:i,setShowUnlinkButtonSignalX:r,setShowUnlinkButtonSignalY:l,onClick:a,onUnlink:u,highlightSignalX:p,highlightSignalY:h}){return _(c.exports.Fragment,{children:[f(yl,{rowData:e,assignment:t,highlight:p,onHover:n,onClick:a,onUnlink:u,axis:"x",showUnlinkButton:s,setShowUnlinkButton:r}),f(yl,{rowData:e,assignment:t,highlight:h,onHover:o,onClick:a,onUnlink:u,axis:"y",showUnlinkButton:i,setShowUnlinkButton:l})]})}function I2({rowData:e,onHoverSignalX:t,onHoverSignalY:n}){const o=X(),s=B(e,"tableMetaInfo.signal.x.delta",null),i=B(e,"tableMetaInfo.signal.y.delta",null),r=B(e,"tableMetaInfo.signal.id",void 0),l=c.exports.useCallback(u=>{const p=u.target.value;o({type:Us,payload:{zoneID:e.id,signal:{id:r,x:p}}})},[o,r,e.id]),a=c.exports.useCallback(u=>{const p=u.target.value;o({type:Us,payload:{zoneID:e.id,signal:{id:r,y:p}}})},[o,r,e.id]);return _(c.exports.Fragment,{children:[f("td",k(b({},t),{children:s!==null?f(at,{value:s.toFixed(2),onSave:l,type:"number",style:{padding:"0.1rem 0.4rem"}}):""})),f("td",k(b({},n),{children:i!==null?f(at,{value:i.toFixed(2),onSave:a,type:"number",style:{padding:"0.1rem 0.4rem"}}):""}))]})}function vl({rowData:e,assignment:t,highlight:n,onHover:o,onClick:s,onUnlink:i,axis:r,showUnlinkButton:l,setShowUnlinkButton:a,rowSpanTags:u}){var p,h,m,g;return f("td",k(b(b({},u),o),{onClick:x=>s(x,t,r),children:B(e,`${r}.nbAtoms`,0)>0?B(e,`${r}.diaIDs`,0).length>0?_("div",{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),children:[e[r].nbAtoms," ","(",f("span",{style:t.isActive&&((p=t.activated)==null?void 0:p.axis)===r||t.isOver&&((h=t.highlighted)==null?void 0:h.axis)===r||n.isActive?{color:"red",fontWeight:"bold"}:{color:"black",fontWeight:"normal"},children:B(e,`${r}.diaIDs`,[]).length}),")"," ",f("sup",{children:f("button",{type:"button",style:{visibility:l?"visible":"hidden",padding:0,margin:0},onClick:x=>i(x,!0,r),children:f(Jo,{color:"red"})})})]}):t.isActive&&((m=t.activated)==null?void 0:m.axis)===r?_("div",{children:[`${B(e,`${r}.nbAtoms`,"")} (`,f("span",{style:{color:"red",fontWeight:"bold"},children:"0"}),")"]}):e[r].nbAtoms:t.isActive&&((g=t.activated)==null?void 0:g.axis)===r?_("div",{children:["0 (",f("span",{style:{color:"red",fontWeight:"bold"},children:"0"}),")"]}):""}))}function P2({rowData:e,assignmentZone:t,onHoverZoneX:n,onHoverZoneY:o,showUnlinkButtonZoneX:s,showUnlinkButtonZoneY:i,setShowUnlinkButtonZoneX:r,setShowUnlinkButtonZoneY:l,rowSpanTags:a,onClick:u,onUnlink:p,highlightZoneX:h,highlightZoneY:m}){return _(c.exports.Fragment,{children:[f(vl,{rowData:e,assignment:t,highlight:h,onHover:n,onClick:u,onUnlink:p,axis:"x",showUnlinkButton:s,setShowUnlinkButton:r,rowSpanTags:a}),f(vl,{rowData:e,assignment:t,highlight:m,onHover:o,onClick:u,onUnlink:p,axis:"y",showUnlinkButton:i,setShowUnlinkButton:l,rowSpanTags:a})]})}const N2={backgroundColor:"#ff6f0057"},R2={backgroundColor:"#f5f5dc"};function M2({rowData:e,onUnlink:t,onContextMenu:n,rowIndex:o}){var R,H,L,z;const s=dt(e.id),i=re([s.id]),r=re([Se(s.id,"X")].concat(((R=s.assigned)==null?void 0:R.x)||[])),l=re([Se(s.id,"Y")].concat(((H=s.assigned)==null?void 0:H.y)||[])),a=dt(e.tableMetaInfo.id),u=re([Se(a.id,"X")].concat(((L=a.assigned)==null?void 0:L.x)||[],Se(a.id,"Crosshair"))),p=re([Se(a.id,"Y")].concat(((z=a.assigned)==null?void 0:z.y)||[],Se(a.id,"Crosshair"))),[h,m]=c.exports.useState(!1),[g,x]=c.exports.useState(!1),[y,S]=c.exports.useState(!1),[v,C]=c.exports.useState(!1),E=c.exports.useMemo(()=>({rowSpan:e.tableMetaInfo.rowSpan,style:B(e,"tableMetaInfo.hide",!1)===!0?{display:"none"}:null}),[e]),T=c.exports.useCallback((V,W,O)=>{V&&V.stopPropagation(),t(e,W,e.tableMetaInfo.signalIndex,O),O==="x"?W!==void 0?W?(m(!1),s.removeAll("x")):(S(!1),a.removeAll("x")):(m(!1),S(!1)):O==="y"?W!==void 0?W?(x(!1),s.removeAll("y")):(C(!1),a.removeAll("y")):(x(!1),C(!1)):(m(!1),s.removeAll("x"),S(!1),a.removeAll("x"),x(!1),s.removeAll("y"),C(!1),a.removeAll("y"))},[a,s,t,e]),N=c.exports.useCallback((V,W,O)=>{V.stopPropagation(),W.setActive(O)},[]),D=c.exports.useMemo(()=>({onMouseEnter:()=>{s.show("x"),r.show()},onMouseLeave:()=>{s.hide(),r.hide()}}),[s,r]),P=c.exports.useMemo(()=>({onMouseEnter:()=>{s.show("y"),l.show()},onMouseLeave:()=>{s.hide(),l.hide()}}),[s,l]),A=c.exports.useMemo(()=>({onMouseEnter:()=>{a.show("x"),u.show()},onMouseLeave:()=>{a.hide(),u.hide()}}),[a,u]),I=c.exports.useMemo(()=>({onMouseEnter:()=>{a.show("y"),p.show()},onMouseLeave:()=>{a.hide(),p.hide()}}),[a,p]);return w("tr",k(b({onContextMenu:V=>n(V,e),style:i.isActive||s.isActive?N2:B(e,"tableMetaInfo.isConstantlyHighlighted",!1)===!0?R2:null},i.onHover),{children:[d("td",k(b({},E),{children:o+1})),d(I2,{rowData:e,onHoverSignalX:A,onHoverSignalY:I}),d(D2,{rowData:e,assignmentSignal:a,onHoverSignalX:A,onHoverSignalY:I,showUnlinkButtonSignalX:y,showUnlinkButtonSignalY:v,setShowUnlinkButtonSignalX:V=>S(V),setShowUnlinkButtonSignalY:V=>C(V),onClick:N,onUnlink:T,highlightSignalX:u,highlightSignalY:p}),d(P2,{rowData:e,assignmentZone:s,onHoverZoneX:D,onHoverZoneY:P,showUnlinkButtonZoneX:h,showUnlinkButtonZoneY:g,setShowUnlinkButtonZoneX:V=>m(V),setShowUnlinkButtonZoneY:V=>x(V),rowSpanTags:E,onClick:N,onUnlink:T,highlightZoneX:r,highlightZoneY:l}),d(T2,{rowData:e,rowSpanTags:E})]}))}const _2=M`
  border-spacing: 0;
  border: 1px solid #dedede;
  width: 100%;
  font-size: 12px;
...
`,kl={solvent:"",searchKeywords:""};function J2({nucleus:e,selectedTool:t}){const n=X(),{handleChangeOption:o}=Cs(),s=Be(e),[i,r]=c.exports.useState(!1),l=c.exports.useRef(),[a,u]=c.exports.useState(kl),p=c.exports.useRef(null),[h,m]=c.exports.useState({data:[],databases:[],solvents:[]}),{item:g}=Ih("Database"),x=c.exports.useCallback(()=>{r(!i)},[i]),y=c.exports.useCallback(()=>{l.current.saveSetting(),r(!1)},[]),S=c.exports.useCallback(D=>{if(typeof D=="string"||D===-1){const P=String(D);u(A=>k(b({},A),{solvent:P}))}else u(P=>k(b({},P),{searchKeywords:D.target.value}))},[]);c.exports.useEffect(()=>{g!=null&&g.isOpen&&setTimeout(()=>{const D=tA(j2());p.current=Cl(D[0].key,e);const P=p.current.data,A=wl(p.current.getSolvents());m({data:P,databases:D,solvents:A})})},[g==null?void 0:g.isOpen,e]),c.exports.useEffect(()=>{const{solvent:D,searchKeywords:P}=a;setTimeout(()=>{if(p.current)if(!D&&!P){const A=p.current.data,I=wl(p.current.getSolvents());m(R=>k(b({},R),{data:A,solvents:I}))}else{const A=[...P.split(",")];D!=="-1"&&A.unshift(`solvent:${D}`);const I=p.current.search(A);m(R=>k(b({},R),{data:I}))}})},[a]),c.exports.useEffect(()=>{function D(P){t===F.databaseRangesSelection.id&&u(A=>{const I=A.searchKeywords?A.searchKeywords.split(","):[],[R,H]=P.range,L=[...I,`delta:${s(R)}..${s(H)}`].join(",");return k(b({},A),{searchKeywords:L})})}return pe.on("brushEnd",D),()=>{pe.off("brushEnd",D)}},[s,t]);const v=c.exports.useCallback(D=>{p.current=Cl(D,e),u(kl)},[e]),C=c.exports.useMemo(()=>X2(h.data),[h.data]),E=c.exports.useCallback(D=>{const{index:P}=D.original,{ranges:A,solvent:I,names:R=[]}=h.data[P];n({type:Nu,payload:{ranges:A,info:{solvent:I,nucleus:e,name:R[0]}}})},[n,e,h.data]),T=c.exports.useCallback(()=>{u(D=>k(b({},D),{searchKeywords:""}))},[]),N=c.exports.useCallback(D=>{const P=D?F.databaseRangesSelection.id:F.zoom.id;o(P)},[o]);return w("div",{css:[Nt,q2,i&&M`
            .table-container {
              table,
              th {
                position: relative !important;
