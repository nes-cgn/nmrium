...
`;function qh(e){const t=c.exports.useMemo(()=>Vh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(jh,e.menuIsClosed?Yh:Xh),children:[w("div",{css:Zh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(Uh,Wh),children:"NMRium"})}),p("button",{type:"button",css:Gh,onClick:e.onMenuToggle,children:p(Ld,{})})]}),p("div",{css:Kh,style:{display:n},children:p(Od,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var Jh=_d(c.exports.memo(qh));const Qh="modulepreload",ul={},ef="./",pt=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${ef}${o}`,o in ul)return;ul[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":Qh,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",a)})})).then(()=>t())},ei={Exam:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./Exam.68e5563c.js"),["assets/Exam.68e5563c.js","assets/vendor.3abbb066.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./Exercise.d2500c9d.js"),["assets/Exercise.d2500c9d.js","assets/vendor.3abbb066.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./SingleView.57fa2235.js"),["assets/SingleView.57fa2235.js","assets/vendor.3abbb066.js"]))),Test:c.exports.memo(c.exports.lazy(()=>pt(()=>Promise.resolve().then(function(){return xT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./View.2379e7fe.js"),["assets/View.2379e7fe.js","assets/vendor.3abbb066.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./TwoInstances.e5daef60.js"),["assets/TwoInstances.e5daef60.js","assets/vendor.3abbb066.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>pt(()=>import("./Teaching.e64c6236.js"),["assets/Teaching.e64c6236.js","assets/vendor.3abbb066.js"])))},tf=P`
  position: relative;
  float: right;
  height: 100%;
