import{r as i,j as e,c as s,e as j,f as A}from"./vendor.be1c8d24.js";import{f as h,N as P,S as R,M as N,c as F}from"./NMRium.a7a0be80.js";import"./index.e376355f.js";let m=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function T(o){const t=await fetch(o);return D(t),await t.json()}function D(o){if(!o.ok)throw new Error(`HTTP ${o.status} - ${o.statusText}`);return o}const E=s`
  display: flex;
...
//# sourceMappingURL=Exam.c87d8a5a.js.map
