...
`;function Qh(e){const t=c.exports.useMemo(()=>Bh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(Yh,e.menuIsClosed?Zh:Gh),children:[w("div",{css:Uh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(Kh,qh),children:"NMRium"})}),p("button",{type:"button",css:Wh,onClick:e.onMenuToggle,children:p($d,{})})]}),p("div",{css:Jh,style:{display:n},children:p(Hd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var ef=Od(c.exports.memo(Qh));const tf="modulepreload",hl={},nf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${nf}${o}`,o in hl)return;hl[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":tf,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",a)})})).then(()=>t())},ti={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.cf8b217c.js"),["assets/Exam.cf8b217c.js","assets/vendor.3abbb066.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.79f06333.js"),["assets/Exercise.79f06333.js","assets/vendor.3abbb066.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.e235002d.js"),["assets/SingleView.e235002d.js","assets/vendor.3abbb066.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return AT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.90041c0e.js"),["assets/View.90041c0e.js","assets/vendor.3abbb066.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.bcda1bec.js"),["assets/TwoInstances.bcda1bec.js","assets/vendor.3abbb066.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.725b82fd.js"),["assets/Teaching.725b82fd.js","assets/vendor.3abbb066.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.1d0fe9aa.js"),["assets/Prediction.1d0fe9aa.js","assets/View.90041c0e.js","assets/vendor.3abbb066.js"])))},of=P`
  position: relative;
  float: right;
  height: 100%;
