var j=Object.defineProperty,D=Object.defineProperties;var F=Object.getOwnPropertyDescriptors;var S=Object.getOwnPropertySymbols;var z=Object.prototype.hasOwnProperty,J=Object.prototype.propertyIsEnumerable;var v=(t,e,s)=>e in t?j(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s,k=(t,e)=>{for(var s in e||(e={}))z.call(e,s)&&v(t,s,e[s]);if(S)for(var s of S(e))J.call(e,s)&&v(t,s,e[s]);return t},R=(t,e)=>D(t,F(e));import{r as i,j as d,a as o,c as n}from"./vendor.ff85ee72.js";import{f as p,N as O,a as H,S as T,M as W}from"./NMRium.ea7c0036.js";import"./index.2a8589df.js";let m=JSON.parse(localStorage.getItem("nmrium-exercises")||"{}");async function $(t){const e=await fetch(t);return B(e),await e.json()}function B(t){if(!t.ok)throw new Error(`HTTP ${t.status} - ${t.statusText}`);return t}const L=n`
  text-transform: none;
  margin: 0;
  padding: 5px;
...
//# sourceMappingURL=Exercise.34c896b7.js.map
