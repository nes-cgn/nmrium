...
`;function nf(e){const t=c.exports.useMemo(()=>Gh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(Zh,e.menuIsClosed?Kh:Uh),children:[w("div",{css:Jh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(Qh,ef),children:"NMRium"})}),p("button",{type:"button",css:qh,onClick:e.onMenuToggle,children:p(Vd,{})})]}),p("div",{css:tf,style:{display:n},children:p(jd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var of=zd(c.exports.memo(nf));const sf="modulepreload",fl={},lf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${lf}${o}`,o in fl)return;fl[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":sf,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ti={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.ff27cb72.js"),["assets/Exam.ff27cb72.js","assets/vendor.7b6718ac.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.989c59f0.js"),["assets/Exercise.989c59f0.js","assets/vendor.7b6718ac.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.301baaac.js"),["assets/SingleView.301baaac.js","assets/vendor.7b6718ac.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return DT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.d0a6a133.js"),["assets/View.d0a6a133.js","assets/vendor.7b6718ac.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.5465931c.js"),["assets/TwoInstances.5465931c.js","assets/vendor.7b6718ac.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.0f52570e.js"),["assets/Teaching.0f52570e.js","assets/vendor.7b6718ac.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.1ec31396.js"),["assets/Prediction.1ec31396.js","assets/View.d0a6a133.js","assets/vendor.7b6718ac.js"])))},rf=P`
  position: relative;
  float: right;
  height: 100%;
...
`}const i=new Blob([s],{type:"text/tab-separated-values"});fn.exports.saveAs(i,`${n}.tsv`)}function aC(e,t="experiment"){e.generateAsync({type:"blob"}).then(n=>{fn.exports.saveAs(n,`${t}.nmredata`)})}function ud(e,t="experiment"){const{blob:n}=Yi(e);fn.exports.saveAs(n,`${t}.svg`)}function cC(e,t="experiment"){const{blob:n,width:o,height:s}=Yi(e);try{let i=document.createElement("canvas");i.width=o,i.height=s;let l=i.getContext("2d");l&&(l.fillStyle="white",l.fillRect(0,0,i.width,i.height));let r=new Image,a=URL.createObjectURL(n);r.onload=async()=>{l==null||l.drawImage(r,0,0);let u=i.toDataURL("image/png",1);fn.exports.saveAs(u,`${t}.png`),URL.revokeObjectURL(u)},r.src=a}catch(i){console.log(i)}}function uC(e){var o;const t=document.createElement("img");t.src=e,t.style.position="fixed",t.style.pointerEvents="none",t.style.opacity="0",document.body.appendChild(t);const n=document.createRange();n.selectNode(t),(o=window.getSelection())==null||o.addRange(n),document.execCommand("Copy"),document.body.removeChild(t)}function dC(e){e.toBlob(t=>{const n=new ClipboardItem({[t.type]:t});navigator.clipboard.write([n]).then(()=>{console.log("experiment copied.")},o=>{console.log(o)})})}function dd(e){const{blob:t,width:n,height:o}=Yi(e);try{let s=document.createElement("canvas");s.width=n,s.height=o;let i=s.getContext("2d");i&&(i.fillStyle="white",i.fillRect(0,0,s.width,s.height));let l=new Image;const r=URL.createObjectURL(t);l.onload=async()=>{i==null||i.drawImage(l,0,0);const a=s.toDataURL("image/png",1);navigator.clipboard.write?dC(s):uC(a),URL.revokeObjectURL(a)},l.src=r}catch(s){s instanceof ReferenceError&&alert("Your browser does not support this feature, please use Google Chrome"),console.log(s)}}function Yi(e){var a;let t=(a=document.getElementById(e))==null?void 0:a.cloneNode(!0);const n=t==null?void 0:t.getAttribute("width").replace("px",""),o=t==null?void 0:t.getAttribute("height").replace("px","");t.querySelectorAll('[data-no-export="true"]').forEach(u=>u.remove());const l=`${`<svg class="nmr-svg"  viewBox='0 0 ${n} ${o}' width="${n}"  height="${o}"  version="1.1" xmlns="http://www.w3.org/2000/svg">`+`<style>.grid line,.grid path{stroke:none;} .peaks-text{fill:#730000} .x path{stroke-width:1px} .x text{
  ...
  </style>`+t.innerHTML}</svg>`;return{blob:new Blob([l],{type:"image/svg+xml"}),width:n,height:o}}const pC=new pn;async function pd(e,t={}){const{spectrum:n,source:o}=t,{file:s={},jcampURL:i}=o;let l="";const r=`${n.info.dimension}d`;switch(s.extension){case"jdx":case"dx":l+=`
