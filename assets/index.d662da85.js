...
`;function of(e){const t=c.exports.useMemo(()=>Wh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(Uh,e.menuIsClosed?qh:Kh),children:[w("div",{css:Qh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(ef,tf),children:"NMRium"})}),p("button",{type:"button",css:Jh,onClick:e.onMenuToggle,children:p(jd,{})})]}),p("div",{css:nf,style:{display:n},children:p(Bd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var sf=Vd(c.exports.memo(of));const lf="modulepreload",ml={},rf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${rf}${o}`,o in ml)return;ml[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":lf,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ti={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.bba5a8b7.js"),["assets/Exam.bba5a8b7.js","assets/vendor.7b6718ac.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.9d780e78.js"),["assets/Exercise.9d780e78.js","assets/vendor.7b6718ac.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.c394dc57.js"),["assets/SingleView.c394dc57.js","assets/vendor.7b6718ac.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return DT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.620751be.js"),["assets/View.620751be.js","assets/vendor.7b6718ac.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.3a96ad6d.js"),["assets/TwoInstances.3a96ad6d.js","assets/vendor.7b6718ac.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.0d2803a4.js"),["assets/Teaching.0d2803a4.js","assets/vendor.7b6718ac.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.0b8eceda.js"),["assets/Prediction.0b8eceda.js","assets/View.620751be.js","assets/vendor.7b6718ac.js"])))},af=P`
  position: relative;
  float: right;
  height: 100%;
