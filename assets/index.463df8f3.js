...
`;function of(e){const t=c.exports.useMemo(()=>Wh(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:P(Uh,e.menuIsClosed?qh:Kh),children:[w("div",{css:Qh,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:P(ef,tf),children:"NMRium"})}),p("button",{type:"button",css:Jh,onClick:e.onMenuToggle,children:p(jd,{})})]}),p("div",{css:nf,style:{display:n},children:p(Bd,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ft(o.item.props.file)}`)},mode:"inline",children:t})})]})}var sf=Vd(c.exports.memo(of));const lf="modulepreload",ml={},rf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${rf}${o}`,o in ml)return;ml[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const l=document.createElement("link");if(l.rel=s?"stylesheet":lf,s||(l.as="script",l.crossOrigin=""),l.href=o,document.head.appendChild(l),s)return new Promise((r,a)=>{l.addEventListener("load",r),l.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ti={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.c603ee35.js"),["assets/Exam.c603ee35.js","assets/vendor.7b6718ac.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.1a5fb2d1.js"),["assets/Exercise.1a5fb2d1.js","assets/vendor.7b6718ac.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.3727b25e.js"),["assets/SingleView.3727b25e.js","assets/vendor.7b6718ac.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return DT}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.f5af3368.js"),["assets/View.f5af3368.js","assets/vendor.7b6718ac.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.917b9cce.js"),["assets/TwoInstances.917b9cce.js","assets/vendor.7b6718ac.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.92ac516f.js"),["assets/Teaching.92ac516f.js","assets/vendor.7b6718ac.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.8fe03dd6.js"),["assets/Prediction.8fe03dd6.js","assets/View.f5af3368.js","assets/vendor.7b6718ac.js"])))},af=P`
  position: relative;
  float: right;
  height: 100%;
