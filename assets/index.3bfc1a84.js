...
`;function Ef(e){const t=c.exports.useMemo(()=>mf(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:M(xf,e.menuIsClosed?yf:bf),children:[w("div",{css:Cf,children:[d("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:d("a",{css:M(Sf,kf),children:"NMRium"})}),d("button",{type:"button",css:vf,onClick:e.onMenuToggle,children:d(op,{})})]}),d("div",{css:wf,style:{display:n},children:d(sp,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+Ot(o.item.props.file)}`)},mode:"inline",children:t})})]})}var Af=np(c.exports.memo(Ef));const Tf="modulepreload",Ar={},Df="./",ot=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${Df}${o}`,o in Ar)return;Ar[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const r=document.createElement("link");if(r.rel=s?"stylesheet":Tf,s||(r.as="script",r.crossOrigin=""),r.href=o,document.head.appendChild(r),s)return new Promise((l,a)=>{r.addEventListener("load",l),r.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ui={Exam:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./Exam.334dd768.js"),["assets/Exam.334dd768.js","assets/vendor.eeff80e8.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./Exercise.b19167b1.js"),["assets/Exercise.b19167b1.js","assets/vendor.eeff80e8.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./SingleView.631d3d33.js"),["assets/SingleView.631d3d33.js","assets/vendor.eeff80e8.js"]))),Test:c.exports.memo(c.exports.lazy(()=>ot(()=>Promise.resolve().then(function(){return mD}),void 0))),View:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./View.f82e4fcd.js"),["assets/View.f82e4fcd.js","assets/vendor.eeff80e8.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./TwoInstances.e22ab187.js"),["assets/TwoInstances.e22ab187.js","assets/vendor.eeff80e8.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./Teaching.26fad036.js"),["assets/Teaching.26fad036.js","assets/vendor.eeff80e8.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>ot(()=>import("./Prediction.ce458b5c.js"),["assets/Prediction.ce458b5c.js","assets/View.f82e4fcd.js","assets/vendor.eeff80e8.js"])))},If=M`
  position: relative;
  float: right;
  height: 100%;
...
> <NMREDATA_2D_`;for(let r of e){if(r.info.dimension<2)continue;let l="";const{info:a,source:u}=r;let{nucleus:p,experiment:h,pulseSequence:m}=a,g=VC(h);p&&(l+=`${i}${p[1]}_${g}_${p[0]}>`);let x=sr(p);l+=await wd(t,{spectrum:r,source:u}),h&&(l+=`
CorType=${h} \\`),m&&(l+=`
...
$$$$
`,t.file(`${i}.sdf`,l)}function WC(e,t){if(!e)return"";const{prefix:n}=t;let o=`${n+ir.assignment}>
...
`;function Pd({onDelete:e,className:t="delete"}){return d("button",{css:AS,className:t,type:"button",onClick:e,children:d(ai,{className:"icon"})})}const TS=e=>M`
  position: relative;
...
`;var lr=(e=>(e.TOP="TOP",e.LEFT="LEFT",e))(lr||{});function PS({children:e,onClick:t,position:n,onDelete:o=()=>null,activeTab:s}){const i=c.exports.useCallback(u=>{const{tablabel:p,tabid:h}=u;t({tablabel:p,tabid:h})},[t]);let r;const l=c.exports.Children.map(e,u=>{if(!c.exports.isValidElement(u))return null;const{tabid:p}=u.props;return p===s&&(r=u.props.children),d(DS,k(b({},u.props),{isActive:p===s,onClick:i,onDelete:o}))}),a=c.exports.useMemo(()=>{switch(n){case"TOP":return cl;case"LEFT":return IS;default:return cl}},[n]);return w("div",{className:"tabs",css:a,children:[d("ol",{className:"tab-list",children:l}),d("div",{className:"tab-content",children:r})]})}var Tn=c.exports.memo(PS);function ul({direction:e,onClick:t}){return d("div",{onClick:t,css:M`
        display: flex;
        position: absolute;
        top: calc(50% - 20px);
      ...
      `,ref:s,children:[d("div",{css:M`
          ...
          display: flex;
        `,children:a}),r!==0&&d(ul,{direction:"left",onClick:p}),a&&r!==a.length-1&&d(ul,{direction:"right",onClick:u})]})}var Rd=c.exports.memo(NS);const MS=M`
  display: flex;
  flex-direction: row;
...
`;function HS(e){const{className:t="",disabled:n=!1,popupPlacement:o="left",popupTitle:s="Save",onClick:i}=e;return d("div",{className:t,children:d(Ee,{title:s,popupPlacement:o,children:d("button",{css:$S,type:"button",onClick:i,disabled:n,className:t,children:d(Qp,{})})})})}var ar=c.exports.memo(HS);const zS=M`
  display: flex;
  flex-direction: row-reverse;
  border-bottom: 0.55px solid rgb(240, 240, 240);
...
`;function gw({text:e,onClose:t,onCopyClick:n}){return w("div",{css:mw,children:[w("div",{className:"mainButtonsContainer handle",children:[d("button",{type:"button",onClick:()=>n(e),children:d(ci,{})}),d(me,{onClick:t})]}),d("div",{className:"innerContainer",dangerouslySetInnerHTML:{__html:e}})]})}const xw=M`
  .btn {
    background-color: transparent;
    border: none;
  }
...
`;function vl({description:e,onConfirm:t}){const n=c.exports.useCallback(o=>{o.preventDefault(),o.stopPropagation(),t()},[t]);return w("div",{css:WE,children:[d("p",{children:e}),d("button",{type:"button",onClick:n,children:"Confirm"})]})}const ZE=M`
  width: 100%;
  height: 100%;
  margin-top: 10px;
  text-align: center;
