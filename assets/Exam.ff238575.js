import{r as i,j as l,a as t,c as s,h as A,i as P}from"./vendor.636807a2.js";import{f as m,N as R,d as N,_ as T,c as D}from"./NMRium.ec1aee97.js";import"./index.e5071d0e.js";let g=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function F(o){const e=await fetch(o);return I(e),await e.json()}function I(o){if(!o.ok)throw new Error(`HTTP ${o.status} - ${o.statusText}`);return o}const z=s`
  display: flex;
...
//# sourceMappingURL=Exam.ff238575.js.map
