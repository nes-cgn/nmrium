...
`;function Cf(e){const t=c.exports.useMemo(()=>df(e.routes),[e.routes]),n=e.menuIsClosed?"none":"block";return w("div",{css:M(hf,e.menuIsClosed?mf:ff),children:[w("div",{css:xf,children:[p("div",{style:{display:n,padding:"0.5rem 0.7rem"},children:p("a",{css:M(bf,yf),children:"NMRium"})}),p("button",{type:"button",css:gf,onClick:e.onMenuToggle,children:p(tp,{})})]}),p("div",{css:vf,style:{display:n},children:p(np,{onClick:o=>{e.history.push(`/SamplesDashboard/${Math.random().toString(36).replace("0.","")}/${(o.item.props.view||"View")+$t(o.item.props.file)}`)},mode:"inline",children:t})})]})}var Sf=ep(c.exports.memo(Cf));const kf="modulepreload",wr={},wf="./",it=function(t,n){return!n||n.length===0?t():Promise.all(n.map(o=>{if(o=`${wf}${o}`,o in wr)return;wr[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const r=document.createElement("link");if(r.rel=s?"stylesheet":kf,s||(r.as="script",r.crossOrigin=""),r.href=o,document.head.appendChild(r),s)return new Promise((l,a)=>{r.addEventListener("load",l),r.addEventListener("error",()=>a(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())},ai={Exam:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exam.39e23c77.js"),["assets/Exam.39e23c77.js","assets/vendor.f4af8bd2.js"]))),Exercise:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Exercise.443c2e4e.js"),["assets/Exercise.443c2e4e.js","assets/vendor.f4af8bd2.js"]))),SingleView:c.exports.memo(c.exports.lazy(()=>it(()=>import("./SingleView.2bc70833.js"),["assets/SingleView.2bc70833.js","assets/vendor.f4af8bd2.js"]))),Test:c.exports.memo(c.exports.lazy(()=>it(()=>Promise.resolve().then(function(){return uD}),void 0))),View:c.exports.memo(c.exports.lazy(()=>it(()=>import("./View.fe7f4eea.js"),["assets/View.fe7f4eea.js","assets/vendor.f4af8bd2.js"]))),TwoInstances:c.exports.memo(c.exports.lazy(()=>it(()=>import("./TwoInstances.dc91e38a.js"),["assets/TwoInstances.dc91e38a.js","assets/vendor.f4af8bd2.js"]))),Teaching:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Teaching.76d6248e.js"),["assets/Teaching.76d6248e.js","assets/vendor.f4af8bd2.js"]))),Prediction:c.exports.memo(c.exports.lazy(()=>it(()=>import("./Prediction.1280f54f.js"),["assets/Prediction.1280f54f.js","assets/View.fe7f4eea.js","assets/vendor.f4af8bd2.js"])))},Ef=M`
  position: relative;
  float: right;
  height: 100%;
