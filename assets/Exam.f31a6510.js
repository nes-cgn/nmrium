import{r as i,j as l,a as t,c as s,h as A,i as P}from"./vendor.b7904b13.js";import{f as m,N as R,d as N,_ as T,c as D}from"./NMRium.3b9adc99.js";import"./index.a6ba3a24.js";let g=JSON.parse(localStorage.getItem("nmrium-exams")||"{}");async function F(o){const e=await fetch(o);return I(e),await e.json()}function I(o){if(!o.ok)throw new Error(`HTTP ${o.status} - ${o.statusText}`);return o}const z=s`
  display: flex;
...
//# sourceMappingURL=Exam.f31a6510.js.map
